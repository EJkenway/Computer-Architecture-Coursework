...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lna2/c;->J1(Lcom/gotokeep/keep/data/model/timeline/feed/RecommendFeedBlackEntity;Ljava/util/Map;)V
.end annotation
...
# direct methods
.method public constructor <init>(Lna2/c;Ljava/util/Map;Lcom/gotokeep/keep/data/model/timeline/feed/RecommendFeedBlackEntity;Lcom/gotokeep/keep/data/model/timeline/feed/CommonAction;)V
    .locals 0

    iput-object p1, p0, Lna2/c$j;->g:Lna2/c;

    iput-object p2, p0, Lna2/c$j;->h:Ljava/util/Map;

    iput-object p3, p0, Lna2/c$j;->i:Lcom/gotokeep/keep/data/model/timeline/feed/RecommendFeedBlackEntity;

    iput-object p4, p0, Lna2/c$j;->j:Lcom/gotokeep/keep/data/model/timeline/feed/CommonAction;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lna2/c$j;->h:Ljava/util/Map;
    ...
    .line 3
    iget-object v1, p0, Lna2/c$j;->g:Lna2/c;

    invoke-static {v1}, Lna2/c;->s1(Lna2/c;)Lcom/gotokeep/keep/su/social/feedblack/mvp/view/RecommendFeedBlackActionBottomView;
    ...
    .line 4
    iget-object v2, p0, Lna2/c$j;->i:Lcom/gotokeep/keep/data/model/timeline/feed/RecommendFeedBlackEntity;
    ...
    .line 5
    :cond_0
    iget-object v4, p0, Lna2/c$j;->i:Lcom/gotokeep/keep/data/model/timeline/feed/RecommendFeedBlackEntity;

    invoke-virtual {v4}, Lcom/gotokeep/keep/data/model/timeline/feed/RecommendFeedBlackEntity;->n()Ljava/util/List;

    move-result-object v4

    .line 6
    iget-object v5, p0, Lna2/c$j;->j:Lcom/gotokeep/keep/data/model/timeline/feed/CommonAction;
    ...
    .line 9
    iget-object p1, p0, Lna2/c$j;->h:Ljava/util/Map;
    ...
    :cond_2
    iget-object v0, p0, Lna2/c$j;->g:Lna2/c;

    invoke-static {v0}, Lna2/c;->q1(Lna2/c;)I
