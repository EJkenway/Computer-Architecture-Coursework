...
# direct methods
.method public constructor <init>(Lcom/gotokeep/keep/tc/business/category/mvp/view/sections/CategoryBannerView;)V
    .locals 1
...
.method public static final synthetic q1(Lxj2/a;ILjava/util/Map;Ljava/util/Map;)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1, p2, p3}, Lxj2/a;->u1(ILjava/util/Map;Ljava/util/Map;)V

    return-void
.end method

.method public static final synthetic r1(Lxj2/a;ILjava/util/Map;Lcom/gotokeep/keep/data/model/category/sections/CategoryBannerItemEntity;)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1, p2, p3}, Lxj2/a;->v1(ILjava/util/Map;Lcom/gotokeep/keep/data/model/category/sections/CategoryBannerItemEntity;)V
...
.method public bridge synthetic bind(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lxj2/a;->s1(Lsj2/a;)V

    return-void
.end method

.method public s1(Lsj2/a;)V
    .locals 3
    ...
    .line 2
    new-instance v1, Lxj2/a$a;

    invoke-direct {v1, v0, p0, p1}, Lxj2/a$a;-><init>(Lcom/gotokeep/keep/tc/business/category/widget/CategoryBannerWidget;Lxj2/a;Lsj2/a;)V
    ...
    .line 3
    invoke-virtual {p1}, Lsj2/a;->getDataList()Ljava/util/List;
    ...
    .line 4
    invoke-virtual {p1}, Lsj2/a;->getIndex()I

    move-result v0

    invoke-virtual {p1}, Lsj2/a;->i1()Ljava/util/Map;
    ...
    invoke-virtual {p0, v0, v1, p1}, Lxj2/a;->v1(ILjava/util/Map;Lcom/gotokeep/keep/data/model/category/sections/CategoryBannerItemEntity;)V

    return-void
.end method

.method public final u1(ILjava/util/Map;Ljava/util/Map;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
...
.method public final v1(ILjava/util/Map;Lcom/gotokeep/keep/data/model/category/sections/CategoryBannerItemEntity;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
