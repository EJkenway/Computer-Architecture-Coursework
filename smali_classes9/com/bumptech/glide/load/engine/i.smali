...
.method public constructor <init>(Lcom/bumptech/glide/load/engine/d;Lcom/bumptech/glide/load/engine/DataFetcherGenerator$FetcherReadyCallback;)V
    ...
    .line 2
    iput v0, p0, Lcom/bumptech/glide/load/engine/i;->b:I

    .line 3
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/engine/d;

    .line 4
    iput-object p2, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/engine/DataFetcherGenerator$FetcherReadyCallback;
...
.method private a()Z
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/i;->a:Ljava/util/List;
...
.method public cancel()V
    ...
    .line 1
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
...
.method public onDataReady(Ljava/lang/Object;)V
    ...
    .line 1
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/engine/DataFetcherGenerator$FetcherReadyCallback;

    iget-object v1, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/Key;

    iget-object v2, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    iget-object v5, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/engine/j;
...
.method public onLoadFailed(Ljava/lang/Exception;)V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/engine/j;
...
.method public startNext()Z
    ...
    .line 1
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/engine/d;
    ...
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/engine/d;
    ...
    :cond_2
    :goto_0
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/i;->a:Ljava/util/List;

    const/4 v4, 0x1

    if-eqz v3, :cond_6

    invoke-direct {p0}, Lcom/bumptech/glide/load/engine/i;->a()Z
    ...
    .line 10
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    .line 12
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/i;->a:Ljava/util/List;

    iget v1, p0, Lcom/bumptech/glide/load/engine/i;->c:I

    add-int/lit8 v3, v1, 0x1

    iput v3, p0, Lcom/bumptech/glide/load/engine/i;->c:I
    ...
    .line 13
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/i;->a:Ljava/io/File;
    ...
    iget-object v5, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/engine/d;
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;

    iget-object v1, v1, Lcom/bumptech/glide/load/model/ModelLoader$LoadData;->a:Lcom/bumptech/glide/load/data/DataFetcher;
    ...
    :cond_6
    :goto_2
    iget v3, p0, Lcom/bumptech/glide/load/engine/i;->b:I

    add-int/2addr v3, v4

    iput v3, p0, Lcom/bumptech/glide/load/engine/i;->b:I
    ...
    .line 20
    iget v3, p0, Lcom/bumptech/glide/load/engine/i;->a:I

    add-int/2addr v3, v4

    iput v3, p0, Lcom/bumptech/glide/load/engine/i;->a:I
    ...
    .line 22
    :cond_7
    iput v2, p0, Lcom/bumptech/glide/load/engine/i;->b:I
    ...
    .line 24
    iget v4, p0, Lcom/bumptech/glide/load/engine/i;->b:I
    ...
    invoke-virtual {v4, v11}, Lcom/bumptech/glide/load/engine/d;->r(Ljava/lang/Class;)Lcom/bumptech/glide/load/Transformation;

    move-result-object v10

    .line 26
    new-instance v13, Lcom/bumptech/glide/load/engine/j;
    ...
    .line 28
    invoke-virtual {v4}, Lcom/bumptech/glide/load/engine/d;->o()Lcom/bumptech/glide/load/Key;
    ...
    .line 31
    invoke-virtual {v4}, Lcom/bumptech/glide/load/engine/d;->k()Lcom/bumptech/glide/load/Options;
    ...
    invoke-direct/range {v4 .. v12}, Lcom/bumptech/glide/load/engine/j;-><init>(Lcom/bumptech/glide/load/engine/bitmap_recycle/ArrayPool;Lcom/bumptech/glide/load/Key;Lcom/bumptech/glide/load/Key;IILcom/bumptech/glide/load/Transformation;Ljava/lang/Class;Lcom/bumptech/glide/load/Options;)V

    iput-object v13, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/engine/j;
    ...
    iput-object v4, p0, Lcom/bumptech/glide/load/engine/i;->a:Ljava/io/File;

    if-eqz v4, :cond_2

    .line 33
    iput-object v3, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/Key;
    ...
    iput-object v3, p0, Lcom/bumptech/glide/load/engine/i;->a:Ljava/util/List;

    .line 35
    iput v2, p0, Lcom/bumptech/glide/load/engine/i;->c:I
