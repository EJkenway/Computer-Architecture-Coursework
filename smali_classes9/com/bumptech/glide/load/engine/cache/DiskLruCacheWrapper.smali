...
.field private static a:Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper; = null
...
.field private a:Lcom/bumptech/glide/disklrucache/DiskLruCache;
...
.method public constructor <init>(Ljava/io/File;J)V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->a:Lcom/bumptech/glide/load/engine/cache/a;

    .line 3
    iput-object p1, p0, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->a:Ljava/io/File;

    .line 4
    iput-wide p2, p0, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->a:J
...
.method private declared-synchronized c()Lcom/bumptech/glide/disklrucache/DiskLruCache;
    .locals 4
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->a:Lcom/bumptech/glide/disklrucache/DiskLruCache;

    if-nez v0, :cond_0

    .line 2
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->a:Ljava/io/File;

    iget-wide v1, p0, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->a:J

    const/4 v3, 0x1

    invoke-static {v0, v3, v3, v1, v2}, Lcom/bumptech/glide/disklrucache/DiskLruCache;->w(Ljava/io/File;IIJ)Lcom/bumptech/glide/disklrucache/DiskLruCache;

    move-result-object v0

    iput-object v0, p0, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->a:Lcom/bumptech/glide/disklrucache/DiskLruCache;
...
.method public declared-synchronized clear()V
    ...
    .line 1
    :try_start_0
    invoke-direct {p0}, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->c()Lcom/bumptech/glide/disklrucache/DiskLruCache;
    ...
    :goto_0
    :try_start_1
    invoke-direct {p0}, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->d()V
    :try_end_1
...
.method public delete(Lcom/bumptech/glide/load/Key;)V
    ...
    invoke-virtual {v0, p1}, Lcom/bumptech/glide/disklrucache/DiskLruCache;->B(Ljava/lang/String;)Z
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public get(Lcom/bumptech/glide/load/Key;)Ljava/io/File;
    ...
    invoke-virtual {v2, v0}, Lcom/bumptech/glide/disklrucache/DiskLruCache;->r(Ljava/lang/String;)Lcom/bumptech/glide/disklrucache/DiskLruCache$Value;
    ...
    .line 5
    invoke-virtual {v0, v2}, Lcom/bumptech/glide/disklrucache/DiskLruCache$Value;->b(I)Ljava/io/File;
...
.method public put(Lcom/bumptech/glide/load/Key;Lcom/bumptech/glide/load/engine/cache/DiskCache$Writer;)V
    ...
    .line 2
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->a:Lcom/bumptech/glide/load/engine/cache/a;
    ...
    .line 6
    invoke-virtual {p1, v1}, Lcom/bumptech/glide/disklrucache/DiskLruCache;->r(Ljava/lang/String;)Lcom/bumptech/glide/disklrucache/DiskLruCache$Value;
    ...
    .line 7
    iget-object p1, p0, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->a:Lcom/bumptech/glide/load/engine/cache/a;
    ...
    :cond_1
    :try_start_2
    invoke-virtual {p1, v1}, Lcom/bumptech/glide/disklrucache/DiskLruCache;->o(Ljava/lang/String;)Lcom/bumptech/glide/disklrucache/DiskLruCache$Editor;
    ...
    iget-object p2, p0, Lcom/bumptech/glide/load/engine/cache/DiskLruCacheWrapper;->a:Lcom/bumptech/glide/load/engine/cache/a;
