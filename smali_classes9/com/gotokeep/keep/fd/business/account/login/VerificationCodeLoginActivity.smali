.class public Lcom/gotokeep/keep/fd/business/account/login/VerificationCodeLoginActivity;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/gotokeep/keep/fd/business/account/login/j;
    }
.end annotation
...
.method public static synthetic S3(Lcom/gotokeep/keep/fd/business/account/login/VerificationCodeLoginActivity;ZLjava/lang/String;)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1, p2}, Lcom/gotokeep/keep/fd/business/account/login/VerificationCodeLoginActivity;->Y3(ZLjava/lang/String;)V

    return-void
.end method

.method public static synthetic T3(Lcom/gotokeep/keep/fd/business/account/login/VerificationCodeLoginActivity;Landroid/os/Bundle;)V
    .locals 0

    invoke-virtual {p0, p1}, Lcom/gotokeep/keep/fd/business/account/login/VerificationCodeLoginActivity;->onCreate$___twin___(Landroid/os/Bundle;)V

    return-void
.end method

.method public static synthetic U3(Lcom/gotokeep/keep/fd/business/account/login/VerificationCodeLoginActivity;I)V
    .locals 0

    invoke-virtual {p0, p1}, Lcom/gotokeep/keep/fd/business/account/login/VerificationCodeLoginActivity;->setRequestedOrientation$___twin___(I)V

    return-void
.end method

.method public static V3(Landroid/content/Context;Lcom/gotokeep/keep/data/model/community/PhoneNumberEntityWithCountry;)V
    .locals 2
    ...
    .line 3
    const-class p1, Lcom/gotokeep/keep/fd/business/account/login/VerificationCodeLoginActivity;
...
.method public J3()V
    ...
    .line 1
    invoke-virtual {p0}, Lcom/gotokeep/keep/fd/business/account/login/VerificationCodeLoginActivity;->W3()V
...
.method public final W3()V
    ...
    .line 5
    sget-object v1, Lcom/gotokeep/keep/fd/business/account/login/view/VerificationCodeType;->i:Lcom/gotokeep/keep/fd/business/account/login/view/VerificationCodeType;
    ...
    .line 14
    invoke-interface {v1, v0}, Los/a;->N(Lcom/gotokeep/keep/data/model/account/LoginParams;)Lretrofit2/b;

    move-result-object v0

    new-instance v1, Lcom/gotokeep/keep/fd/business/account/login/VerificationCodeLoginActivity$a;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Lcom/gotokeep/keep/fd/business/account/login/VerificationCodeLoginActivity$a;-><init>(Lcom/gotokeep/keep/fd/business/account/login/VerificationCodeLoginActivity;Z)V
...
.method public final Y3(ZLjava/lang/String;)V
    .locals 2
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string v0, "com.gotokeep.keep.fd.business.account.login.VerificationCodeLoginActivity"
    ...
    invoke-static {p0, p1}, Lcom/gotokeep/keep/fd/business/account/login/j;->a(Lcom/gotokeep/keep/fd/business/account/login/VerificationCodeLoginActivity;Landroid/os/Bundle;)V
...
.method public setRequestedOrientation(I)V
    ...
    invoke-static {p0, p1}, Lcom/gotokeep/keep/fd/business/account/login/j;->b(Lcom/gotokeep/keep/fd/business/account/login/VerificationCodeLoginActivity;I)V
