...
.method public static declared-synchronized b(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string/jumbo v2, "stat sub "
    ...
    invoke-virtual {v1}, Lcom/alipay/sdk/m/m/a;->e()Z

    move-result v1

    if-eqz v1, :cond_0

    new-instance v1, Lcom/alipay/sdk/m/q/d;

    invoke-direct {v1}, Lcom/alipay/sdk/m/q/d;-><init>()V

    goto :goto_0

    :cond_0
    new-instance v1, Lcom/alipay/sdk/m/q/e;

    invoke-direct {v1}, Lcom/alipay/sdk/m/q/e;-><init>()V
    :try_end_0
    ...
    .line 3
    :try_start_1
    invoke-virtual {v1, v2, p0, p1}, Lcom/alipay/sdk/m/p/e;->a(Lcom/alipay/sdk/m/s/a;Landroid/content/Context;Ljava/lang/String;)Lcom/alipay/sdk/m/p/b;
