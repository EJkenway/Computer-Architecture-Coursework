...
.method private static a(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    const-string v1, "Start service error, msg: "
...
.method public static startService(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    const-string v3, "Can\'t find target service, intent: "
    ...
    const-string v4, "Can\'t support outer package, out-package: "
    ...
    const-string v4, "Target service must implement IOreoServiceUnlimited! class: "
    ...
    const-string v3, "__bundle_key_oreo_unlimited_flag__"
    ...
    invoke-direct {v5, p0, p1, v3}, Lcom/alipay/tianyan/mobilesdk/coco/OreoServiceUnlimited$StartServiceServiceConnection;-><init>(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V

    .line 22
    invoke-virtual {p0, p1, v5, v4}, Landroid/content/Context;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z

    .line 23
    invoke-static {v3}, Lcom/alipay/tianyan/mobilesdk/coco/OreoServiceUnlimitedTracker;->trackBeforeCall(Ljava/lang/String;)V

    goto :goto_0

    .line 24
    :cond_6
    new-instance v3, Lcom/alipay/tianyan/mobilesdk/coco/OreoServiceUnlimited$StartServiceServiceConnection;

    invoke-direct {v3, p0, p1, v1}, Lcom/alipay/tianyan/mobilesdk/coco/OreoServiceUnlimited$StartServiceServiceConnection;-><init>(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V

    .line 25
    invoke-virtual {p0, p1, v3, v4}, Landroid/content/Context;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    const-string v4, "Fail to startService, intent: "
