.class public Lcom/alipay/xmedia/capture/biz/audio/capture/ByteDataCapture;
...
.field private b:Lcom/alipay/xmedia/capture/biz/audio/collector/ByteDataCollector;
...
.method public constructor <init>(ILcom/alipay/xmedia/capture/api/APMAudioConfig;)V
    ...
    .line 2
    new-instance v0, Lcom/alipay/xmedia/capture/biz/audio/collector/ByteDataCollector;

    invoke-direct {v0, p1, p2}, Lcom/alipay/xmedia/capture/biz/audio/collector/ByteDataCollector;-><init>(ILcom/alipay/xmedia/capture/api/APMAudioConfig;)V

    iput-object v0, p0, Lcom/alipay/xmedia/capture/biz/audio/capture/ByteDataCapture;->b:Lcom/alipay/xmedia/capture/biz/audio/collector/ByteDataCollector;
...
.method private a(I)V
    ...
    iget-object v0, p0, Lcom/alipay/xmedia/capture/biz/audio/capture/ByteDataCapture;->a:[B
    ...
    .line 2
    :cond_0
    invoke-direct {p0, v0, p1}, Lcom/alipay/xmedia/capture/biz/audio/capture/ByteDataCapture;->a([BI)D
...
.method public addPCM(Lcom/alipay/xmedia/capture/api/APMAudioCaptureListener;I)V
    ...
    .line 1
    iget-object v0, p0, Lcom/alipay/xmedia/capture/biz/audio/capture/ByteDataCapture;->b:Lcom/alipay/xmedia/capture/biz/audio/collector/ByteDataCollector;

    iget-object v1, p0, Lcom/alipay/xmedia/capture/biz/audio/capture/ByteDataCapture;->a:[B

    invoke-virtual {v0, v1, p2, p1}, Lcom/alipay/xmedia/capture/biz/audio/collector/ByteDataCollector;->addPCM([BILcom/alipay/xmedia/capture/api/APMAudioCaptureListener;)V
...
.method public captureData(Landroid/media/AudioRecord;)I
    ...
    invoke-virtual {p1, v0, v1, v2}, Landroid/media/AudioRecord;->read([BII)I
    ...
    invoke-virtual {p1, v0, v1, v2, v1}, Landroid/media/AudioRecord;->read([BIII)I

    move-result p1

    .line 4
    :goto_0
    invoke-direct {p0, p1}, Lcom/alipay/xmedia/capture/biz/audio/capture/ByteDataCapture;->a(I)V
...
.method public createBuffer()V
    ...
    iput-object v0, p0, Lcom/alipay/xmedia/capture/biz/audio/capture/ByteDataCapture;->a:[B
...
.method public handleCallback(Lcom/alipay/xmedia/capture/api/APMAudioCaptureListener;I)V
    ...
    iget-object v2, p0, Lcom/alipay/xmedia/capture/biz/audio/capture/ByteDataCapture;->a:[B
    ...
    .line 5
    invoke-virtual {p1, v0, p2}, Lcom/alipay/xmedia/capture/api/APMAudioCaptureListener;->onAudioFrameAvailable([BI)V
...
.method public notifyEnd(Lcom/alipay/xmedia/capture/api/APMAudioCaptureListener;)V
    ...
    invoke-virtual {v0, p1}, Lcom/alipay/xmedia/capture/biz/audio/collector/ByteDataCollector;->notifyEnd(Lcom/alipay/xmedia/capture/api/APMAudioCaptureListener;)V
