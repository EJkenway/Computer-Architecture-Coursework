...
.field private e:Lcom/amap/api/mapcore/util/fy;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 2
    iput-object v0, p0, Lcom/amap/api/mapcore/util/ay;->c:Landroid/os/Bundle;

    const/4 v0, 0x0

    .line 3
    iput-boolean v0, p0, Lcom/amap/api/mapcore/util/ay;->a:Z

    const-wide/16 v0, 0x7d0

    .line 4
    iput-wide v0, p0, Lcom/amap/api/mapcore/util/ay;->b:J

    .line 5
    iput-object p1, p0, Lcom/amap/api/mapcore/util/ay;->g:Landroid/content/Context;
...
.method private a(Z)V
    ...
    .line 8
    iget-object v0, p0, Lcom/amap/api/mapcore/util/ay;->f:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/amap/api/mapcore/util/ay;->e:Lcom/amap/api/mapcore/util/fy;

    if-eqz v0, :cond_1

    .line 9
    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/fy;->c()V

    .line 10
    new-instance v0, Lcom/amap/api/mapcore/util/fy;

    iget-object v1, p0, Lcom/amap/api/mapcore/util/ay;->g:Landroid/content/Context;

    invoke-direct {v0, v1}, Lcom/amap/api/mapcore/util/fy;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/amap/api/mapcore/util/ay;->e:Lcom/amap/api/mapcore/util/fy;

    .line 11
    invoke-virtual {v0, p0}, Lcom/amap/api/mapcore/util/fy;->a(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationListener;)V
    ...
    iget-wide v1, p0, Lcom/amap/api/mapcore/util/ay;->b:J
    ...
    iget-object v1, p0, Lcom/amap/api/mapcore/util/ay;->f:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;

    invoke-virtual {v0, v1}, Lcom/amap/api/mapcore/util/fy;->a(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;)V

    .line 15
    iget-object v0, p0, Lcom/amap/api/mapcore/util/ay;->e:Lcom/amap/api/mapcore/util/fy;

    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/fy;->a()V
...
.method public a(I)V
    ...
    .line 6
    invoke-direct {p0, p1}, Lcom/amap/api/mapcore/util/ay;->a(Z)V
    ...
    :cond_1
    :goto_0
    invoke-direct {p0, v0}, Lcom/amap/api/mapcore/util/ay;->a(Z)V
...
.method public a(J)V
    ...
    iget-object v1, p0, Lcom/amap/api/mapcore/util/ay;->e:Lcom/amap/api/mapcore/util/fy;
    ...
    .line 5
    :cond_0
    iput-wide p1, p0, Lcom/amap/api/mapcore/util/ay;->b:J
...
.method public activate(Lcom/amap/api/maps/LocationSource$OnLocationChangedListener;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/amap/api/mapcore/util/ay;->d:Lcom/amap/api/maps/LocationSource$OnLocationChangedListener;

    .line 2
    iget-object p1, p0, Lcom/amap/api/mapcore/util/ay;->e:Lcom/amap/api/mapcore/util/fy;

    if-nez p1, :cond_0

    .line 3
    new-instance p1, Lcom/amap/api/mapcore/util/fy;

    iget-object v0, p0, Lcom/amap/api/mapcore/util/ay;->g:Landroid/content/Context;

    invoke-direct {p1, v0}, Lcom/amap/api/mapcore/util/fy;-><init>(Landroid/content/Context;)V

    iput-object p1, p0, Lcom/amap/api/mapcore/util/ay;->e:Lcom/amap/api/mapcore/util/fy;
    ...
    iput-object p1, p0, Lcom/amap/api/mapcore/util/ay;->f:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;

    .line 5
    iget-object p1, p0, Lcom/amap/api/mapcore/util/ay;->e:Lcom/amap/api/mapcore/util/fy;

    invoke-virtual {p1, p0}, Lcom/amap/api/mapcore/util/fy;->a(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationListener;)V

    .line 6
    iget-object p1, p0, Lcom/amap/api/mapcore/util/ay;->f:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;

    iget-wide v0, p0, Lcom/amap/api/mapcore/util/ay;->b:J
    ...
    invoke-virtual {p1, v0}, Lcom/amap/api/mapcore/util/fy;->a(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;)V

    .line 10
    iget-object p1, p0, Lcom/amap/api/mapcore/util/ay;->e:Lcom/amap/api/mapcore/util/fy;

    invoke-virtual {p1}, Lcom/amap/api/mapcore/util/fy;->a()V
...
.method public deactivate()V
    ...
    .line 1
    iput-object v0, p0, Lcom/amap/api/mapcore/util/ay;->d:Lcom/amap/api/maps/LocationSource$OnLocationChangedListener;
    ...
    .line 3
    invoke-virtual {v1}, Lcom/amap/api/mapcore/util/fy;->b()V

    .line 4
    iget-object v1, p0, Lcom/amap/api/mapcore/util/ay;->e:Lcom/amap/api/mapcore/util/fy;

    invoke-virtual {v1}, Lcom/amap/api/mapcore/util/fy;->c()V
...
.method public onLocationChanged(Lcom/autonavi/amap/mapcore/Inner_3dMap_location;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lcom/amap/api/mapcore/util/ay;->d:Lcom/amap/api/maps/LocationSource$OnLocationChangedListener;
    ...
    .line 4
    :cond_0
    iget-object v0, p0, Lcom/amap/api/mapcore/util/ay;->c:Landroid/os/Bundle;
