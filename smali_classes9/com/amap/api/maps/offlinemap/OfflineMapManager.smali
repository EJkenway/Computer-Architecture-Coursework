...
# instance fields
.field public a:Lcom/amap/api/mapcore/util/bj;

.field public b:Lcom/amap/api/mapcore/util/bf;
...
.method public constructor <init>(Landroid/content/Context;Lcom/amap/api/maps/offlinemap/OfflineMapManager$OfflineMapDownloadListener;)V
    ...
    invoke-virtual {p1, p2}, Lcom/amap/api/mapcore/util/gz;->a(Landroid/content/Context;)V
...
.method public static synthetic a(Lcom/amap/api/maps/offlinemap/OfflineMapManager;)Lcom/amap/api/maps/offlinemap/OfflineMapManager$OfflineMapDownloadListener;
    .locals 0
...
.method private a(Landroid/content/Context;)V
    ...
    .line 4
    invoke-static {p1}, Lcom/amap/api/mapcore/util/bf;->a(Landroid/content/Context;)Lcom/amap/api/mapcore/util/bf;

    move-result-object p1

    iput-object p1, p0, Lcom/amap/api/maps/offlinemap/OfflineMapManager;->b:Lcom/amap/api/mapcore/util/bf;
    ...
    invoke-virtual {p1, v0}, Lcom/amap/api/mapcore/util/bf;->a(Lcom/amap/api/mapcore/util/bf$a;)V

    .line 6
    :try_start_0
    iget-object p1, p0, Lcom/amap/api/maps/offlinemap/OfflineMapManager;->b:Lcom/amap/api/mapcore/util/bf;

    invoke-virtual {p1}, Lcom/amap/api/mapcore/util/bf;->a()V

    .line 7
    iget-object p1, p0, Lcom/amap/api/maps/offlinemap/OfflineMapManager;->b:Lcom/amap/api/mapcore/util/bf;

    iget-object p1, p1, Lcom/amap/api/mapcore/util/bf;->f:Lcom/amap/api/mapcore/util/bj;

    iput-object p1, p0, Lcom/amap/api/maps/offlinemap/OfflineMapManager;->a:Lcom/amap/api/mapcore/util/bj;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 9
    iget-object p2, p0, Lcom/amap/api/maps/offlinemap/OfflineMapManager;->b:Lcom/amap/api/mapcore/util/bf;

    invoke-virtual {p2, p1}, Lcom/amap/api/mapcore/util/bf;->a(Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic b(Lcom/amap/api/maps/offlinemap/OfflineMapManager;)Landroid/os/Handler;
    .locals 0
...
.method public static synthetic c(Lcom/amap/api/maps/offlinemap/OfflineMapManager;)Lcom/amap/api/maps/offlinemap/OfflineMapManager$OfflineLoadedListener;
    .locals 0
...
.method public destroy()V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lcom/amap/api/maps/offlinemap/OfflineMapManager;->b:Lcom/amap/api/mapcore/util/bf;

    if-eqz v0, :cond_0

    .line 2
    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/bf;->e()V
...
.method public downloadByCityCode(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lcom/amap/api/mapcore/util/bf;->e(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public downloadByCityName(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lcom/amap/api/mapcore/util/bf;->d(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getDownloadOfflineMapCityList()Ljava/util/ArrayList;
    ...
    .line 1
    iget-object v0, p0, Lcom/amap/api/maps/offlinemap/OfflineMapManager;->a:Lcom/amap/api/mapcore/util/bj;

    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/bj;->c()Ljava/util/ArrayList;
...
.method public getDownloadOfflineMapProvinceList()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/bj;->d()Ljava/util/ArrayList;
...
.method public getDownloadingCityList()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/bj;->e()Ljava/util/ArrayList;
...
.method public getDownloadingProvinceList()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/bj;->f()Ljava/util/ArrayList;
...
.method public getItemByCityCode(Ljava/lang/String;)Lcom/amap/api/maps/offlinemap/OfflineMapCity;
    ...
    invoke-virtual {v0, p1}, Lcom/amap/api/mapcore/util/bj;->a(Ljava/lang/String;)Lcom/amap/api/maps/offlinemap/OfflineMapCity;
...
.method public getItemByCityName(Ljava/lang/String;)Lcom/amap/api/maps/offlinemap/OfflineMapCity;
    ...
    invoke-virtual {v0, p1}, Lcom/amap/api/mapcore/util/bj;->b(Ljava/lang/String;)Lcom/amap/api/maps/offlinemap/OfflineMapCity;
...
.method public getItemByProvinceName(Ljava/lang/String;)Lcom/amap/api/maps/offlinemap/OfflineMapProvince;
    ...
    invoke-virtual {v0, p1}, Lcom/amap/api/mapcore/util/bj;->c(Ljava/lang/String;)Lcom/amap/api/maps/offlinemap/OfflineMapProvince;
...
.method public getOfflineMapCityList()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/bj;->b()Ljava/util/ArrayList;
...
.method public getOfflineMapProvinceList()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/bj;->a()Ljava/util/ArrayList;
...
.method public pause()V
    ...
    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/bf;->d()V
...
.method public remove(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1}, Lcom/amap/api/mapcore/util/bf;->b(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/amap/api/mapcore/util/bf;->c(Ljava/lang/String;)V
...
.method public stop()V
    ...
    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/bf;->c()V
