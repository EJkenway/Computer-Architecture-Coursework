.class public final enum Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;
...
.method public static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;

    const-string v3, "ACTION_START"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;->b:Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;

    .line 3
    new-instance v3, Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;

    const-string v5, "ACTION_RUNNING"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;->c:Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;

    .line 4
    new-instance v5, Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;

    const-string v7, "ACTION_PAUSE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;->d:Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;

    .line 5
    new-instance v7, Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;

    const-string v9, "ACTION_STOP"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;->e:Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;
    ...
    .line 6
    sput-object v9, Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;->f:[Lcom/amap/api/maps/utils/overlay/MovingPointOverlay$a;
