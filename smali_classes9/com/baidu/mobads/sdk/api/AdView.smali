...
.field public static final P_VERSION:Ljava/lang/String; = "3.61"


# instance fields
.field private hasCalledRequestMethod:Ljava/util/concurrent/atomic/AtomicBoolean;

.field private mAdProd:Lcom/baidu/mobads/sdk/internal/cp;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;ZLcom/baidu/mobads/sdk/api/AdSize;Ljava/lang/String;)V
    ...
    invoke-direct {p2, p1}, Lcom/baidu/mobads/sdk/internal/co;-><init>(Landroid/content/Context;)V

    .line 9
    new-instance p4, Lcom/baidu/mobads/sdk/internal/cp;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/baidu/mobads/sdk/internal/cp;-><init>(Lcom/baidu/mobads/sdk/api/AdView;Landroid/content/Context;Landroid/widget/RelativeLayout;Ljava/lang/String;Z)V

    iput-object p4, p0, Lcom/baidu/mobads/sdk/api/AdView;->mAdProd:Lcom/baidu/mobads/sdk/internal/cp;
    ...
    invoke-virtual {p2, p1}, Lcom/baidu/mobads/sdk/internal/co;->a(Lcom/baidu/mobads/sdk/internal/co$a;)V
...
.method public constructor <init>(Landroid/content/Context;ZLcom/baidu/mobads/sdk/api/AdSize;Ljava/lang/String;)V
    .locals 6
...
.method public static synthetic access$000(Lcom/baidu/mobads/sdk/api/AdView;)Lcom/baidu/mobads/sdk/internal/cp;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/baidu/mobads/sdk/api/AdView;->mAdProd:Lcom/baidu/mobads/sdk/internal/cp;

    return-object p0
.end method

.method public static synthetic access$100(Lcom/baidu/mobads/sdk/api/AdView;)V
    .locals 0
...
.method private callRequest()V
    ...
    .line 3
    iget-object v0, p0, Lcom/baidu/mobads/sdk/api/AdView;->mAdProd:Lcom/baidu/mobads/sdk/internal/cp;

    invoke-virtual {v0}, Lcom/baidu/mobads/sdk/internal/cp;->a()V
...
.method public setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v0, v1}, Lcom/baidu/mobads/sdk/internal/bq;->a([Ljava/lang/Object;)V
    ...
    invoke-static {v2}, Lcom/baidu/mobads/sdk/internal/ax;->f(Landroid/content/Context;)Landroid/util/DisplayMetrics;
    ...
    invoke-virtual {v10, v7}, Lcom/baidu/mobads/sdk/internal/bq;->a([Ljava/lang/Object;)V
    ...
    .line 14
    iget-object v2, p0, Lcom/baidu/mobads/sdk/api/AdView;->mAdProd:Lcom/baidu/mobads/sdk/internal/cp;

    if-eqz v2, :cond_4

    .line 15
    invoke-virtual {v2, v0}, Lcom/baidu/mobads/sdk/internal/cp;->a(I)V

    .line 16
    iget-object v0, p0, Lcom/baidu/mobads/sdk/api/AdView;->mAdProd:Lcom/baidu/mobads/sdk/internal/cp;

    invoke-virtual {v0, v1}, Lcom/baidu/mobads/sdk/internal/cp;->c(I)V
...
.method public setListener(Lcom/baidu/mobads/sdk/api/AdViewListener;)V
    ...
    .line 2
    invoke-virtual {v0, p1}, Lcom/baidu/mobads/sdk/internal/cp;->a(Lcom/baidu/mobads/sdk/api/AdViewListener;)V
