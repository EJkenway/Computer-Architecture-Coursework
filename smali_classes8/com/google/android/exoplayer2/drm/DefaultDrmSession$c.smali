...
.method public final a(Landroid/os/Message;Lcom/google/android/exoplayer2/drm/MediaDrmCallbackException;)Z
    ...
    .line 4
    iget-object v7, v0, Lcom/google/android/exoplayer2/drm/DefaultDrmSession$c;->a:Lcom/google/android/exoplayer2/drm/DefaultDrmSession;

    .line 5
    invoke-static {v7}, Lcom/google/android/exoplayer2/drm/DefaultDrmSession;->j(Lcom/google/android/exoplayer2/drm/DefaultDrmSession;)Lcom/google/android/exoplayer2/upstream/n;

    move-result-object v7

    const/4 v8, 0x3

    invoke-interface {v7, v8}, Lcom/google/android/exoplayer2/upstream/n;->d(I)I
    ...
    iget-object v12, v2, Lcom/google/android/exoplayer2/drm/MediaDrmCallbackException;->g:Lcom/google/android/exoplayer2/upstream/f;

    iget-object v13, v2, Lcom/google/android/exoplayer2/drm/MediaDrmCallbackException;->h:Landroid/net/Uri;

    iget-object v14, v2, Lcom/google/android/exoplayer2/drm/MediaDrmCallbackException;->i:Ljava/util/Map;
    ...
    iget-wide v6, v2, Lcom/google/android/exoplayer2/drm/MediaDrmCallbackException;->j:J

    move-object v9, v4

    move-wide/from16 v19, v6

    invoke-direct/range {v9 .. v20}, Lfd/h;-><init>(JLcom/google/android/exoplayer2/upstream/f;Landroid/net/Uri;Ljava/util/Map;JJJ)V

    .line 9
    new-instance v6, Lfd/i;

    invoke-direct {v6, v8}, Lfd/i;-><init>(I)V
    ...
    invoke-direct {v8, v4, v6, v2, v3}, Lcom/google/android/exoplayer2/upstream/n$a;-><init>(Lfd/h;Lfd/i;Ljava/io/IOException;I)V

    invoke-interface {v7, v8}, Lcom/google/android/exoplayer2/upstream/n;->a(Lcom/google/android/exoplayer2/upstream/n$a;)J
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget-object v2, v1, Lcom/google/android/exoplayer2/drm/DefaultDrmSession;->k:Lcom/google/android/exoplayer2/drm/h;
    ...
    invoke-interface {v2, v1, v3}, Lcom/google/android/exoplayer2/drm/h;->a(Ljava/util/UUID;Lcom/google/android/exoplayer2/drm/e$a;)[B
    ...
    check-cast v3, Lcom/google/android/exoplayer2/drm/e$d;

    .line 6
    invoke-interface {v2, v1, v3}, Lcom/google/android/exoplayer2/drm/h;->b(Ljava/util/UUID;Lcom/google/android/exoplayer2/drm/e$d;)[B
    ...
    .line 7
    invoke-static {v2, v3, v1}, Lde/m;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v2}, Lcom/google/android/exoplayer2/drm/DefaultDrmSession;->j(Lcom/google/android/exoplayer2/drm/DefaultDrmSession;)Lcom/google/android/exoplayer2/upstream/n;
