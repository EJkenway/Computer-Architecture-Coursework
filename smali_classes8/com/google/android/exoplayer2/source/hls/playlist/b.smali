...
.method public constructor <init>(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Lcom/google/android/exoplayer2/Format;Ljava/util/List;ZLjava/util/Map;Ljava/util/List;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2, p10}, Lmd/d;-><init>(Ljava/lang/String;Ljava/util/List;Z)V

    .line 2
    invoke-static {p3, p4, p5, p6, p7}, Lcom/google/android/exoplayer2/source/hls/playlist/b;->f(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Ljava/util/List;
...
.method public static d(Ljava/util/List;ILjava/util/List;)Ljava/util/List;
    ...
    .line 6
    iget v6, v5, Lcom/google/android/exoplayer2/offline/StreamKey;->h:I

    if-ne v6, p1, :cond_0

    iget v5, v5, Lcom/google/android/exoplayer2/offline/StreamKey;->i:I
...
.method public static e(Ljava/lang/String;)Lcom/google/android/exoplayer2/source/hls/playlist/b;
    .locals 13
    ...
    invoke-static {p0}, Lcom/google/android/exoplayer2/source/hls/playlist/b$b;->b(Landroid/net/Uri;)Lcom/google/android/exoplayer2/source/hls/playlist/b$b;
...
.method public static f(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v2, v2, Lcom/google/android/exoplayer2/source/hls/playlist/b$b;->a:Landroid/net/Uri;
    ...
    .line 6
    :cond_1
    invoke-static {p1, v0}, Lcom/google/android/exoplayer2/source/hls/playlist/b;->b(Ljava/util/List;Ljava/util/List;)V

    .line 7
    invoke-static {p2, v0}, Lcom/google/android/exoplayer2/source/hls/playlist/b;->b(Ljava/util/List;Ljava/util/List;)V

    .line 8
    invoke-static {p3, v0}, Lcom/google/android/exoplayer2/source/hls/playlist/b;->b(Ljava/util/List;Ljava/util/List;)V

    .line 9
    invoke-static {p4, v0}, Lcom/google/android/exoplayer2/source/hls/playlist/b;->b(Ljava/util/List;Ljava/util/List;)V
...
.method public bridge synthetic a(Ljava/util/List;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/b;->c(Ljava/util/List;)Lcom/google/android/exoplayer2/source/hls/playlist/b;
...
.method public c(Ljava/util/List;)Lcom/google/android/exoplayer2/source/hls/playlist/b;
    .locals 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lmd/d;->a:Ljava/lang/String;

    iget-object v2, p0, Lmd/d;->b:Ljava/util/List;
    ...
    .line 2
    invoke-static {v0, v3, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/b;->d(Ljava/util/List;ILjava/util/List;)Ljava/util/List;
    ...
    .line 4
    invoke-static {v0, v5, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/b;->d(Ljava/util/List;ILjava/util/List;)Ljava/util/List;
    ...
    .line 5
    invoke-static {v0, v6, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/b;->d(Ljava/util/List;ILjava/util/List;)Ljava/util/List;
