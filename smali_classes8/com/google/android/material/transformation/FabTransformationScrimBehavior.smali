...
# instance fields
.field private final collapseTiming:Lhf/i;

.field private final expandTiming:Lhf/i;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lhf/i;-><init>(JJ)V

    iput-object v0, p0, Lcom/google/android/material/transformation/FabTransformationScrimBehavior;->expandTiming:Lhf/i;
    ...
    iput-object v0, p0, Lcom/google/android/material/transformation/FabTransformationScrimBehavior;->collapseTiming:Lhf/i;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 5
    new-instance p1, Lhf/i;

    const-wide/16 v0, 0x4b

    const-wide/16 v2, 0x96

    invoke-direct {p1, v0, v1, v2, v3}, Lhf/i;-><init>(JJ)V

    iput-object p1, p0, Lcom/google/android/material/transformation/FabTransformationScrimBehavior;->expandTiming:Lhf/i;
    ...
    iput-object p1, p0, Lcom/google/android/material/transformation/FabTransformationScrimBehavior;->collapseTiming:Lhf/i;
...
.method private createScrimAnimation(Landroid/view/View;ZZLjava/util/List;Ljava/util/List;)V
    ...
    .line 1
    iget-object p5, p0, Lcom/google/android/material/transformation/FabTransformationScrimBehavior;->expandTiming:Lhf/i;

    goto :goto_0

    :cond_0
    iget-object p5, p0, Lcom/google/android/material/transformation/FabTransformationScrimBehavior;->collapseTiming:Lhf/i;
    ...
    .line 5
    :goto_1
    invoke-virtual {p5, p1}, Lhf/i;->a(Landroid/animation/Animator;)V
...
.method public onCreateExpandedStateChangeAnimation(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    .line 5
    invoke-static {p4, p1}, Lhf/b;->a(Landroid/animation/AnimatorSet;Ljava/util/List;)V
