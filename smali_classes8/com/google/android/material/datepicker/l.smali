...
.method public static e(Ljava/lang/String;Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    .line 2
    invoke-static {}, Lcom/google/android/material/datepicker/l;->q()Landroid/icu/util/TimeZone;
...
.method public static f(Ljava/util/Calendar;)Ljava/util/Calendar;
    ...
    .line 1
    invoke-static {p0}, Lcom/google/android/material/datepicker/l;->s(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method public static g(ILjava/util/Locale;)Ljava/text/DateFormat;
    ...
    .line 2
    invoke-static {}, Lcom/google/android/material/datepicker/l;->o()Ljava/util/TimeZone;
...
.method public static h(Ljava/util/Locale;)Ljava/text/DateFormat;
    ...
    .line 1
    invoke-static {v0, p0}, Lcom/google/android/material/datepicker/l;->g(ILjava/util/Locale;)Ljava/text/DateFormat;
...
.method public static j(Ljava/util/Locale;)Ljava/text/DateFormat;
    ...
    .line 1
    invoke-static {p0}, Lcom/google/android/material/datepicker/l;->i(Ljava/util/Locale;)Ljava/text/DateFormat;
    ...
    invoke-static {v0}, Lcom/google/android/material/datepicker/l;->x(Ljava/lang/String;)Ljava/lang/String;
...
.method public static k(Ljava/lang/String;Ljava/util/Locale;)Ljava/text/SimpleDateFormat;
    .locals 1
...
.method public static l()Ljava/text/SimpleDateFormat;
    .locals 3
...
.method public static m(Landroid/content/res/Resources;Ljava/text/SimpleDateFormat;)Ljava/lang/String;
    .locals 3
...
.method public static o()Ljava/util/TimeZone;
    .locals 1
...
.method public static p()Ljava/util/Calendar;
    .locals 3

    .line 1
    invoke-static {}, Lcom/google/android/material/datepicker/l;->n()Lcom/google/android/material/datepicker/k;
...
.method public static q()Landroid/icu/util/TimeZone;
    .locals 1
    .annotation build Landroid/annotation/TargetApi;
        value = 0x18
    .end annotation
...
.method public static r()Ljava/util/Calendar;
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-static {v0}, Lcom/google/android/material/datepicker/l;->s(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method public static s(Ljava/util/Calendar;)Ljava/util/Calendar;
    .locals 3
...
.method public static v()Ljava/text/SimpleDateFormat;
    ...
    invoke-static {v0}, Lcom/google/android/material/datepicker/l;->w(Ljava/util/Locale;)Ljava/text/SimpleDateFormat;
...
.method public static w(Ljava/util/Locale;)Ljava/text/SimpleDateFormat;
    .locals 1

    const-string v0, "LLLL, yyyy"

    .line 1
    invoke-static {v0, p0}, Lcom/google/android/material/datepicker/l;->k(Ljava/lang/String;Ljava/util/Locale;)Ljava/text/SimpleDateFormat;
...
.method public static x(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1
    invoke-static {p0, v0, v1, v2}, Lcom/google/android/material/datepicker/l;->b(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    .line 3
    invoke-static {p0, v2, v1, v0}, Lcom/google/android/material/datepicker/l;->b(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    .line 6
    invoke-static {p0, v2, v4, v0}, Lcom/google/android/material/datepicker/l;->b(Ljava/lang/String;Ljava/lang/String;II)I
