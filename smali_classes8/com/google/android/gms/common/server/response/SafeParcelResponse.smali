...
.field public final j:Lcom/google/android/gms/common/server/response/zan;
...
.method public constructor <init>(ILandroid/os/Parcel;Lcom/google/android/gms/common/server/response/zan;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->h:Landroid/os/Parcel;

    const/4 p1, 0x2

    iput p1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->i:I

    iput-object p3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->j:Lcom/google/android/gms/common/server/response/zan;
    ...
    :cond_0
    invoke-virtual {p3}, Lcom/google/android/gms/common/server/response/zan;->G()Ljava/lang/String;
...
.method public static final j(Ljava/lang/StringBuilder;ILjava/lang/Object;)V
    ...
    invoke-static {p0, p1}, Lue/h;->a(Ljava/lang/StringBuilder;Ljava/util/HashMap;)V
    ...
    invoke-static {p2}, Lue/b;->b([B)Ljava/lang/String;
    ...
    invoke-static {p2}, Lue/b;->a([B)Ljava/lang/String;
    ...
    invoke-static {p1}, Lue/g;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method public final a()Ljava/util/Map;
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->j:Lcom/google/android/gms/common/server/response/zan;
    ...
    :cond_0
    iget-object v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->n:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/gms/common/server/response/zan;->J(Ljava/lang/String;)Ljava/util/Map;
...
.method public final h()Landroid/os/Parcel;
    ...
    iget v2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->p:I

    .line 3
    invoke-static {v0, v2}, Loe/a;->b(Landroid/os/Parcel;I)V
    ...
    invoke-static {v0}, Loe/a;->a(Landroid/os/Parcel;)I

    move-result v0

    iput v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->p:I

    iget-object v2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->h:Landroid/os/Parcel;

    .line 5
    invoke-static {v2, v0}, Loe/a;->b(Landroid/os/Parcel;I)V
...
.method public final i(Ljava/lang/StringBuilder;Ljava/util/Map;Landroid/os/Parcel;)V
    ...
    invoke-virtual {v2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->G()I
    ...
    .line 13
    invoke-virtual {v5}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->K0()Z

    move-result v3

    if-eqz v3, :cond_4

    iget v3, v5, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->j:I
    ...
    invoke-static {v8}, Lcom/google/android/gms/common/internal/j;->g(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 34
    :pswitch_8
    invoke-static {p3, v4}, Lcom/google/android/gms/common/internal/safeparcel/SafeParcelReader;->D(Landroid/os/Parcel;I)J
    ...
    .line 38
    :pswitch_a
    invoke-static {p3, v4}, Lcom/google/android/gms/common/internal/safeparcel/SafeParcelReader;->C(Landroid/os/Parcel;I)I
    ...
    .line 40
    :cond_4
    iget-boolean v3, v5, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->n:Z
    ...
    .line 48
    invoke-virtual {v5}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->F0()Ljava/util/Map;
    ...
    .line 52
    invoke-static {p1, v3}, Lue/a;->i(Ljava/lang/StringBuilder;[Ljava/lang/String;)V
    ...
    .line 54
    invoke-static {p1, v3}, Lue/a;->h(Ljava/lang/StringBuilder;[Z)V
    ...
    .line 56
    invoke-static {p1, v3}, Lue/a;->g(Ljava/lang/StringBuilder;[Ljava/lang/Object;)V
    ...
    .line 58
    invoke-static {p1, v3}, Lue/a;->c(Ljava/lang/StringBuilder;[D)V
    ...
    .line 60
    invoke-static {p1, v3}, Lue/a;->d(Ljava/lang/StringBuilder;[F)V
    ...
    .line 62
    invoke-static {p1, v3}, Lue/a;->f(Ljava/lang/StringBuilder;[J)V
    ...
    .line 66
    invoke-static {p1, v3}, Lue/a;->e(Ljava/lang/StringBuilder;[I)V
    ...
    invoke-static {v5}, Lue/g;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lue/b;->b([B)Ljava/lang/String;
    ...
    invoke-static {v3}, Lue/b;->a([B)Ljava/lang/String;
    ...
    invoke-static {v3}, Lue/g;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->j:Lcom/google/android/gms/common/server/response/zan;

    iget-object v3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->n:Ljava/lang/String;

    .line 5
    invoke-static {v3}, Lcom/google/android/gms/common/internal/j;->g(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Ljava/lang/String;

    invoke-virtual {v2, v3}, Lcom/google/android/gms/common/server/response/zan;->J(Ljava/lang/String;)Ljava/util/Map;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 4
    invoke-static {p1, v3, v1, v4}, Loe/a;->m(Landroid/os/Parcel;ILandroid/os/Parcel;Z)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->j:Lcom/google/android/gms/common/server/response/zan;
    ...
    .line 6
    invoke-static {p1, v2, v1, p2, v4}, Loe/a;->n(Landroid/os/Parcel;ILandroid/os/Parcelable;IZ)V
