...
.field public static final enum BIZ_SPECIFIC_RPC:Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;

.field public static final enum BIZ_SPECIFIC_SCHEDULED:Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;
...
.field public static final enum SCHEDULED:Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;
...
.method public static constructor <clinit>()V
    ...
    sput-object v10, Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;->SCHEDULED:Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;

    .line 13
    new-instance v8, Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;

    const-string v6, "BIZ_SPECIFIC"

    const/16 v4, 0xc

    invoke-direct {v8, v6, v4}, Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;-><init>(Ljava/lang/String;I)V

    sput-object v8, Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;->BIZ_SPECIFIC:Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;

    .line 14
    new-instance v6, Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;

    const-string v4, "BIZ_SPECIFIC_RPC"

    const/16 v2, 0xd

    invoke-direct {v6, v4, v2}, Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;-><init>(Ljava/lang/String;I)V

    sput-object v6, Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;->BIZ_SPECIFIC_RPC:Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;

    .line 15
    new-instance v4, Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;

    const-string v2, "BIZ_SPECIFIC_SCHEDULED"

    move-object/from16 v17, v6

    const/16 v6, 0xe

    invoke-direct {v4, v2, v6}, Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;->BIZ_SPECIFIC_SCHEDULED:Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;

    const/16 v2, 0xf

    new-array v2, v2, [Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;
    ...
    .line 16
    sput-object v2, Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;->$VALUES:[Lcom/alipay/mobile/framework/service/common/TaskScheduleService$ScheduleType;
