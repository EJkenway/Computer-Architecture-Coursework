.class public Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;
...
.field private e:Lcom/alipay/mobile/worker/v8worker/V8Worker;
...
.method public static constructor <clinit>()V
    ...
    const-string v1, ":NXPostMessageDispatcher"
    ...
    sput-object v0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->a:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Lcom/alipay/mobile/worker/v8worker/V8Worker;Lcom/alibaba/ariver/app/api/App;)V
    .locals 2
    ...
    iput-object v0, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->renderRendyLock:Landroid/os/ConditionVariable;

    const-string/jumbo v0, "viewId"

    .line 3
    iput-object v0, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->c:Ljava/lang/String;

    const/4 v0, 0x0

    .line 4
    iput-boolean v0, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->d:Z

    .line 5
    iput v0, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->g:I
    ...
    iput-object v0, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->b:Ljava/util/concurrent/BlockingQueue;

    .line 7
    iput-object p1, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->e:Lcom/alipay/mobile/worker/v8worker/V8Worker;

    .line 8
    iput-object p2, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->f:Lcom/alibaba/ariver/app/api/App;
    ...
    iput p1, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->g:I
    :try_end_0
    ...
    .line 10
    :catch_0
    sget-object p1, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->a:Ljava/lang/String;

    const-string/jumbo p2, "parse ta_messagequeue_init_timeout error"
...
.method private a()Lcom/alibaba/ariver/engine/api/bridge/EngineRouter;
    ...
    .line 11
    iget-object v0, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->f:Lcom/alibaba/ariver/app/api/App;
    ...
    .line 12
    sget-object v0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->a:Ljava/lang/String;
...
.method private a(Lcom/alibaba/ariver/engine/api/Render;)Z
    ...
    .line 1
    invoke-static {p1}, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->b(Lcom/alibaba/ariver/engine/api/Render;)Z
    ...
    .line 4
    iget-object v0, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->renderRendyLock:Landroid/os/ConditionVariable;
    ...
    const-string/jumbo v2, "prerun registerStatusListenerForStatusCode for t0"
    ...
    .line 6
    new-instance v3, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher$3;

    invoke-direct {v3, p0, p1}, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher$3;-><init>(Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;Lcom/alipay/mobile/nebulax/engine/webview/v8/RenderLoadingStatusChangePoint;)V
    ...
    .line 7
    iget-object p1, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->renderRendyLock:Landroid/os/ConditionVariable;

    iget v2, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->g:I
    ...
    const-string/jumbo p1, "prerun,uc get t0"
...
.method public dispatch(Lcom/alibaba/fastjson/JSONObject;)V
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->b:Ljava/util/concurrent/BlockingQueue;
...
.method public run()V
    ...
    :cond_0
    :goto_0
    iget-boolean v0, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->d:Z
    ...
    .line 8
    :cond_1
    iget-object v3, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->f:Lcom/alibaba/ariver/app/api/App;

    .line 9
    iget-object v4, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->e:Lcom/alipay/mobile/worker/v8worker/V8Worker;

    invoke-virtual {v4}, Lcom/alipay/mobile/worker/H5Worker;->isRenderReady()Z
    ...
    .line 11
    invoke-direct {p0}, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->a()Lcom/alibaba/ariver/engine/api/bridge/EngineRouter;
    ...
    .line 13
    invoke-direct {p0, v3}, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->a(Lcom/alibaba/ariver/engine/api/Render;)Z
    ...
    .line 14
    :cond_2
    iget-object v3, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->renderRendyLock:Landroid/os/ConditionVariable;

    invoke-virtual {v3}, Landroid/os/ConditionVariable;->close()V

    .line 15
    sget-object v3, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->a:Ljava/lang/String;
    ...
    new-instance v5, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher$1;

    invoke-direct {v5, p0}, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher$1;-><init>(Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;)V
    ...
    .line 17
    iget-object v4, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->renderRendyLock:Landroid/os/ConditionVariable;

    iget v5, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->g:I
    ...
    .line 22
    :cond_5
    iget-object v3, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->e:Lcom/alipay/mobile/worker/v8worker/V8Worker;

    invoke-virtual {v3}, Lcom/alipay/mobile/worker/H5Worker;->isRenderReady()Z
    ...
    new-instance v4, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher$2;

    invoke-direct {v4, p0}, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher$2;-><init>(Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;)V

    invoke-virtual {v3, v4}, Lcom/alipay/mobile/worker/H5Worker;->registerRenderReadyListener(Lcom/alipay/mobile/worker/H5Worker$RenderReadyListener;)V

    .line 25
    iget-object v3, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->renderRendyLock:Landroid/os/ConditionVariable;

    iget v4, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->g:I
    ...
    .line 30
    iget-object v1, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->e:Lcom/alipay/mobile/worker/v8worker/V8Worker;
    ...
    .line 45
    sget-object v1, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->a:Ljava/lang/String;
    ...
    .line 46
    iget-boolean v1, p0, Lcom/alipay/mobile/nebulax/engine/webview/v8/NXPostMessageDispatcher;->d:Z
