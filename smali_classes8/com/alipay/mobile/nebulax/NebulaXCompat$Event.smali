...
.field public static final enum SAVE_APP_INFO:Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;
...
.method public static constructor <clinit>()V
    ...
    const-string v3, "SAVE_APP_INFO"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;->SAVE_APP_INFO:Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;

    .line 3
    new-instance v3, Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;

    const-string v5, "RECEIVE_SYNC"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;->RECEIVE_SYNC:Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;

    .line 4
    new-instance v5, Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;

    const-string v7, "UPDATE_PRIVATE_DATA_DIRECTORY_SUFFIX"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;->UPDATE_PRIVATE_DATA_DIRECTORY_SUFFIX:Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;
    ...
    .line 5
    sput-object v7, Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;->$VALUES:[Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;
...
.method public static valueOf(Ljava/lang/String;)Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;
    ...
    check-cast p0, Lcom/alipay/mobile/nebulax/NebulaXCompat$Event;
