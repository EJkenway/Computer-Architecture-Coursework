...
# direct methods
.method public constructor <init>(IIIIIIIJLlc/s$a;Lcom/google/android/exoplayer2/metadata/Metadata;)V
    .locals 0
    .param p10    # Llc/s$a;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    .line 17
    iput p1, p0, Llc/s;->a:I

    .line 18
    iput p2, p0, Llc/s;->b:I

    .line 19
    iput p3, p0, Llc/s;->c:I

    .line 20
    iput p4, p0, Llc/s;->d:I

    .line 21
    iput p5, p0, Llc/s;->e:I

    .line 22
    invoke-static {p5}, Llc/s;->k(I)I

    move-result p1

    iput p1, p0, Llc/s;->f:I

    .line 23
    iput p6, p0, Llc/s;->g:I

    .line 24
    iput p7, p0, Llc/s;->h:I

    .line 25
    invoke-static {p7}, Llc/s;->f(I)I

    move-result p1

    iput p1, p0, Llc/s;->i:I

    .line 26
    iput-wide p8, p0, Llc/s;->j:J

    .line 27
    iput-object p10, p0, Llc/s;->k:Llc/s$a;

    .line 28
    iput-object p11, p0, Llc/s;->l:Lcom/google/android/exoplayer2/metadata/Metadata;
...
.method public constructor <init>([BI)V
    ...
    .line 3
    invoke-virtual {v0, p2}, Lde/s;->p(I)V
    ...
    iput p1, p0, Llc/s;->e:I

    .line 9
    invoke-static {p1}, Llc/s;->k(I)I
    ...
    iput p1, p0, Llc/s;->h:I

    .line 12
    invoke-static {p1}, Llc/s;->f(I)I
    ...
    .line 13
    invoke-virtual {v0, p1}, Lde/s;->j(I)J

    move-result-wide p1

    iput-wide p1, p0, Llc/s;->j:J

    const/4 p1, 0x0

    .line 14
    iput-object p1, p0, Llc/s;->k:Llc/s$a;

    .line 15
    iput-object p1, p0, Llc/s;->l:Lcom/google/android/exoplayer2/metadata/Metadata;
...
.method public static a(Ljava/util/List;Ljava/util/List;)Lcom/google/android/exoplayer2/metadata/Metadata;
    ...
    .line 5
    invoke-static {v4, v5}, Lcom/google/android/exoplayer2/util/h;->Q0(Ljava/lang/String;Ljava/lang/String;)[Ljava/lang/String;
...
# virtual methods
.method public b(Ljava/util/List;)Llc/s;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, p1}, Llc/s;->a(Ljava/util/List;Ljava/util/List;)Lcom/google/android/exoplayer2/metadata/Metadata;

    move-result-object p1

    .line 2
    invoke-virtual {p0, p1}, Llc/s;->i(Lcom/google/android/exoplayer2/metadata/Metadata;)Lcom/google/android/exoplayer2/metadata/Metadata;
    ...
    iget v1, p0, Llc/s;->a:I

    iget v2, p0, Llc/s;->b:I

    iget v3, p0, Llc/s;->c:I

    iget v4, p0, Llc/s;->d:I

    iget v5, p0, Llc/s;->e:I

    iget v6, p0, Llc/s;->g:I

    iget v7, p0, Llc/s;->h:I

    iget-wide v8, p0, Llc/s;->j:J

    iget-object v10, p0, Llc/s;->k:Llc/s$a;

    move-object v0, p1

    invoke-direct/range {v0 .. v11}, Llc/s;-><init>(IIIIIIIJLlc/s$a;Lcom/google/android/exoplayer2/metadata/Metadata;)V

    return-object p1
.end method

.method public c(Llc/s$a;)Llc/s;
    .locals 13
    .param p1    # Llc/s$a;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    iget-object v11, p0, Llc/s;->l:Lcom/google/android/exoplayer2/metadata/Metadata;
...
.method public d(Ljava/util/List;)Llc/s;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, v0}, Llc/s;->a(Ljava/util/List;Ljava/util/List;)Lcom/google/android/exoplayer2/metadata/Metadata;
...
.method public e()J
    ...
    .line 4
    :goto_1
    iget v2, p0, Llc/s;->g:I

    int-to-long v2, v2

    mul-long v0, v0, v2

    iget v2, p0, Llc/s;->h:I
...
.method public h([BLcom/google/android/exoplayer2/metadata/Metadata;)Lcom/google/android/exoplayer2/Format;
    ...
    .line 3
    :goto_0
    invoke-virtual {p0, p2}, Llc/s;->i(Lcom/google/android/exoplayer2/metadata/Metadata;)Lcom/google/android/exoplayer2/metadata/Metadata;
...
.method public i(Lcom/google/android/exoplayer2/metadata/Metadata;)Lcom/google/android/exoplayer2/metadata/Metadata;
    ...
    .line 1
    iget-object v0, p0, Llc/s;->l:Lcom/google/android/exoplayer2/metadata/Metadata;
