...
.method public static c(Ldb/o0;)Lcom/cocos/runtime/x2;
    .locals 2

    .line 1
    iget-object v0, p0, Ldb/o0;->b:Lcom/cocos/runtime/x2;

    .line 2
    sget-object v1, Lcom/cocos/runtime/x2;->j:Lcom/cocos/runtime/x2;
    ...
    .line 3
    :cond_0
    iget-object p0, p0, Ldb/o0;->m:Ldb/k0;

    if-eqz p0, :cond_1

    .line 4
    iget-object p0, p0, Ldb/k0;->c:Lcom/cocos/runtime/x2;
...
.method public static e([BZLjava/nio/charset/Charset;)Ljava/lang/String;
    .locals 0
    ...
    sget-object p2, Ldb/i;->a:Ljava/nio/charset/Charset;
...
.method public static f(Ldb/z0;)V
    .locals 1

    if-eqz p0, :cond_0

    :try_start_0
    invoke-virtual {p0}, Ldb/z0;->close()V
    :try_end_0
...
.method public static j(Ljava/lang/String;Ljava/util/ArrayList;Z)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v2, p1, v3}, Ldb/z1;->j(Ljava/lang/String;Ljava/util/ArrayList;Z)V
...
.method public static k(Ljava/nio/channels/FileChannel;)V
    .locals 1
...
.method public static m(Ljava/io/File;)Z
    ...
    invoke-static {v5}, Ldb/z1;->m(Ljava/io/File;)Z
    ...
    const-string v2, "deleteRecursive ("
...
.method public static n(Ljava/io/File;Ljava/lang/String;)Z
    .locals 3
...
.method public static p(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v6, v5}, Ldb/z1;->p(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p1}, Ldb/z1;->g(Ljava/io/InputStream;)V

    invoke-static {v3}, Ldb/z1;->k(Ljava/nio/channels/FileChannel;)V

    invoke-static {v0}, Ldb/z1;->h(Ljava/io/OutputStream;)V

    invoke-static {p0}, Ldb/z1;->k(Ljava/nio/channels/FileChannel;)V
    ...
    invoke-static {p1}, Ldb/z1;->k(Ljava/nio/channels/FileChannel;)V
...
.method public static q([C)[B
    .locals 3

    :try_start_0
    sget-object v0, Ldb/i;->a:Ljava/nio/charset/Charset;
...
.method public static r(Ljava/io/File;)Lorg/json/JSONObject;
    .locals 3

    const-string v0, "rt_file_util"

    invoke-static {p0}, Ldb/z1;->v(Ljava/io/File;)Ljava/lang/String;
...
.method public static u(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Ldb/b2;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public static w(Ljava/lang/String;)Lorg/json/JSONArray;
    .locals 3
    ...
    invoke-static {v0}, Ldb/z1;->v(Ljava/io/File;)Ljava/lang/String;
    ...
    const-string v2, "readJsonArrayFromFile error:"
...
.method public static x(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v1, "renameFile, file "
...
.method public static z(Ljava/io/File;)V
    ...
    const-string v2, "make dir failed "
    ...
    const-string v1, "_checkPermission"
    ...
    const-string v2, "no permission to create file "
    ...
    const-string v2, "no permission to write "
    ...
    const-string v2, "no permission to read "
