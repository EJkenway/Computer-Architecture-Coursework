...
.method public constructor <init>()V
    ...
    .line 1
    invoke-direct {p0, v0}, Luc/f;-><init>(Ljava/lang/String;)V
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Luc/f;->a:Lde/s;
    ...
    iput-object v1, p0, Luc/f;->b:Lde/t;

    const/4 v0, 0x0

    .line 5
    iput v0, p0, Luc/f;->f:I

    .line 6
    iput v0, p0, Luc/f;->g:I

    .line 7
    iput-boolean v0, p0, Luc/f;->h:Z

    .line 8
    iput-boolean v0, p0, Luc/f;->i:Z

    .line 9
    iput-object p1, p0, Luc/f;->c:Ljava/lang/String;
...
.method public final a(Lde/t;[BI)Z
    ...
    .line 3
    iget p1, p0, Luc/f;->g:I

    add-int/2addr p1, v0

    iput p1, p0, Luc/f;->g:I
...
.method public c(Lde/t;)V
    ...
    .line 1
    iget-object v0, p0, Luc/f;->e:Llc/a0;
    ...
    iget v2, p0, Luc/f;->l:I

    iget v3, p0, Luc/f;->g:I
    ...
    .line 5
    iget-object v2, p0, Luc/f;->e:Llc/a0;

    invoke-interface {v2, p1, v0}, Llc/a0;->b(Lde/t;I)V

    .line 6
    iget v2, p0, Luc/f;->g:I

    add-int/2addr v2, v0

    iput v2, p0, Luc/f;->g:I

    .line 7
    iget v7, p0, Luc/f;->l:I

    if-ne v2, v7, :cond_0

    .line 8
    iget-object v3, p0, Luc/f;->e:Llc/a0;

    iget-wide v4, p0, Luc/f;->m:J
    ...
    .line 9
    iget-wide v2, p0, Luc/f;->m:J

    iget-wide v4, p0, Luc/f;->j:J

    add-long/2addr v2, v4

    iput-wide v2, p0, Luc/f;->m:J

    .line 10
    iput v1, p0, Luc/f;->f:I

    goto :goto_0

    .line 11
    :cond_2
    iget-object v0, p0, Luc/f;->b:Lde/t;
    ...
    invoke-virtual {p0, p1, v0, v3}, Luc/f;->a(Lde/t;[BI)Z
    ...
    iget-object v1, p0, Luc/f;->b:Lde/t;

    invoke-interface {v0, v1, v3}, Llc/a0;->b(Lde/t;I)V

    .line 15
    iput v2, p0, Luc/f;->f:I

    goto :goto_0

    .line 16
    :cond_3
    invoke-virtual {p0, p1}, Luc/f;->h(Lde/t;)Z
...
.method public f(Llc/k;Luc/i0$d;)V
    ...
    iput-object v0, p0, Luc/f;->d:Ljava/lang/String;
    ...
    iput-object p1, p0, Luc/f;->e:Llc/a0;
...
.method public final g()V
    ...
    .line 1
    iget-object v0, p0, Luc/f;->a:Lde/s;
    ...
    invoke-static {v0}, Lfc/b;->d(Lde/s;)Lfc/b$b;

    move-result-object v0

    .line 3
    iget-object v1, p0, Luc/f;->k:Lcom/google/android/exoplayer2/Format;

    const-string v2, "audio/ac4"

    if-eqz v1, :cond_0

    iget v3, v0, Lfc/b$b;->b:I

    iget v4, v1, Lcom/google/android/exoplayer2/Format;->H:I

    if-ne v3, v4, :cond_0

    iget v3, v0, Lfc/b$b;->a:I

    iget v4, v1, Lcom/google/android/exoplayer2/Format;->I:I
    ...
    iput-object v1, p0, Luc/f;->k:Lcom/google/android/exoplayer2/Format;
    ...
    .line 13
    :cond_1
    iget v1, v0, Lfc/b$b;->c:I

    iput v1, p0, Luc/f;->l:I

    const-wide/32 v1, 0xf4240

    .line 14
    iget v0, v0, Lfc/b$b;->d:I

    int-to-long v3, v0

    mul-long v3, v3, v1

    iget-object v0, p0, Luc/f;->k:Lcom/google/android/exoplayer2/Format;
