...
.field public static final d:Lje/a;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lje/a;->c:Ljava/lang/Object;
...
.method public c(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    .line 1
    invoke-super {p0, p1, p2, p3}, Lje/b;->c(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method public d(Landroid/content/Context;II)Landroid/app/PendingIntent;
    ...
    .line 1
    invoke-super {p0, p1, p2, p3}, Lje/b;->d(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public final f(I)Ljava/lang/String;
    ...
    .line 1
    invoke-super {p0, p1}, Lje/b;->f(I)Ljava/lang/String;
...
.method public g(Landroid/content/Context;)I
    ...
    .line 1
    invoke-super {p0, p1}, Lje/b;->g(Landroid/content/Context;)I
...
.method public h(Landroid/content/Context;I)I
    ...
    .line 1
    invoke-super {p0, p1, p2}, Lje/b;->h(Landroid/content/Context;I)I
...
.method public final k(I)Z
    ...
    .line 1
    invoke-super {p0, p1}, Lje/b;->k(I)Z
...
.method public l(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    .line 1
    invoke-virtual {p0, p1, p2, v0}, Lje/a;->c(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    invoke-static {p1, v0, p3}, Lne/o;->b(Landroid/app/Activity;Landroid/content/Intent;I)Lne/o;

    move-result-object p3

    .line 2
    invoke-virtual {p0, p1, p2, p3, p4}, Lje/a;->q(Landroid/content/Context;ILne/o;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public m(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lje/a;->d(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public o(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    .line 1
    invoke-virtual {p0, p1, p2, p3, p4}, Lje/a;->l(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    .line 2
    invoke-virtual {p0, p1, p2, p3, p4}, Lje/a;->t(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public p(Landroid/content/Context;I)V
    ...
    .line 1
    invoke-virtual {p0, p1, p2, v0, v1}, Lje/b;->e(Landroid/content/Context;IILjava/lang/String;)Landroid/app/PendingIntent;
    ...
    .line 2
    invoke-virtual {p0, p1, p2, v1, v0}, Lje/a;->u(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V

    return-void
.end method

.method public final q(Landroid/content/Context;ILne/o;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 7
    :cond_2
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/k;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 9
    :cond_3
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/k;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 11
    :cond_4
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/k;->g(Landroid/content/Context;I)Ljava/lang/String;
...
.method public final r(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    .line 6
    invoke-static {p1, v0}, Lcom/google/android/gms/common/internal/k;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 10
    invoke-virtual {p0, p1, v0, v1, p2}, Lje/a;->t(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V

    return-object v0
.end method

.method public final s(Landroid/content/Context;Lle/s0;)Lcom/google/android/gms/common/api/internal/zabx;
    .locals 2
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    .line 3
    invoke-direct {v1, p2}, Lcom/google/android/gms/common/api/internal/zabx;-><init>(Lle/s0;)V
    ...
    .line 6
    invoke-virtual {p0, p1, v0}, Lje/b;->j(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public final t(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    .line 4
    invoke-static {p2, p4}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->v1(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Lcom/google/android/gms/common/SupportErrorDialogFragment;
...
.method public final u(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    .line 3
    invoke-virtual {p0, p1}, Lje/a;->v(Landroid/content/Context;)V
    ...
    .line 5
    :cond_2
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/k;->f(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v0

    .line 6
    invoke-static {p1, p2}, Lcom/google/android/gms/common/internal/k;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 14
    invoke-static {p1}, Lue/f;->c(Landroid/content/Context;)Z
    ...
    .line 18
    invoke-static {p1}, Lue/f;->d(Landroid/content/Context;)Z
    ...
    invoke-static {p4}, Lcom/google/android/gms/common/internal/j;->i(Z)V

    sget-object p4, Lje/a;->c:Ljava/lang/Object;

    .line 30
    monitor-enter p4

    :try_start_0
    iget-object v1, p0, Lje/a;->b:Ljava/lang/String;
    ...
    .line 33
    invoke-static {p1}, Lcom/google/android/gms/common/internal/k;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 40
    :cond_8
    sget-object p2, Lje/d;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final v(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, p1}, Lje/f;-><init>(Lje/a;Landroid/content/Context;)V
...
.method public final w(Landroid/app/Activity;Lle/f;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 1
    .param p1    # Landroid/app/Activity;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 1
    invoke-virtual {p0, p1, p3, p4}, Lje/a;->c(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object p4

    const/4 v0, 0x2

    invoke-static {p2, p4, v0}, Lne/o;->c(Lle/f;Landroid/content/Intent;I)Lne/o;

    move-result-object p2

    .line 2
    invoke-virtual {p0, p1, p3, p2, p5}, Lje/a;->q(Landroid/content/Context;ILne/o;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    .line 3
    invoke-virtual {p0, p1, p2, p3, p5}, Lje/a;->t(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public final x(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;I)Z
    ...
    .line 1
    invoke-static {p1}, Lwe/a;->a(Landroid/content/Context;)Z
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p1, p2}, Lje/a;->m(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;)Landroid/app/PendingIntent;
    ...
    .line 4
    invoke-static {p1, v0, p3, v3}, Lcom/google/android/gms/common/api/GoogleApiActivity;->e(Landroid/content/Context;Landroid/app/PendingIntent;IZ)Landroid/content/Intent;
    ...
    .line 5
    invoke-static {p1, v1, p3, v0}, Lye/d;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object p3

    .line 6
    invoke-virtual {p0, p1, p2, v2, p3}, Lje/a;->u(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
