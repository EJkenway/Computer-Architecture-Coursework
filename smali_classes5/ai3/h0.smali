...
.method public static a(Ljava/util/Map;)I
    ...
    invoke-static {p0, v0}, Lyh3/e9;->a(Ljava/lang/String;I)I
...
.method public static b(Landroid/app/Notification;ILjava/lang/String;Lai3/k;)Landroid/app/Notification;
    .locals 4
    ...
    :cond_1
    invoke-virtual {p3}, Lai3/k;->z()Ljava/util/List;
...
.method public static synthetic c(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lai3/h0;->i(ILjava/lang/String;)Ljava/lang/String;
...
.method public static d(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;Landroid/app/Notification;)Lyh3/i$a;
    .locals 7

    new-instance v6, Lai3/i0;
    ...
    invoke-direct/range {v0 .. v5}, Lai3/i0;-><init>(ILjava/lang/String;Landroid/content/Context;Ljava/lang/String;Landroid/app/Notification;)V

    return-object v6
.end method

.method public static e(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;Landroid/app/Notification;)V
    .locals 3
    .annotation build Landroid/annotation/TargetApi;
        value = 0x13
    .end annotation
    ...
    invoke-static {p0, p1, p2, p3, p4}, Lai3/h0;->k(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;Landroid/app/Notification;)V

    :cond_0
    return-void
.end method

.method public static f(Landroid/content/Context;Ljava/util/Map;Lyh3/p4;J)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1}, Lai3/h0;->g(Ljava/util/Map;)Z

    move-result p0

    if-eqz p0, :cond_3

    invoke-static {p1}, Lai3/h0;->a(Ljava/util/Map;)I

    move-result p0

    invoke-static {p1}, Lai3/h0;->h(Ljava/util/Map;)I
    ...
    invoke-virtual {p2, v0}, Lyh3/p4;->d(Landroid/os/Bundle;)Lyh3/p4;
...
.method public static synthetic j(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;Landroid/app/Notification;)V
    .locals 0
...
.method public static k(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;Landroid/app/Notification;)V
    .locals 17
    .annotation build Landroid/annotation/TargetApi;
        value = 0x13
    .end annotation
    ...
    :cond_0
    invoke-static/range {p0 .. p1}, Lai3/k;->b(Landroid/content/Context;Ljava/lang/String;)Lai3/k;

    move-result-object v4

    invoke-static {v3, v1, v2, v4}, Lai3/h0;->b(Landroid/app/Notification;ILjava/lang/String;Lai3/k;)Landroid/app/Notification;
    ...
    invoke-static {v5, v8, v6}, Lyh3/j0;->j(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v1, v5}, Lai3/k;->n(ILandroid/app/Notification;)V
    ...
    invoke-virtual {v4, v1, v3}, Lai3/k;->n(ILandroid/app/Notification;)V
    ...
    invoke-static/range {p2 .. p3}, Lai3/h0;->i(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v4, v3}, Lyh3/i;->i(Ljava/lang/String;)Z
    ...
    invoke-static {v0, v5, v1, v2, v4}, Lai3/h0;->d(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;Landroid/app/Notification;)Lyh3/i$a;

    move-result-object v0

    invoke-virtual {v3, v0, v14}, Lyh3/i;->n(Lyh3/i$a;I)Z
