.class public Lcn/ledongli/ldl/fitnessCourse/ai/business/bonepoint/DetectResultHandler;
...
.method public static a(Lcom/alisports/pose/controller/DetectResult;[I)Z
    .locals 6

    sget-object v0, Lcn/ledongli/ldl/fitnessCourse/ai/business/bonepoint/DetectResultHandler;->$ipChange:Lcom/android/alibaba/ip/runtime/IpChange;

    const-string v1, "9636"
...
.method public static b(Lcom/alisports/pose/controller/DetectResult;)Z
    .locals 5

    sget-object v0, Lcn/ledongli/ldl/fitnessCourse/ai/business/bonepoint/DetectResultHandler;->$ipChange:Lcom/android/alibaba/ip/runtime/IpChange;

    const-string v1, "9648"
...
.method private static c(Ljava/util/List;II[Lcom/alisports/pose/controller/ResultJoint;[F)V
    .locals 4
...
.method public static d(Lcom/alisports/pose/controller/DetectResult;I)Lcom/alisports/pose/controller/ResultJoint;
    .locals 4

    sget-object v0, Lcn/ledongli/ldl/fitnessCourse/ai/business/bonepoint/DetectResultHandler;->$ipChange:Lcom/android/alibaba/ip/runtime/IpChange;

    const-string v1, "9672"
...
.method public static e(Lcom/alisports/pose/controller/DetectResult;)Ljava/lang/String;
    .locals 5
    ...
    .line 1
    :cond_0
    invoke-static {p0}, Lcn/ledongli/ldl/fitnessCourse/ai/business/bonepoint/DetectResultHandler;->b(Lcom/alisports/pose/controller/DetectResult;)Z
...
.method public static f(Lcom/alisports/pose/controller/DetectResult;)I
    .locals 4

    sget-object v0, Lcn/ledongli/ldl/fitnessCourse/ai/business/bonepoint/DetectResultHandler;->$ipChange:Lcom/android/alibaba/ip/runtime/IpChange;

    const-string v1, "9687"
    ...
    .line 5
    invoke-static {v2}, Lcn/ledongli/ldl/fitnessCourse/ai/business/bonepoint/DetectResultHandler;->i(Lcom/alisports/pose/controller/ResultJoint;)Z
...
.method public static g(Lcom/alisports/pose/controller/DetectResult;)Ljava/util/Map;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    invoke-static {v7, v3, v4, v9, v8}, Lcn/ledongli/ldl/fitnessCourse/ai/business/bonepoint/DetectResultHandler;->c(Ljava/util/List;II[Lcom/alisports/pose/controller/ResultJoint;[F)V

    const/4 v10, 0x2

    .line 8
    invoke-static {v7, v4, v10, v9, v8}, Lcn/ledongli/ldl/fitnessCourse/ai/business/bonepoint/DetectResultHandler;->c(Ljava/util/List;II[Lcom/alisports/pose/controller/ResultJoint;[F)V

    const/4 v11, 0x3

    .line 9
    invoke-static {v7, v10, v11, v9, v8}, Lcn/ledongli/ldl/fitnessCourse/ai/business/bonepoint/DetectResultHandler;->c(Ljava/util/List;II[Lcom/alisports/pose/controller/ResultJoint;[F)V

    const/4 v10, 0x4

    .line 10
    invoke-static {v7, v11, v10, v9, v8}, Lcn/ledongli/ldl/fitnessCourse/ai/business/bonepoint/DetectResultHandler;->c(Ljava/util/List;II[Lcom/alisports/pose/controller/ResultJoint;[F)V
...
.method public static h(Lcom/alisports/pose/controller/DetectResult;I)Z
    .locals 7

    sget-object v0, Lcn/ledongli/ldl/fitnessCourse/ai/business/bonepoint/DetectResultHandler;->$ipChange:Lcom/android/alibaba/ip/runtime/IpChange;

    const-string v1, "9712"
...
.method private static i(Lcom/alisports/pose/controller/ResultJoint;)Z
    .locals 5

    sget-object v0, Lcn/ledongli/ldl/fitnessCourse/ai/business/bonepoint/DetectResultHandler;->$ipChange:Lcom/android/alibaba/ip/runtime/IpChange;

    const-string v1, "9729"
