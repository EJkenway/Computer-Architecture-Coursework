...
# static fields
.field private static final DEFAULT_LIB_PLAYER_CORE_VERSION:Ljava/lang/String; = "2.32.0.224.min"
...
.method public static getPlayerCoreVersion()Ljava/lang/String;
    ...
    const-string v1, "getPlayerCoreVersion: *.so is not loaded yet, return the hard-coded version number:2.32.0.224.min"

    invoke-static {v0, v1}, Lcom/tencent/thumbplayer/core/common/TPNativeLog;->printLog(ILjava/lang/String;)V

    const-string v0, "2.32.0.224.min"
...
.method private static loadLib(Landroid/content/Context;)Z
    ...
    const-string v4, "tpthirdparties-master"
    ...
    const-string v6, "2.32.0.224.min"
    ...
    const-string v3, ") doesn\'t match javaPlayerCoreVer:(2.32.0)"
