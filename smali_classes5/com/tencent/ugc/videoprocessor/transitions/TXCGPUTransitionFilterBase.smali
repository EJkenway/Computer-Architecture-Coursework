...
# static fields
.field public static final FRAG_GET_FROM_COLOR:Ljava/lang/String; = "vec4 getFromColor(in vec2 uv){\n    vec2 fromTexture = vec2(uv.x,1.0 - uv.y);\n    vec4 fromColor = texture2D(inputImageTexture,fromTexture);\n    return fromColor;\n}"

.field public static final FRAG_GET_TO_COLOR:Ljava/lang/String; = "vec4 getToColor(in vec2 uv){\n    vec2 toTexture = vec2(uv.x,1.0-uv.y);\n    vec4 toColor = texture2D(inputImageTexture,toTexture);\n    return toColor;\n}"

.field public static final FRAG_MAIN:Ljava/lang/String; = "void main() {\n    gl_FragColor = transition(_uv);\n}"

.field public static final FRAG_PUBLIC_DECLARE:Ljava/lang/String; = "precision mediump float;\nvarying mediump vec2 _uv;\nuniform sampler2D inputImageTexture;\nuniform float progress;\nuniform float ratio;"

.field public static final TRANSITION_BASE_VERTEX:Ljava/lang/String; = "attribute vec2 position; \nvarying mediump vec2 _uv;\n  \nvoid main() \n{ \n    gl_Position = vec4(position,0,1); \n    vec2 uv = position * 0.5 + 0.5;\n    _uv = vec2(uv.x,1.0 - uv.y);\n}"
