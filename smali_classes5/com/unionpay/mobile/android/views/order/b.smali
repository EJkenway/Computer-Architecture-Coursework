...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;Ljava/lang/String;)V
    ...
    iput-object v1, p0, Lcom/unionpay/mobile/android/views/order/b;->s:Landroid/widget/AdapterView$OnItemClickListener;

    const/4 v2, 0x0

    iput-boolean v2, p0, Lcom/unionpay/mobile/android/views/order/b;->B:Z
    ...
    iput v2, p0, Lcom/unionpay/mobile/android/views/order/b;->C:I

    const/4 v2, 0x1

    iput v2, p0, Lcom/unionpay/mobile/android/views/order/b;->v:I

    const/4 v2, -0x1

    iput v2, p0, Lcom/unionpay/mobile/android/views/order/b;->u:I
    ...
    iget-object v5, p0, Lcom/unionpay/mobile/android/views/order/b;->k:Ljava/util/List;

    sget-object p3, Lcom/unionpay/mobile/android/languages/c;->bD:Lcom/unionpay/mobile/android/languages/c;

    iget-object v6, p3, Lcom/unionpay/mobile/android/languages/c;->bh:Ljava/lang/String;

    iget-object v7, p0, Lcom/unionpay/mobile/android/views/order/b;->p:Ljava/lang/String;

    iget-object v8, p3, Lcom/unionpay/mobile/android/languages/c;->bi:Ljava/lang/String;

    iget v9, p0, Lcom/unionpay/mobile/android/views/order/b;->v:I

    const/4 v10, 0x0

    move-object v3, p2

    invoke-direct/range {v3 .. v10}, Lcom/unionpay/mobile/android/upwidget/c;-><init>(Landroid/content/Context;Ljava/util/List;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II)V

    iput-object p2, p0, Lcom/unionpay/mobile/android/views/order/b;->o:Lcom/unionpay/mobile/android/upwidget/c;

    invoke-virtual {p2, p1}, Lcom/unionpay/mobile/android/upwidget/c;->a(Landroid/view/View$OnClickListener;)V

    new-instance p1, Lcom/unionpay/mobile/android/upwidget/g;

    iget-object p2, p0, Lcom/unionpay/mobile/android/views/order/AbstractMethod;->b:Landroid/content/Context;
    ...
    invoke-virtual {p1, v1}, Lcom/unionpay/mobile/android/upwidget/g;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object p1, p0, Lcom/unionpay/mobile/android/views/order/b;->n:Lcom/unionpay/mobile/android/upwidget/g;

    invoke-virtual {p1, v0}, Lcom/unionpay/mobile/android/upwidget/g;->a(Landroid/view/View$OnClickListener;)V

    return-void
.end method

.method public static synthetic a(Lcom/unionpay/mobile/android/views/order/b;)V
    .locals 0
...
.method public static synthetic a(Lcom/unionpay/mobile/android/views/order/b;I)V
    .locals 0
...
.method public static synthetic a(Lcom/unionpay/mobile/android/views/order/b;Landroid/view/View;)V
    .locals 4
...
.method public static synthetic b(Lcom/unionpay/mobile/android/views/order/b;)Landroid/widget/PopupWindow;
    .locals 0
...
.method public static synthetic c(Lcom/unionpay/mobile/android/views/order/b;)Lorg/json/JSONObject;
    .locals 0
...
.method public final a(Landroid/widget/RelativeLayout;)V
    ...
    iget-object v1, p0, Lcom/unionpay/mobile/android/views/order/AbstractMethod;->c:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/unionpay/mobile/android/views/order/AbstractMethod;->b:Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/unionpay/mobile/android/views/order/AbstractMethod;->c:Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/unionpay/mobile/android/views/order/AbstractMethod;->a(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/unionpay/mobile/android/views/order/AbstractMethod;->a(Ljava/lang/String;)Z
    ...
    invoke-static {v0}, Lcom/unionpay/mobile/android/views/order/AbstractMethod;->a(Landroid/widget/TextView;)V
...
.method public final b(Landroid/widget/RelativeLayout;)V
    ...
    iget-object v8, p0, Lcom/unionpay/mobile/android/views/order/AbstractMethod;->b:Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/unionpay/mobile/android/views/order/AbstractMethod;->b:Landroid/content/Context;
    ...
    invoke-virtual {p0}, Lcom/unionpay/mobile/android/views/order/AbstractMethod;->g()V
...
.method public final d(Ljava/lang/String;)Lcom/unionpay/mobile/android/views/order/b;
    ...
    iput-object p1, p0, Lcom/unionpay/mobile/android/views/order/AbstractMethod;->c:Ljava/lang/String;
...
.method public final e(Ljava/lang/String;)Lcom/unionpay/mobile/android/views/order/b;
    ...
    iput-object p1, p0, Lcom/unionpay/mobile/android/views/order/AbstractMethod;->d:Ljava/lang/String;
...
.method public final e()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/unionpay/mobile/android/views/order/AbstractMethod;->d:Ljava/lang/String;
