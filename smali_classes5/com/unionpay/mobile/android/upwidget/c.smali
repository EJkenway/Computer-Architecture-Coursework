...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II)V
    ...
    iput v1, p0, Lcom/unionpay/mobile/android/upwidget/c;->i:I

    iput v0, p0, Lcom/unionpay/mobile/android/upwidget/c;->j:I
    ...
    invoke-virtual {p1, p2, p3, p3}, Lcom/unionpay/mobile/android/resource/c;->a(III)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    iput-object p1, p0, Lcom/unionpay/mobile/android/upwidget/c;->a:Landroid/graphics/drawable/Drawable;

    iget-object p1, p0, Lcom/unionpay/mobile/android/upwidget/c;->d:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/unionpay/mobile/android/upwidget/c;->b:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p1, p0, Lcom/unionpay/mobile/android/upwidget/c;->c:Landroid/graphics/drawable/Drawable;

    return-void
.end method

.method public static synthetic a(Lcom/unionpay/mobile/android/upwidget/c;)Ljava/util/ArrayList;
    .locals 0

    iget-object p0, p0, Lcom/unionpay/mobile/android/upwidget/c;->l:Ljava/util/ArrayList;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v3, v0, Lcom/unionpay/mobile/android/upwidget/c;->d:Landroid/content/Context;
    ...
    iget-object v5, v0, Lcom/unionpay/mobile/android/upwidget/c;->d:Landroid/content/Context;
    ...
    iget-object v7, v0, Lcom/unionpay/mobile/android/upwidget/c;->d:Landroid/content/Context;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/unionpay/mobile/android/upwidget/c;->c()I

    move-result v9

    sub-int v9, v1, v9

    iget-object v10, v0, Lcom/unionpay/mobile/android/upwidget/c;->k:Ljava/util/List;
    ...
    :goto_0
    invoke-direct/range {p0 .. p0}, Lcom/unionpay/mobile/android/upwidget/c;->d()Z
    ...
    iget-object v5, v0, Lcom/unionpay/mobile/android/upwidget/c;->e:Ljava/lang/String;
    ...
    invoke-virtual {v9, v13, v8}, Landroid/widget/RelativeLayout$LayoutParams;->addRule(II)V

    invoke-virtual {v9, v14, v8}, Landroid/widget/RelativeLayout$LayoutParams;->addRule(II)V

    sget v10, Lcom/unionpay/mobile/android/global/b;->f:I

    iput v10, v9, Landroid/widget/RelativeLayout$LayoutParams;->leftMargin:I

    invoke-virtual {v4, v1, v9}, Landroid/widget/RelativeLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v1, v0, Lcom/unionpay/mobile/android/upwidget/c;->g:Ljava/lang/String;
    ...
    iget-object v3, v0, Lcom/unionpay/mobile/android/upwidget/c;->g:Ljava/lang/String;
    ...
    iget-object v3, v0, Lcom/unionpay/mobile/android/upwidget/c;->m:Landroid/view/View$OnClickListener;
    ...
    invoke-virtual {v3, v14, v8}, Landroid/widget/RelativeLayout$LayoutParams;->addRule(II)V

    sget v5, Lcom/unionpay/mobile/android/global/b;->f:I
    ...
    :cond_2
    invoke-direct/range {p0 .. p0}, Lcom/unionpay/mobile/android/upwidget/c;->e()Z
    ...
    iget-object v5, v0, Lcom/unionpay/mobile/android/upwidget/c;->f:Ljava/lang/String;
    ...
    invoke-virtual {v5, v13, v8}, Landroid/widget/RelativeLayout$LayoutParams;->addRule(II)V
    ...
    iget-object v5, v0, Lcom/unionpay/mobile/android/upwidget/c;->c:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v12, v0, Lcom/unionpay/mobile/android/upwidget/c;->d:Landroid/content/Context;
    ...
    iget-object v15, v0, Lcom/unionpay/mobile/android/upwidget/c;->d:Landroid/content/Context;
    ...
    invoke-virtual/range {p0 .. p1}, Lcom/unionpay/mobile/android/upwidget/c;->b(I)Landroid/text/Spanned;

    move-result-object v15

    invoke-virtual {v12, v15}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    sget v15, Lcom/unionpay/mobile/android/global/b;->k:F
    ...
    iget-object v11, v0, Lcom/unionpay/mobile/android/upwidget/c;->d:Landroid/content/Context;

    invoke-static {v11, v3}, Lcom/unionpay/mobile/android/utils/g;->a(Landroid/content/Context;F)I

    move-result v11

    iget v15, v0, Lcom/unionpay/mobile/android/upwidget/c;->j:I

    if-nez v15, :cond_7

    iget-boolean v3, v0, Lcom/unionpay/mobile/android/upwidget/c;->h:Z

    if-eqz v3, :cond_4

    iget-object v5, v0, Lcom/unionpay/mobile/android/upwidget/c;->b:Landroid/graphics/drawable/Drawable;

    goto :goto_2

    :cond_4
    iget-object v5, v0, Lcom/unionpay/mobile/android/upwidget/c;->a:Landroid/graphics/drawable/Drawable;

    :goto_2
    if-nez v3, :cond_5

    iget v3, v0, Lcom/unionpay/mobile/android/upwidget/c;->i:I
    ...
    invoke-virtual {v10, v5}, Landroid/widget/ImageView;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual/range {p0 .. p1}, Lcom/unionpay/mobile/android/upwidget/c;->c(I)Z

    move-result v1

    if-eqz v1, :cond_6

    iget-boolean v1, v0, Lcom/unionpay/mobile/android/upwidget/c;->h:Z
    ...
    invoke-virtual {v4, v10, v1}, Landroid/widget/RelativeLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v4, v12, v1}, Landroid/widget/RelativeLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iget v13, v0, Lcom/unionpay/mobile/android/upwidget/c;->i:I
    ...
    invoke-static {v15, v3}, Lcom/unionpay/mobile/android/utils/g;->a(Landroid/content/Context;F)I

    move-result v3

    iget-object v15, v0, Lcom/unionpay/mobile/android/upwidget/c;->d:Landroid/content/Context;

    invoke-static {v15}, Lcom/unionpay/mobile/android/resource/c;->a(Landroid/content/Context;)Lcom/unionpay/mobile/android/resource/c;

    move-result-object v15

    invoke-virtual {v15, v13, v11, v11}, Lcom/unionpay/mobile/android/resource/c;->a(III)Landroid/graphics/drawable/Drawable;

    move-result-object v11

    invoke-direct/range {p0 .. p1}, Lcom/unionpay/mobile/android/upwidget/c;->d(I)Z
