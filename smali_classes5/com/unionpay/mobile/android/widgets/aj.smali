...
.method public constructor <init>(Landroid/content/Context;Lorg/json/JSONObject;Ljava/lang/String;Lcom/unionpay/mobile/android/widgets/aj$a;)V
    ...
    new-instance v2, Lcom/unionpay/mobile/android/widgets/am;

    invoke-direct {v2, p0}, Lcom/unionpay/mobile/android/widgets/am;-><init>(Lcom/unionpay/mobile/android/widgets/aj;)V

    iput-object v2, p0, Lcom/unionpay/mobile/android/widgets/aj;->c:Landroid/widget/AdapterView$OnItemClickListener;

    const/4 v3, 0x0

    iput v3, p0, Lcom/unionpay/mobile/android/widgets/aj;->s:I

    const/4 v4, 0x0

    iput-object v4, p0, Lcom/unionpay/mobile/android/widgets/aj;->t:Lorg/json/JSONArray;

    iput-object v4, p0, Lcom/unionpay/mobile/android/widgets/aj;->u:Lorg/json/JSONArray;
    ...
    iput-boolean v6, p0, Lcom/unionpay/mobile/android/widgets/aj;->B:Z

    iput-object v5, p0, Lcom/unionpay/mobile/android/widgets/aj;->C:Ljava/lang/String;

    iput-object v4, p0, Lcom/unionpay/mobile/android/widgets/aj;->D:Lcom/unionpay/mobile/android/widgets/aj$a;

    iput-object p4, p0, Lcom/unionpay/mobile/android/widgets/aj;->D:Lcom/unionpay/mobile/android/widgets/aj$a;

    iput v3, p0, Lcom/unionpay/mobile/android/widgets/aj;->r:I

    iget-object p4, p0, Lcom/unionpay/mobile/android/widgets/ba;->n:Lorg/json/JSONObject;

    const-string v4, "items"

    invoke-static {p4, v4}, Lcom/unionpay/mobile/android/utils/j;->d(Lorg/json/JSONObject;Ljava/lang/String;)Lorg/json/JSONArray;
    ...
    invoke-virtual {p0, p4}, Lcom/unionpay/mobile/android/widgets/z;->a(Ljava/lang/String;)Z
    ...
    iget v4, p0, Lcom/unionpay/mobile/android/widgets/aj;->s:I

    invoke-direct {p2, p1, p4, v4, p3}, Lcom/unionpay/mobile/android/upwidget/j;-><init>(Landroid/content/Context;Lorg/json/JSONArray;ILjava/lang/String;)V

    iput-object p2, p0, Lcom/unionpay/mobile/android/widgets/aj;->q:Lcom/unionpay/mobile/android/upwidget/j;

    invoke-virtual {p2, v2}, Lcom/unionpay/mobile/android/upwidget/j;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object p1, p0, Lcom/unionpay/mobile/android/widgets/aj;->q:Lcom/unionpay/mobile/android/upwidget/j;

    invoke-virtual {p1, v0}, Lcom/unionpay/mobile/android/upwidget/j;->a(Landroid/view/View$OnClickListener;)V

    iget-object p1, p0, Lcom/unionpay/mobile/android/widgets/aj;->q:Lcom/unionpay/mobile/android/upwidget/j;

    invoke-virtual {p1, v1}, Lcom/unionpay/mobile/android/upwidget/j;->d(Landroid/view/View$OnClickListener;)V

    iget-object p1, p0, Lcom/unionpay/mobile/android/widgets/ba;->m:Landroid/widget/RelativeLayout;
    ...
    invoke-direct {v1, p4, v6}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    iget-object v2, p0, Lcom/unionpay/mobile/android/widgets/ba;->n:Lorg/json/JSONObject;
    ...
    iput-object v1, p0, Lcom/unionpay/mobile/android/widgets/aj;->z:Landroid/widget/RelativeLayout;
    ...
    iget-object v1, p0, Lcom/unionpay/mobile/android/widgets/aj;->z:Landroid/widget/RelativeLayout;

    invoke-virtual {v1, p2}, Landroid/widget/RelativeLayout;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {v1, p0}, Lcom/unionpay/mobile/android/widgets/an;-><init>(Lcom/unionpay/mobile/android/widgets/aj;)V
    ...
    iget-object p3, p0, Lcom/unionpay/mobile/android/widgets/ba;->d:Landroid/content/Context;
    ...
    invoke-virtual {p3, v4, p4, p4}, Lcom/unionpay/mobile/android/resource/c;->a(III)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p3, v4}, Lcom/unionpay/mobile/android/utils/g;->a(Landroid/content/Context;F)I

    move-result p3

    new-instance v4, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {v4, p3, p3}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    const/16 p3, 0xb

    invoke-virtual {v4, p3, p4}, Landroid/widget/RelativeLayout$LayoutParams;->addRule(II)V

    invoke-virtual {v4, v1, p4}, Landroid/widget/RelativeLayout$LayoutParams;->addRule(II)V
    ...
    invoke-virtual {p3, p2, v4}, Landroid/widget/RelativeLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-direct {p3, p4, v4}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    invoke-virtual {p3, v1, p4}, Landroid/widget/RelativeLayout$LayoutParams;->addRule(II)V
    ...
    iget-object v1, p0, Lcom/unionpay/mobile/android/widgets/aj;->v:Landroid/widget/TextView;
    ...
    invoke-direct {p3, p4, v6}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V
    ...
    :cond_2
    invoke-virtual {p0, v6}, Lcom/unionpay/mobile/android/widgets/aj;->a(Z)V

    iget p1, p0, Lcom/unionpay/mobile/android/widgets/aj;->s:I

    invoke-direct {p0, p1, v3}, Lcom/unionpay/mobile/android/widgets/aj;->a(II)V

    return-void
.end method

.method public static synthetic a(Lcom/unionpay/mobile/android/widgets/aj;)Landroid/widget/PopupWindow;
    .locals 0
...
.method public static synthetic a(Lcom/unionpay/mobile/android/widgets/aj;IILjava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method public static synthetic a(Lcom/unionpay/mobile/android/widgets/aj;ILjava/lang/String;)Ljava/lang/String;
    .locals 0
...
.method private a(II)V
    ...
    invoke-virtual {p0, v0}, Lcom/unionpay/mobile/android/widgets/z;->a(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v1}, Lcom/unionpay/mobile/android/widgets/z;->a(Ljava/lang/String;)Z
...
.method public static synthetic a(Lcom/unionpay/mobile/android/widgets/aj;II)V
    .locals 0
...
.method public static synthetic a(Lcom/unionpay/mobile/android/widgets/aj;Landroid/view/View;)V
    .locals 4
...
.method public final a()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/unionpay/mobile/android/widgets/ba;->n()Ljava/lang/String;
...
.method public final a(Z)V
    ...
    :goto_1
    iget-object v1, p0, Lcom/unionpay/mobile/android/widgets/ba;->m:Landroid/widget/RelativeLayout;
...
.method public final a(Landroid/widget/LinearLayout;Ljava/lang/String;)Z
    .locals 6

    invoke-virtual {p0, p2}, Lcom/unionpay/mobile/android/widgets/z;->a(Ljava/lang/String;)Z
    ...
    iget-object p1, p0, Lcom/unionpay/mobile/android/widgets/ba;->n:Lorg/json/JSONObject;
    ...
    iget-object v3, p0, Lcom/unionpay/mobile/android/widgets/ba;->n:Lorg/json/JSONObject;
    ...
    iget-object v3, p0, Lcom/unionpay/mobile/android/widgets/ba;->d:Landroid/content/Context;

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    invoke-virtual {p0}, Lcom/unionpay/mobile/android/widgets/ba;->s()Ljava/lang/String;
