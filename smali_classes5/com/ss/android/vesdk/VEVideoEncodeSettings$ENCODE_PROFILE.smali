...
.method public static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;

    const-string v3, "ENCODE_PROFILE_BASELINE"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;->ENCODE_PROFILE_BASELINE:Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;

    .line 3
    new-instance v3, Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;

    const-string v5, "ENCODE_PROFILE_MAIN"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;->ENCODE_PROFILE_MAIN:Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;

    .line 4
    new-instance v5, Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;

    const-string v7, "ENCODE_PROFILE_HIGH"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;->ENCODE_PROFILE_HIGH:Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;
    ...
    .line 5
    sput-object v7, Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;->$VALUES:[Lcom/ss/android/vesdk/VEVideoEncodeSettings$ENCODE_PROFILE;
