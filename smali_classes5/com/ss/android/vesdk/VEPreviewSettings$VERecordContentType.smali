...
.method public static constructor <clinit>()V
    ...
    const-string v3, "RecordEffectContent"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/ss/android/vesdk/VEPreviewSettings$VERecordContentType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v5, "RecordFullContent"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/ss/android/vesdk/VEPreviewSettings$VERecordContentType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/ss/android/vesdk/VEPreviewSettings$VERecordContentType;->RecordFullContent:Lcom/ss/android/vesdk/VEPreviewSettings$VERecordContentType;

    .line 4
    new-instance v5, Lcom/ss/android/vesdk/VEPreviewSettings$VERecordContentType;

    const-string v7, "RecordIntermediateContent"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/ss/android/vesdk/VEPreviewSettings$VERecordContentType;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/ss/android/vesdk/VEPreviewSettings$VERecordContentType;->RecordIntermediateContent:Lcom/ss/android/vesdk/VEPreviewSettings$VERecordContentType;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/ss/android/vesdk/VEPreviewSettings$VERecordContentType;
    ...
    .line 5
    sput-object v7, Lcom/ss/android/vesdk/VEPreviewSettings$VERecordContentType;->$VALUES:[Lcom/ss/android/vesdk/VEPreviewSettings$VERecordContentType;
