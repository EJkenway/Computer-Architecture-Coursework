...
.method public static constructor <clinit>()V
    ...
    const-string v3, "HD_GET_FRAME_MODE"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;-><init>(Ljava/lang/String;I)V
    ...
    const-string v5, "RENDER_PICTURE_MODE"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;->RENDER_PICTURE_MODE:Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;

    .line 4
    new-instance v5, Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;

    const-string v7, "FOLLOW_SHOT_FRAME_MODE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;->FOLLOW_SHOT_FRAME_MODE:Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;

    .line 5
    new-instance v7, Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;

    const-string v9, "SEQUENCE_FRAME_MODE"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;->SEQUENCE_FRAME_MODE:Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;

    .line 6
    new-instance v9, Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;

    const-string v11, "NO_FRAME_MODE"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;->NO_FRAME_MODE:Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;

    const/4 v11, 0x6

    new-array v11, v11, [Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;
    ...
    .line 7
    sput-object v11, Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;->$VALUES:[Lcom/ss/android/vesdk/VEGetFrameSettings$VEGetFrameType;
