.class Lcom/ss/android/vesdk/VERecorder$7;
...
.field public final synthetic val$originalListener:Lcom/ss/android/vesdk/VERecorder$IShotScreenCallback;
...
# direct methods
.method public constructor <init>(Lcom/ss/android/vesdk/VERecorder;Lcom/ss/android/vesdk/VEShotScreenSettings;JLcom/ss/android/vesdk/VERecorder$IShotScreenCallback;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/ss/android/vesdk/VERecorder$7;->this$0:Lcom/ss/android/vesdk/VERecorder;

    iput-object p2, p0, Lcom/ss/android/vesdk/VERecorder$7;->val$settings:Lcom/ss/android/vesdk/VEShotScreenSettings;

    iput-wide p3, p0, Lcom/ss/android/vesdk/VERecorder$7;->val$shotScreenStartTime:J

    iput-object p5, p0, Lcom/ss/android/vesdk/VERecorder$7;->val$originalListener:Lcom/ss/android/vesdk/VERecorder$IShotScreenCallback;
...
.method public onShotScreen(I)V
    ...
    .line 1
    iget-object v0, p0, Lcom/ss/android/vesdk/VERecorder$7;->val$settings:Lcom/ss/android/vesdk/VEShotScreenSettings;
    ...
    iget-wide v4, p0, Lcom/ss/android/vesdk/VERecorder$7;->val$shotScreenStartTime:J
    ...
    .line 5
    iget-object v1, p0, Lcom/ss/android/vesdk/VERecorder$7;->val$settings:Lcom/ss/android/vesdk/VEShotScreenSettings;
    ...
    .line 6
    iget-object v2, p0, Lcom/ss/android/vesdk/VERecorder$7;->val$settings:Lcom/ss/android/vesdk/VEShotScreenSettings;
    ...
    iget-wide v3, p0, Lcom/ss/android/vesdk/VERecorder$7;->val$shotScreenStartTime:J
    ...
    .line 20
    iget-object v1, p0, Lcom/ss/android/vesdk/VERecorder$7;->val$originalListener:Lcom/ss/android/vesdk/VERecorder$IShotScreenCallback;

    if-eqz v1, :cond_4

    .line 21
    invoke-interface {v1, p1}, Lcom/ss/android/vesdk/VERecorder$IShotScreenCallback;->onShotScreen(I)V

    .line 22
    :cond_4
    iget-object p1, p0, Lcom/ss/android/vesdk/VERecorder$7;->val$settings:Lcom/ss/android/vesdk/VEShotScreenSettings;
