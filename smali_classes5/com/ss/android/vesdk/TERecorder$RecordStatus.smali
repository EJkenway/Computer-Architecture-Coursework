...
.method public static constructor <clinit>()V
    ...
    const-string v3, "INTED"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/ss/android/vesdk/TERecorder$RecordStatus;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v3, v5, v6}, Lcom/ss/android/vesdk/TERecorder$RecordStatus;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/ss/android/vesdk/TERecorder$RecordStatus;->RUNNING:Lcom/ss/android/vesdk/TERecorder$RecordStatus;

    .line 4
    new-instance v5, Lcom/ss/android/vesdk/TERecorder$RecordStatus;

    const-string v7, "RECORDING"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/ss/android/vesdk/TERecorder$RecordStatus;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/ss/android/vesdk/TERecorder$RecordStatus;->RECORDING:Lcom/ss/android/vesdk/TERecorder$RecordStatus;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/ss/android/vesdk/TERecorder$RecordStatus;
    ...
    .line 5
    sput-object v7, Lcom/ss/android/vesdk/TERecorder$RecordStatus;->$VALUES:[Lcom/ss/android/vesdk/TERecorder$RecordStatus;
