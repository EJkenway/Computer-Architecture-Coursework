...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v3, v5, v6}, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;->ENCODE_LEVEL_VERYFAST:Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;
    ...
    invoke-direct {v5, v7, v8}, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;->ENCODE_LEVEL_FASTER:Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;
    ...
    invoke-direct {v7, v9, v10}, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;->ENCODE_LEVEL_FAST:Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;
    ...
    invoke-direct {v9, v11, v12}, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;->ENCODE_LEVEL_MEDIUM:Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;
    ...
    invoke-direct {v11, v13, v14}, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;-><init>(Ljava/lang/String;I)V

    sput-object v11, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;->ENCODE_LEVEL_SLOW:Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;
    ...
    invoke-direct {v13, v15, v14}, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;-><init>(Ljava/lang/String;I)V

    sput-object v13, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;->ENCODE_LEVEL_SLOWER:Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;
    ...
    invoke-direct {v15, v14, v12}, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;-><init>(Ljava/lang/String;I)V

    sput-object v15, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;->ENCODE_LEVEL_VERYSLOW:Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;

    .line 10
    new-instance v14, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;

    const-string v12, "ENCODE_LEVEL_PLACEBO"

    const/16 v10, 0x9

    invoke-direct {v14, v12, v10}, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;-><init>(Ljava/lang/String;I)V

    sput-object v14, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;->ENCODE_LEVEL_PLACEBO:Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;

    const/16 v12, 0xa

    new-array v12, v12, [Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;
    ...
    .line 11
    sput-object v12, Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;->$VALUES:[Lcom/ss/android/vesdk/settings/VEVideoEncodePreset;
