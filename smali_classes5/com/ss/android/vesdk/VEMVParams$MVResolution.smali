...
.method public static constructor <clinit>()V
    ...
    const-string v3, "RES_720P"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/ss/android/vesdk/VEMVParams$MVResolution;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v3, v5, v6}, Lcom/ss/android/vesdk/VEMVParams$MVResolution;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/ss/android/vesdk/VEMVParams$MVResolution;->RES_1080P:Lcom/ss/android/vesdk/VEMVParams$MVResolution;

    new-instance v5, Lcom/ss/android/vesdk/VEMVParams$MVResolution;

    const-string v7, "RES_2K"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/ss/android/vesdk/VEMVParams$MVResolution;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/ss/android/vesdk/VEMVParams$MVResolution;->RES_2K:Lcom/ss/android/vesdk/VEMVParams$MVResolution;

    new-instance v7, Lcom/ss/android/vesdk/VEMVParams$MVResolution;

    const-string v9, "RES_720P_REVERSE"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/ss/android/vesdk/VEMVParams$MVResolution;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/ss/android/vesdk/VEMVParams$MVResolution;->RES_720P_REVERSE:Lcom/ss/android/vesdk/VEMVParams$MVResolution;

    new-instance v9, Lcom/ss/android/vesdk/VEMVParams$MVResolution;

    const-string v11, "RES_FROM_TEMPLATE"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lcom/ss/android/vesdk/VEMVParams$MVResolution;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/ss/android/vesdk/VEMVParams$MVResolution;->RES_FROM_TEMPLATE:Lcom/ss/android/vesdk/VEMVParams$MVResolution;

    new-instance v11, Lcom/ss/android/vesdk/VEMVParams$MVResolution;

    const-string v13, "RES_CUSTOM"

    const/4 v14, 0x6

    invoke-direct {v11, v13, v14}, Lcom/ss/android/vesdk/VEMVParams$MVResolution;-><init>(Ljava/lang/String;I)V

    sput-object v11, Lcom/ss/android/vesdk/VEMVParams$MVResolution;->RES_CUSTOM:Lcom/ss/android/vesdk/VEMVParams$MVResolution;

    const/4 v13, 0x7

    new-array v13, v13, [Lcom/ss/android/vesdk/VEMVParams$MVResolution;
    ...
    .line 2
    sput-object v13, Lcom/ss/android/vesdk/VEMVParams$MVResolution;->$VALUES:[Lcom/ss/android/vesdk/VEMVParams$MVResolution;
