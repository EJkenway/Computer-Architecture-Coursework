...
.method public static constructor <clinit>()V
    ...
    const-string v3, "CAMERA_FLASH_ON"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FLASH_MODE;-><init>(Ljava/lang/String;I)V
    ...
    const-string v5, "CAMERA_FLASH_TORCH"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FLASH_MODE;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FLASH_MODE;->CAMERA_FLASH_TORCH:Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FLASH_MODE;

    .line 4
    new-instance v5, Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FLASH_MODE;

    const-string v7, "CAMERA_FLASH_AUTO"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FLASH_MODE;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FLASH_MODE;->CAMERA_FLASH_AUTO:Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FLASH_MODE;

    .line 5
    new-instance v7, Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FLASH_MODE;

    const-string v9, "CAMERA_FLASH_RED_EYE"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FLASH_MODE;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FLASH_MODE;->CAMERA_FLASH_RED_EYE:Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FLASH_MODE;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FLASH_MODE;
    ...
    .line 6
    sput-object v9, Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FLASH_MODE;->$VALUES:[Lcom/ss/android/vesdk/VECameraSettings$CAMERA_FLASH_MODE;
