...
.method public static b(Landroid/content/Context;Lyh3/e7;)V
    .locals 2
    ...
    new-instance v1, Lyh3/z6$a;

    invoke-direct {v1, p0, p1}, Lyh3/z6$a;-><init>(Landroid/content/Context;Lyh3/e7;)V
...
.method public static c(Landroid/content/Context;Lyh3/e7;Ljava/io/File;[B)V
    .locals 12
    ...
    :goto_2
    invoke-static {p3}, Lth3/c;->D(Ljava/lang/String;)V
    ...
    :cond_4
    invoke-static {p3, v9}, Lyh3/f6;->b([B[B)[B
    ...
    :cond_5
    new-instance v9, Lyh3/g7;

    invoke-direct {v9}, Lyh3/g7;-><init>()V

    invoke-static {v9, v7}, Lcom/xiaomi/push/j;->e(Lyh3/h8;[B)V
    ...
    invoke-virtual {v9, v10, v11}, Lyh3/g7;->l(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_6
    invoke-static {p0, p1, v0}, Lyh3/a7;->c(Landroid/content/Context;Lyh3/e7;Ljava/util/List;)V
...
.method public static synthetic e(Landroid/content/Context;Lyh3/e7;)V
    .locals 0

    invoke-static {p0, p1}, Lyh3/z6;->f(Landroid/content/Context;Lyh3/e7;)V

    return-void
.end method

.method public static f(Landroid/content/Context;Lyh3/e7;)V
    .locals 11
    ...
    sget-boolean v2, Lyh3/z6;->a:Z

    if-nez v2, :cond_4

    const/4 v2, 0x1

    sput-boolean v2, Lyh3/z6;->a:Z
    ...
    :cond_0
    invoke-static {p0}, Lyh3/z6;->a(Landroid/content/Context;)V

    invoke-static {p0}, Lai3/f0;->b(Landroid/content/Context;)[B
    ...
    invoke-static {v7}, Lyh3/j9;->f(Ljava/io/File;)Z
    ...
    :cond_2
    invoke-static {p0, p1, v2, v3}, Lyh3/z6;->c(Landroid/content/Context;Lyh3/e7;Ljava/io/File;[B)V

    const/4 p1, 0x0

    invoke-static {p1}, Lyh3/y6;->c(Z)V

    invoke-static {p0}, Lyh3/z6;->d(Landroid/content/Context;)V

    sput-boolean p1, Lyh3/z6;->a:Z
