...
.method public static getInstance()Lmtopsdk/common/util/ConfigStoreManager;
    ...
    .line 2
    const-class v0, Lmtopsdk/common/util/ConfigStoreManager;

    monitor-enter v0

    .line 3
    :try_start_0
    sget-object v1, Lmtopsdk/common/util/ConfigStoreManager;->instance:Lmtopsdk/common/util/ConfigStoreManager;

    if-nez v1, :cond_0

    .line 4
    new-instance v1, Lmtopsdk/common/util/ConfigStoreManager;

    invoke-direct {v1}, Lmtopsdk/common/util/ConfigStoreManager;-><init>()V

    sput-object v1, Lmtopsdk/common/util/ConfigStoreManager;->instance:Lmtopsdk/common/util/ConfigStoreManager;
...
.method public getAllConfigItems(Landroid/content/Context;Ljava/lang/String;)Ljava/util/Map;
    ...
    const-string v1, "[getAllConfigItems] getConfigItem error,store="
    ...
    const-string p2, "mtopsdk.ConfigStoreManager"

    invoke-static {p2, p1}, Lmtopsdk/common/util/TBSdkLog;->w(Ljava/lang/String;Ljava/lang/String;)V
...
.method public getAllConfigItemsByPrefix(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map;
    ...
    const-string v1, "[getAllConfigItemsByPrefix] getAllConfigItemsByPrefix error,store="
...
.method public getConfigItem(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v1, "[getConfigItem] getConfigItem error,store="

    invoke-virtual {p1, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p1, p2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string p2, ",keyprefix="
...
.method public saveConfigItem(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-interface {p1, v1, p5}, Landroid/content/SharedPreferences$Editor;->putString(Ljava/lang/String;Ljava/lang/String;)Landroid/content/SharedPreferences$Editor;
    ...
    const-string p5, "[saveConfigItem] saveConfigItem error,store="
