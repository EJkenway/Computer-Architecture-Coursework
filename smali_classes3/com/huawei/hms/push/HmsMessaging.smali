...
# virtual methods
.method public final a(Ljava/lang/String;Ljava/lang/String;)Lqc3/f;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, v1, p1, v0}, Lcom/huawei/hms/aaid/plugin/PushProxy;->subscribe(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lqc3/f;
    ...
    invoke-interface {p2, v1, p1, v0}, Lcom/huawei/hms/aaid/plugin/PushProxy;->unsubscribe(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lqc3/f;
    ...
    invoke-virtual {p1, p2}, Lcom/huawei/hms/common/HuaweiApi;->doWrite(Lcom/huawei/hms/common/internal/TaskApiCall;)Lqc3/f;
    ...
    .line 20
    :catch_0
    new-instance p1, Lqc3/g;

    invoke-direct {p1}, Lqc3/g;-><init>()V
    ...
    invoke-virtual {p1, v2}, Lqc3/g;->b(Ljava/lang/Exception;)V
    ...
    .line 23
    invoke-virtual {p1}, Lqc3/g;->a()Lqc3/f;
    ...
    .line 24
    new-instance p2, Lqc3/g;

    invoke-direct {p2}, Lqc3/g;-><init>()V

    .line 25
    invoke-virtual {p2, p1}, Lqc3/g;->b(Ljava/lang/Exception;)V
    ...
    .line 27
    invoke-virtual {p2}, Lqc3/g;->a()Lqc3/f;
...
.method public final a(Z)Lqc3/f;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z)",
    ...
    invoke-virtual {p1, v3}, Lqc3/g;->b(Ljava/lang/Exception;)V
    ...
    invoke-static {v1}, Lqc3/i;->b(Ljava/util/concurrent/Callable;)Lqc3/f;
    ...
    invoke-static {p1}, Lqc3/i;->b(Ljava/util/concurrent/Callable;)Lqc3/f;
    ...
    .line 92
    invoke-virtual {p1, v3}, Lcom/huawei/hms/common/HuaweiApi;->doWrite(Lcom/huawei/hms/common/internal/TaskApiCall;)Lqc3/f;
...
.method public final a(Lcom/huawei/hms/support/api/entity/push/UpSendMsgReq;Ljava/lang/String;)V
    ...
    .line 96
    invoke-virtual {v0, v7}, Lcom/huawei/hms/common/HuaweiApi;->doWrite(Lcom/huawei/hms/common/internal/TaskApiCall;)Lqc3/f;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
...
.method public subscribe(Ljava/lang/String;)Lqc3/f;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-virtual {p0, p1, v0}, Lcom/huawei/hms/push/HmsMessaging;->a(Ljava/lang/String;Ljava/lang/String;)Lqc3/f;
...
.method public turnOffPush()Lqc3/f;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0, v1, v2}, Lcom/huawei/hms/aaid/plugin/PushProxy;->turnOff(Landroid/content/Context;Ljava/lang/String;)Lqc3/f;
    ...
    .line 5
    invoke-virtual {p0, v0}, Lcom/huawei/hms/push/HmsMessaging;->a(Z)Lqc3/f;
...
.method public turnOnPush()Lqc3/f;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-interface {v0, v1, v2}, Lcom/huawei/hms/aaid/plugin/PushProxy;->turnOn(Landroid/content/Context;Ljava/lang/String;)Lqc3/f;
...
.method public unsubscribe(Ljava/lang/String;)Lqc3/f;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
