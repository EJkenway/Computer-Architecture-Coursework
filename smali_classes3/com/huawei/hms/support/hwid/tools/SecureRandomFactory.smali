...
.method public static getSecureRandom()Ljava/security/SecureRandom;
    ...
    .line 5
    new-instance v2, Lfm3/a;

    invoke-direct {v2}, Lfm3/a;-><init>()V
    ...
    .line 7
    new-instance v5, Lhm3/g;

    const/4 v6, 0x1

    invoke-direct {v5, v0, v6}, Lhm3/g;-><init>(Ljava/security/SecureRandom;Z)V

    const/4 v0, 0x0

    invoke-virtual {v5, v2, v3, v4, v0}, Lhm3/g;->a(Lorg/bouncycastle/crypto/a;I[BZ)Lhm3/f;
