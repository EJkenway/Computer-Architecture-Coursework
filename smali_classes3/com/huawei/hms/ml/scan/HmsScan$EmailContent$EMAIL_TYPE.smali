.class final enum Lcom/huawei/hms/ml/scan/HmsScan$EmailContent$EMAIL_TYPE;
...
# static fields
.field private static final synthetic $VALUES:[Lcom/huawei/hms/ml/scan/HmsScan$EmailContent$EMAIL_TYPE;
...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lcom/huawei/hms/ml/scan/HmsScan$EmailContent$EMAIL_TYPE;

    const-string v3, "OFFICE_USE_TYPE"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4, v4}, Lcom/huawei/hms/ml/scan/HmsScan$EmailContent$EMAIL_TYPE;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/huawei/hms/ml/scan/HmsScan$EmailContent$EMAIL_TYPE;->OFFICE_USE_TYPE:Lcom/huawei/hms/ml/scan/HmsScan$EmailContent$EMAIL_TYPE;

    new-instance v3, Lcom/huawei/hms/ml/scan/HmsScan$EmailContent$EMAIL_TYPE;

    const-string v5, "RESIDENTIAL_USE_TYPE"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6, v2}, Lcom/huawei/hms/ml/scan/HmsScan$EmailContent$EMAIL_TYPE;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/huawei/hms/ml/scan/HmsScan$EmailContent$EMAIL_TYPE;->RESIDENTIAL_USE_TYPE:Lcom/huawei/hms/ml/scan/HmsScan$EmailContent$EMAIL_TYPE;

    const/4 v5, 0x3

    new-array v5, v5, [Lcom/huawei/hms/ml/scan/HmsScan$EmailContent$EMAIL_TYPE;
    ...
    .line 2
    sput-object v5, Lcom/huawei/hms/ml/scan/HmsScan$EmailContent$EMAIL_TYPE;->$VALUES:[Lcom/huawei/hms/ml/scan/HmsScan$EmailContent$EMAIL_TYPE;
