...
.method public constructor <init>(Lcom/hpplay/glide/load/engine/Engine;Lcom/hpplay/glide/load/engine/cache/MemoryCache;Lcom/hpplay/glide/load/engine/bitmap_recycle/BitmapPool;Landroid/content/Context;Lcom/hpplay/glide/load/DecodeFormat;)V
    ...
    const-class v2, Lcom/hpplay/glide/load/resource/gifbitmap/GifBitmapWrapper;

    const-class v3, Lcom/hpplay/glide/load/model/ImageVideoWrapper;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 2
    new-instance v4, Lcom/hpplay/glide/request/target/ImageViewTargetFactory;

    invoke-direct {v4}, Lcom/hpplay/glide/request/target/ImageViewTargetFactory;-><init>()V

    iput-object v4, p0, Lcom/hpplay/glide/Glide;->imageViewTargetFactory:Lcom/hpplay/glide/request/target/ImageViewTargetFactory;

    .line 3
    new-instance v4, Lcom/hpplay/glide/load/resource/transcode/TranscoderRegistry;

    invoke-direct {v4}, Lcom/hpplay/glide/load/resource/transcode/TranscoderRegistry;-><init>()V

    iput-object v4, p0, Lcom/hpplay/glide/Glide;->transcoderRegistry:Lcom/hpplay/glide/load/resource/transcode/TranscoderRegistry;
    ...
    invoke-virtual {p1, v5, v6, p2}, Lcom/hpplay/glide/provider/DataLoadProviderRegistry;->register(Ljava/lang/Class;Ljava/lang/Class;Lcom/hpplay/glide/provider/DataLoadProvider;)V

    .line 14
    new-instance v5, Lcom/hpplay/glide/load/resource/bitmap/FileDescriptorBitmapDataLoadProvider;

    invoke-direct {v5, p3, p5}, Lcom/hpplay/glide/load/resource/bitmap/FileDescriptorBitmapDataLoadProvider;-><init>(Lcom/hpplay/glide/load/engine/bitmap_recycle/BitmapPool;Lcom/hpplay/glide/load/DecodeFormat;)V
    ...
    invoke-virtual {p1, p5, v6, v5}, Lcom/hpplay/glide/provider/DataLoadProviderRegistry;->register(Ljava/lang/Class;Ljava/lang/Class;Lcom/hpplay/glide/provider/DataLoadProvider;)V

    .line 16
    new-instance p5, Lcom/hpplay/glide/load/resource/bitmap/ImageVideoDataLoadProvider;

    invoke-direct {p5, p2, v5}, Lcom/hpplay/glide/load/resource/bitmap/ImageVideoDataLoadProvider;-><init>(Lcom/hpplay/glide/provider/DataLoadProvider;Lcom/hpplay/glide/provider/DataLoadProvider;)V

    .line 17
    const-class p2, Landroid/graphics/Bitmap;

    invoke-virtual {p1, v3, p2, p5}, Lcom/hpplay/glide/provider/DataLoadProviderRegistry;->register(Ljava/lang/Class;Ljava/lang/Class;Lcom/hpplay/glide/provider/DataLoadProvider;)V

    .line 18
    new-instance p2, Lcom/hpplay/glide/load/resource/gif/GifDrawableLoadProvider;

    invoke-direct {p2, p4, p3}, Lcom/hpplay/glide/load/resource/gif/GifDrawableLoadProvider;-><init>(Landroid/content/Context;Lcom/hpplay/glide/load/engine/bitmap_recycle/BitmapPool;)V

    .line 19
    const-class v5, Ljava/io/InputStream;

    const-class v6, Lcom/hpplay/glide/load/resource/gif/GifDrawable;
    ...
    invoke-direct {v5, p5, p2, p3}, Lcom/hpplay/glide/load/resource/gifbitmap/ImageVideoGifDrawableLoadProvider;-><init>(Lcom/hpplay/glide/provider/DataLoadProvider;Lcom/hpplay/glide/provider/DataLoadProvider;Lcom/hpplay/glide/load/engine/bitmap_recycle/BitmapPool;)V

    invoke-virtual {p1, v3, v2, v5}, Lcom/hpplay/glide/provider/DataLoadProviderRegistry;->register(Ljava/lang/Class;Ljava/lang/Class;Lcom/hpplay/glide/provider/DataLoadProvider;)V
    ...
    new-instance v3, Lcom/hpplay/glide/load/resource/file/StreamFileDataLoadProvider;

    invoke-direct {v3}, Lcom/hpplay/glide/load/resource/file/StreamFileDataLoadProvider;-><init>()V

    invoke-virtual {p1, p2, p5, v3}, Lcom/hpplay/glide/provider/DataLoadProviderRegistry;->register(Ljava/lang/Class;Ljava/lang/Class;Lcom/hpplay/glide/provider/DataLoadProvider;)V
    ...
    new-instance p5, Lcom/hpplay/glide/load/model/file_descriptor/FileDescriptorFileLoader$Factory;

    invoke-direct {p5}, Lcom/hpplay/glide/load/model/file_descriptor/FileDescriptorFileLoader$Factory;-><init>()V

    invoke-virtual {p0, p1, p2, p5}, Lcom/hpplay/glide/Glide;->register(Ljava/lang/Class;Ljava/lang/Class;Lcom/hpplay/glide/load/model/ModelLoaderFactory;)V
    ...
    new-instance p5, Lcom/hpplay/glide/load/model/stream/StreamFileLoader$Factory;

    invoke-direct {p5}, Lcom/hpplay/glide/load/model/stream/StreamFileLoader$Factory;-><init>()V
    ...
    new-instance p5, Lcom/hpplay/glide/load/model/file_descriptor/FileDescriptorResourceLoader$Factory;

    invoke-direct {p5}, Lcom/hpplay/glide/load/model/file_descriptor/FileDescriptorResourceLoader$Factory;-><init>()V
    ...
    new-instance p5, Lcom/hpplay/glide/load/model/stream/StreamResourceLoader$Factory;

    invoke-direct {p5}, Lcom/hpplay/glide/load/model/stream/StreamResourceLoader$Factory;-><init>()V
    ...
    invoke-virtual {p0, v1, p1, p2}, Lcom/hpplay/glide/Glide;->register(Ljava/lang/Class;Ljava/lang/Class;Lcom/hpplay/glide/load/model/ModelLoaderFactory;)V
    ...
    new-instance p2, Lcom/hpplay/glide/load/model/file_descriptor/FileDescriptorStringLoader$Factory;

    invoke-direct {p2}, Lcom/hpplay/glide/load/model/file_descriptor/FileDescriptorStringLoader$Factory;-><init>()V

    invoke-virtual {p0, v0, p1, p2}, Lcom/hpplay/glide/Glide;->register(Ljava/lang/Class;Ljava/lang/Class;Lcom/hpplay/glide/load/model/ModelLoaderFactory;)V

    .line 29
    const-class p1, Ljava/io/InputStream;

    new-instance p2, Lcom/hpplay/glide/load/model/stream/StreamStringLoader$Factory;

    invoke-direct {p2}, Lcom/hpplay/glide/load/model/stream/StreamStringLoader$Factory;-><init>()V
    ...
    new-instance p5, Lcom/hpplay/glide/load/model/file_descriptor/FileDescriptorUriLoader$Factory;

    invoke-direct {p5}, Lcom/hpplay/glide/load/model/file_descriptor/FileDescriptorUriLoader$Factory;-><init>()V
    ...
    new-instance p5, Lcom/hpplay/glide/load/model/stream/StreamUriLoader$Factory;

    invoke-direct {p5}, Lcom/hpplay/glide/load/model/stream/StreamUriLoader$Factory;-><init>()V
    ...
    new-instance p5, Lcom/hpplay/glide/load/model/stream/StreamUrlLoader$Factory;

    invoke-direct {p5}, Lcom/hpplay/glide/load/model/stream/StreamUrlLoader$Factory;-><init>()V

    invoke-virtual {p0, p1, p2, p5}, Lcom/hpplay/glide/Glide;->register(Ljava/lang/Class;Ljava/lang/Class;Lcom/hpplay/glide/load/model/ModelLoaderFactory;)V

    .line 33
    const-class p1, Lcom/hpplay/glide/load/model/GlideUrl;

    const-class p2, Ljava/io/InputStream;

    new-instance p5, Lcom/hpplay/glide/load/model/stream/HttpUrlGlideUrlLoader$Factory;

    invoke-direct {p5}, Lcom/hpplay/glide/load/model/stream/HttpUrlGlideUrlLoader$Factory;-><init>()V
    ...
    new-instance p5, Lcom/hpplay/glide/load/model/stream/StreamByteArrayLoader$Factory;

    invoke-direct {p5}, Lcom/hpplay/glide/load/model/stream/StreamByteArrayLoader$Factory;-><init>()V
    ...
    new-instance p5, Lcom/hpplay/glide/load/resource/transcode/GlideBitmapDrawableTranscoder;
    ...
    invoke-direct {p5, v0, p3}, Lcom/hpplay/glide/load/resource/transcode/GlideBitmapDrawableTranscoder;-><init>(Landroid/content/res/Resources;Lcom/hpplay/glide/load/engine/bitmap_recycle/BitmapPool;)V

    .line 37
    invoke-virtual {v4, p1, p2, p5}, Lcom/hpplay/glide/load/resource/transcode/TranscoderRegistry;->register(Ljava/lang/Class;Ljava/lang/Class;Lcom/hpplay/glide/load/resource/transcode/ResourceTranscoder;)V

    .line 38
    const-class p1, Lcom/hpplay/glide/load/resource/drawable/GlideDrawable;

    new-instance p2, Lcom/hpplay/glide/load/resource/transcode/GifBitmapWrapperDrawableTranscoder;
    ...
    invoke-direct {p5, p4, p3}, Lcom/hpplay/glide/load/resource/transcode/GlideBitmapDrawableTranscoder;-><init>(Landroid/content/res/Resources;Lcom/hpplay/glide/load/engine/bitmap_recycle/BitmapPool;)V

    invoke-direct {p2, p5}, Lcom/hpplay/glide/load/resource/transcode/GifBitmapWrapperDrawableTranscoder;-><init>(Lcom/hpplay/glide/load/resource/transcode/ResourceTranscoder;)V

    .line 40
    invoke-virtual {v4, v2, p1, p2}, Lcom/hpplay/glide/load/resource/transcode/TranscoderRegistry;->register(Ljava/lang/Class;Ljava/lang/Class;Lcom/hpplay/glide/load/resource/transcode/ResourceTranscoder;)V
