...
.method private static getConfig(Ljava/io/InputStream;Lcom/hpplay/glide/load/DecodeFormat;)Landroid/graphics/Bitmap$Config;
    ...
    .line 1
    sget-object v2, Lcom/hpplay/glide/load/DecodeFormat;->ALWAYS_ARGB_8888:Lcom/hpplay/glide/load/DecodeFormat;

    if-eq p1, v2, :cond_5

    sget-object v2, Lcom/hpplay/glide/load/DecodeFormat;->PREFER_ARGB_8888:Lcom/hpplay/glide/load/DecodeFormat;
    ...
    .line 3
    :try_start_0
    new-instance v4, Lcom/hpplay/glide/load/resource/bitmap/ImageHeaderParser;

    invoke-direct {v4, p0}, Lcom/hpplay/glide/load/resource/bitmap/ImageHeaderParser;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v4}, Lcom/hpplay/glide/load/resource/bitmap/ImageHeaderParser;->hasAlpha()Z
...
.method private static shouldUsePool(Ljava/io/InputStream;)Z
    ...
    .line 3
    :try_start_0
    new-instance v3, Lcom/hpplay/glide/load/resource/bitmap/ImageHeaderParser;

    invoke-direct {v3, p0}, Lcom/hpplay/glide/load/resource/bitmap/ImageHeaderParser;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v3}, Lcom/hpplay/glide/load/resource/bitmap/ImageHeaderParser;->getType()Lcom/hpplay/glide/load/resource/bitmap/ImageHeaderParser$ImageType;

    move-result-object v3

    .line 4
    sget-object v4, Lcom/hpplay/glide/load/resource/bitmap/Downsampler;->TYPES_THAT_USE_POOL:Ljava/util/Set;
...
.method public decode(Ljava/io/InputStream;Lcom/hpplay/glide/load/engine/bitmap_recycle/BitmapPool;IILcom/hpplay/glide/load/DecodeFormat;)Landroid/graphics/Bitmap;
    ...
    .line 3
    invoke-virtual {v11}, Lcom/hpplay/glide/util/ByteArrayPool;->getBytes()[B
    ...
    invoke-direct {v3, v0, v13}, Lcom/hpplay/glide/load/resource/bitmap/RecyclableBufferedInputStream;-><init>(Ljava/io/InputStream;[B)V
    ...
    .line 8
    new-instance v4, Lcom/hpplay/glide/util/MarkEnforcingInputStream;

    invoke-direct {v4, v15}, Lcom/hpplay/glide/util/MarkEnforcingInputStream;-><init>(Ljava/io/InputStream;)V

    const/high16 v0, 0x500000

    .line 9
    :try_start_0
    invoke-virtual {v15, v0}, Lcom/hpplay/glide/util/ExceptionCatchingInputStream;->mark(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
    ...
    invoke-direct {v0, v15}, Lcom/hpplay/glide/load/resource/bitmap/ImageHeaderParser;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v0}, Lcom/hpplay/glide/load/resource/bitmap/ImageHeaderParser;->getOrientation()I
    ...
    .line 11
    :try_start_2
    invoke-virtual {v15}, Lcom/hpplay/glide/util/ExceptionCatchingInputStream;->reset()V
    :try_end_2
    ...
    .line 20
    invoke-virtual {v9, v4, v3, v14}, Lcom/hpplay/glide/load/resource/bitmap/Downsampler;->getDimensions(Lcom/hpplay/glide/util/MarkEnforcingInputStream;Lcom/hpplay/glide/load/resource/bitmap/RecyclableBufferedInputStream;Landroid/graphics/BitmapFactory$Options;)[I
    ...
    .line 23
    invoke-static {v0}, Lcom/hpplay/glide/load/resource/bitmap/TransformationUtils;->getExifOrientationDegrees(I)I
    ...
    .line 26
    invoke-virtual {v15}, Lcom/hpplay/glide/util/ExceptionCatchingInputStream;->getException()Ljava/io/IOException;
    ...
    .line 27
    invoke-static {v1, v10, v0}, Lcom/hpplay/glide/load/resource/bitmap/TransformationUtils;->rotateImageExif(Landroid/graphics/Bitmap;Lcom/hpplay/glide/load/engine/bitmap_recycle/BitmapPool;I)Landroid/graphics/Bitmap;
    ...
    invoke-interface {v10, v1}, Lcom/hpplay/glide/load/engine/bitmap_recycle/BitmapPool;->put(Landroid/graphics/Bitmap;)Z
    ...
    .line 30
    :cond_3
    invoke-virtual {v11, v12}, Lcom/hpplay/glide/util/ByteArrayPool;->releaseBytes([B)Z

    .line 31
    invoke-virtual {v11, v13}, Lcom/hpplay/glide/util/ByteArrayPool;->releaseBytes([B)Z

    .line 32
    invoke-virtual {v15}, Lcom/hpplay/glide/util/ExceptionCatchingInputStream;->release()V

    .line 33
    invoke-static {v14}, Lcom/hpplay/glide/load/resource/bitmap/Downsampler;->releaseOptions(Landroid/graphics/BitmapFactory$Options;)V
