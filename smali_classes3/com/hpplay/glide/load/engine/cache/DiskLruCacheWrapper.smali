...
.method public put(Lcom/hpplay/glide/load/Key;Lcom/hpplay/glide/load/engine/cache/DiskCache$Writer;)V
    ...
    .line 1
    iget-object v1, p0, Lcom/hpplay/glide/load/engine/cache/DiskLruCacheWrapper;->safeKeyGenerator:Lcom/hpplay/glide/load/engine/cache/SafeKeyGenerator;

    invoke-virtual {v1, p1}, Lcom/hpplay/glide/load/engine/cache/SafeKeyGenerator;->getSafeKey(Lcom/hpplay/glide/load/Key;)Ljava/lang/String;

    move-result-object v1

    .line 2
    iget-object v2, p0, Lcom/hpplay/glide/load/engine/cache/DiskLruCacheWrapper;->writeLocker:Lcom/hpplay/glide/load/engine/cache/DiskCacheWriteLocker;

    invoke-virtual {v2, p1}, Lcom/hpplay/glide/load/engine/cache/DiskCacheWriteLocker;->acquire(Lcom/hpplay/glide/load/Key;)V
    ...
    invoke-virtual {v2, v1}, Lcom/hpplay/glide/disklrucache/DiskLruCache;->edit(Ljava/lang/String;)Lcom/hpplay/glide/disklrucache/DiskLruCache$Editor;
    ...
    .line 4
    :try_start_1
    invoke-virtual {v1, v2}, Lcom/hpplay/glide/disklrucache/DiskLruCache$Editor;->getFile(I)Ljava/io/File;

    move-result-object v2

    .line 5
    invoke-interface {p2, v2}, Lcom/hpplay/glide/load/engine/cache/DiskCache$Writer;->write(Ljava/io/File;)Z
    ...
    .line 6
    invoke-virtual {v1}, Lcom/hpplay/glide/disklrucache/DiskLruCache$Editor;->commit()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :cond_0
    :try_start_2
    invoke-virtual {v1}, Lcom/hpplay/glide/disklrucache/DiskLruCache$Editor;->abortUnlessCommitted()V
