...
# instance fields
.field public extraParsers:Ljava/util/List;
...
.field public mAllowPduOverflow:Ljava/lang/Boolean;

.field public mBeaconLayout:Ljava/lang/String;

.field public mDBmCorrection:Ljava/lang/Integer;

.field public final mDataEndOffsets:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/Integer;",
...
.field public final mDataLittleEndianFlags:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/Boolean;",
...
.field public final mDataStartOffsets:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/Integer;",
...
.field public mExtraFrame:Ljava/lang/Boolean;

.field public mHardwareAssistManufacturers:[I

.field public mIdentifier:Ljava/lang/String;

.field public final mIdentifierEndOffsets:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/Integer;",
...
.field public final mIdentifierLittleEndianFlags:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/Boolean;",
...
.field public final mIdentifierStartOffsets:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/Integer;",
...
.field public final mIdentifierVariableLengthFlags:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/Boolean;",
...
.field public mLayoutSize:Ljava/lang/Integer;

.field private mMatchingBeaconTypeCode:Ljava/lang/Long;

.field public mMatchingBeaconTypeCodeEndOffset:Ljava/lang/Integer;

.field public mMatchingBeaconTypeCodeStartOffset:Ljava/lang/Integer;

.field public mPowerEndOffset:Ljava/lang/Integer;

.field public mPowerStartOffset:Ljava/lang/Integer;

.field public mServiceUuid:Ljava/lang/Long;

.field public mServiceUuidEndOffset:Ljava/lang/Integer;

.field public mServiceUuidStartOffset:Ljava/lang/Integer;
...
.method public fromScanData([BILandroid/bluetooth/BluetoothDevice;Lorg/altbeacon/beacon/Beacon;)Lorg/altbeacon/beacon/Beacon;
    ...
    .line 71
    invoke-static {v5, v6}, Lorg/altbeacon/bluetooth/BeaconUtils;->safeParseInt(Ljava/lang/String;I)I
    ...
    .line 72
    invoke-direct {v0, v1, v10, v8, v9}, Lorg/altbeacon/beacon/BeaconParser;->byteArrayToFormattedString([BIIZ)Ljava/lang/String;

    move-result-object v1

    .line 73
    invoke-static {v1, v6}, Lorg/altbeacon/bluetooth/BeaconUtils;->safeParseInt(Ljava/lang/String;I)I
...
.method public setBeaconLayout(Ljava/lang/String;)Lorg/altbeacon/beacon/BeaconParser;
    ...
    iput-object v0, p0, Lorg/altbeacon/beacon/BeaconParser;->mExtraFrame:Ljava/lang/Boolean;
    ...
    const-string v9, "Cannot parse integer byte offset in term: "
