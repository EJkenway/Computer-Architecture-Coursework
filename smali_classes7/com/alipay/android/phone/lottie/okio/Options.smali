...
# instance fields
.field public final byteStrings:[Lcom/alipay/android/phone/lottie/okio/ByteString;
...
.method private static buildTrieRecursive(JLcom/alipay/android/phone/lottie/okio/Buffer;ILjava/util/List;IILjava/util/List;)V
    ...
    .line 29
    invoke-virtual {v3, v4}, Lcom/alipay/android/phone/lottie/okio/ByteString;->getByte(I)B
    ...
    .line 36
    invoke-virtual {v9}, Lcom/alipay/android/phone/lottie/okio/Buffer;->size()J

    move-result-wide v1

    invoke-virtual {v0, v9, v1, v2}, Lcom/alipay/android/phone/lottie/okio/Buffer;->write(Lcom/alipay/android/phone/lottie/okio/Buffer;J)V
...
.method public static varargs of([Lcom/alipay/android/phone/lottie/okio/ByteString;)Lcom/alipay/android/phone/lottie/okio/Options;
    ...
    new-array v0, v1, [Lcom/alipay/android/phone/lottie/okio/ByteString;
    ...
    .line 16
    invoke-virtual {v5, v2}, Lcom/alipay/android/phone/lottie/okio/ByteString;->startsWith(Lcom/alipay/android/phone/lottie/okio/ByteString;)Z
    ...
    invoke-virtual {v2}, Lcom/alipay/android/phone/lottie/okio/ByteString;->size()I
