...
.method public static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;

    const-string v3, "OFF"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;->OFF:Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;

    .line 3
    new-instance v3, Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;

    const-string v5, "RESETTING"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;->RESETTING:Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;

    .line 4
    new-instance v5, Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;

    const-string v7, "UNAUTHORIZED"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;->UNAUTHORIZED:Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;

    .line 5
    new-instance v7, Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;

    const-string v9, "UNKNOWN"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;->UNKNOWN:Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;
    ...
    .line 6
    sput-object v9, Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;->$VALUES:[Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;
...
.method public static valueOf(Ljava/lang/String;)Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;
    ...
    check-cast p0, Lcom/alipay/android/phone/bluetoothsdk/BluetoothState;
