.class public final Lcom/alibaba/ariver/engine/api/R$string;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/alibaba/ariver/engine/api/R;
.end annotation
...
.method public static constructor <clinit>()V
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->api_error_no_storage_permission:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->app_name:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_engine_api_authorization_error:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_engine_api_forbidden_error:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_engine_api_user_not_grant:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_appinfo_mepty:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_cancel:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_choosedate:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_choosetime:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_date_longterm:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_datecancel:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_datevalid:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_download_fail:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_install_fail:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_invalid_api_params:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_ok:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_page_exited:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_page_exited_render_is_empty:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_push_window_in_trans_window:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_unauthorized_user_info:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_jsapi_websocket_already_exist:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_resource_download_error:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_resource_network_is_dismatch:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_resource_none_subpackage_mode:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_resource_parse_error:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_websocket_already_connected:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_websocket_cannot_send_until_connection_is_open:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_websocket_connection_timeout:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_websocket_error_writing_to_stream:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_websocket_invalid_sec_ws_accept_resp:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_websocket_not_wss:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_websocket_placeholder:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_websocket_server_spec_sec_ws_proto_not_req:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_websocket_ssl_handshake_error:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_websocket_unable_alloc_mem_to_read:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_websocket_unknow_error:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_websocket_url_empty:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->ariver_websocket_url_invalid:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->console_toggle_button_text:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->fatal_msg:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->remote_debug_exit:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_apologize_for_the_delay:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_being_init_authorization_panel:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_remote_debug_connect_interrupt:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_remote_debug_connected:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_remote_debug_connecting:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_remote_debug_disconnected:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_remote_debug_exit_cancel:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_remote_debug_exit_confirm:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_remote_debug_exit_dialog_title:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_remote_debug_hit_break_point:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_remote_debug_no_network:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_request_bluetooth_permission:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_request_camera_permission:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_request_clipboard_permission:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_request_contact_permission:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_request_location_permission:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_request_maincity_permission:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_request_photo_permission:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_request_record_permission:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_server_busy_error:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_trace_debug_connect_interrupt:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_trace_debug_connected:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_trace_debug_connecting:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_trace_debug_disconnected:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_trace_debug_experience_connect_interrupt:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_trace_debug_experience_connected:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_trace_debug_experience_disconnected:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_trace_debug_network_connect_interrupt:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_trace_debug_network_connected:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_trace_debug_network_disconnected:I
    ...
    sput v1, Lcom/alibaba/ariver/engine/api/R$string;->tiny_user_cancel_authorization:I
    ...
    sput v0, Lcom/alibaba/ariver/engine/api/R$string;->trace_debug_exit:I
