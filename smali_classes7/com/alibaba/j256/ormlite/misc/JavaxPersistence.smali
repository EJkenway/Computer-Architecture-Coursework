...
.method public static createFieldConfig(Lcom/alibaba/j256/ormlite/db/DatabaseType;Ljava/lang/reflect/Field;)Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;
    ...
    .line 16
    :cond_b
    invoke-virtual {v0, v2}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setFieldName(Ljava/lang/String;)V
    ...
    .line 20
    invoke-virtual {v0, v5}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setColumnName(Ljava/lang/String;)V
    ...
    .line 24
    invoke-virtual {v0, v5}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setColumnDefinition(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v5}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setWidth(I)V
    ...
    invoke-virtual {v0, v5}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setCanBeNull(Z)V
    ...
    invoke-virtual {v0, v5}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setUnique(Z)V
    :try_end_0
    ...
    invoke-virtual {v0, v6}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setCanBeNull(Z)V
    :try_end_1
    ...
    .line 39
    invoke-virtual {v0, v5}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setId(Z)V

    goto :goto_3

    .line 40
    :cond_13
    invoke-virtual {v0, v5}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setGeneratedId(Z)V
    ...
    .line 43
    :cond_16
    invoke-virtual {v0, v5}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setForeign(Z)V
    ...
    .line 47
    invoke-virtual {v0, v4}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setColumnName(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setCanBeNull(Z)V
    ...
    invoke-virtual {v0, v2}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setUnique(Z)V
    :try_end_2
    ...
    :cond_19
    :goto_4
    invoke-virtual {v0, v5}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setForeignCollection(Z)V
    ...
    .line 59
    invoke-virtual {v0, v2}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setForeignCollectionColumnName(Ljava/lang/String;)V
    ...
    .line 63
    invoke-virtual {v0, v5}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setForeignCollectionEager(Z)V
    :try_end_3
    ...
    .line 68
    sget-object v2, Lcom/alibaba/j256/ormlite/field/DataType;->ENUM_STRING:Lcom/alibaba/j256/ormlite/field/DataType;

    invoke-virtual {v0, v2}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setDataType(Lcom/alibaba/j256/ormlite/field/DataType;)V

    goto :goto_6

    .line 69
    :cond_1c
    sget-object v2, Lcom/alibaba/j256/ormlite/field/DataType;->ENUM_INTEGER:Lcom/alibaba/j256/ormlite/field/DataType;
    ...
    .line 71
    invoke-virtual {v0, v5}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setVersion(Z)V

    .line 72
    :cond_1e
    invoke-virtual {v0}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->getDataPersister()Lcom/alibaba/j256/ormlite/field/DataPersister;
    ...
    invoke-virtual {v0, v2}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setDataPersister(Lcom/alibaba/j256/ormlite/field/DataPersister;)V

    :cond_1f
    const/4 v2, 0x0

    .line 74
    invoke-static {v1, v2}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->findGetMethod(Ljava/lang/reflect/Field;Z)Ljava/lang/reflect/Method;
    ...
    .line 75
    invoke-static {v1, v2}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->findSetMethod(Ljava/lang/reflect/Field;Z)Ljava/lang/reflect/Method;
    ...
    .line 76
    :goto_7
    invoke-virtual {v0, v4}, Lcom/alibaba/j256/ormlite/field/DatabaseFieldConfig;->setUseGetSet(Z)V
