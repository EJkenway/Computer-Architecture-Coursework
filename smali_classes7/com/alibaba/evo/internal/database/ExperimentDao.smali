.class public Lcom/alibaba/evo/internal/database/ExperimentDao;
...
# static fields
.field public static final TABLE_NAME:Ljava/lang/String; = "experiments_v1"
...
.method public static w(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
    ...
    const-string v1, "alter table experiments_v1 add "
...
.method public static x(Landroid/database/sqlite/SQLiteDatabase;Z)V
    .locals 5
    ...
    const-string p1, "experiments_v1"
    ...
    const-string v2, " VARCHAR(2048) NOT NULL, "
    ...
    const-string v2, " VARCHAR(4096) NOT NULL, "
    ...
    const-string v4, "hit_latest_time"
    ...
    const-string v3, " VARCHAR(64) NOT NULL DEFAULT \'0\', "
    ...
    const-string v3, "priority_level_int"

    invoke-virtual {v0, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v1, "ext_string"
    ...
    const-string p1, "CREATE INDEX IF NOT EXISTS experiments_v1_key_idx ON experiments_v1(key)"
...
.method public static y(Landroid/database/sqlite/SQLiteDatabase;Z)V
    ...
    const-string v1, "experiments_v1"
...
# virtual methods
.method public A(Landroid/database/Cursor;)Lcom/alibaba/evo/internal/database/ExperimentDO;
    .locals 1

    .line 1
    new-instance v0, Lcom/alibaba/evo/internal/database/ExperimentDO;

    invoke-direct {v0, p1}, Lcom/alibaba/evo/internal/database/ExperimentDO;-><init>(Landroid/database/Cursor;)V
...
.method public B(Ljava/util/Map;)V
    ...
    const-string v2, "UPDATE experiments_v1 SET hit_count = hit_count + "
    ...
    invoke-virtual {v1, v0}, Lcom/alibaba/ut/abtest/internal/database/Database;->c(Ljava/lang/String;)V
...
.method public f()Ljava/lang/String;
    ...
    const-string v0, "experiments_v1"
...
.method public bridge synthetic m(Landroid/database/Cursor;)Lcom/alibaba/ut/abtest/internal/database/DataObject;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/alibaba/evo/internal/database/ExperimentDao;->A(Landroid/database/Cursor;)Lcom/alibaba/evo/internal/database/ExperimentDO;
...
.method public z()Ljava/util/Map;
    ...
    invoke-direct {v1, v4, v2}, Lcom/alibaba/ut/abtest/internal/database/WhereCondition;-><init>(Ljava/lang/String;[Ljava/lang/Object;)V

    new-array v2, v3, [Lcom/alibaba/ut/abtest/internal/database/WhereCondition;
    ...
    const-string v3, "hit_latest_time"
    ...
    .line 6
    invoke-virtual/range {v4 .. v10}, Lcom/alibaba/ut/abtest/internal/database/BaseDao;->query([Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;[Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 10
    invoke-virtual {v2}, Lcom/alibaba/ut/abtest/internal/database/ABDataObject;->getId()J
