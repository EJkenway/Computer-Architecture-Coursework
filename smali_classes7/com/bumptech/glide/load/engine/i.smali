...
.method public constructor <init>(Lx3/h;Lx3/a$a;Ly3/a;Ly3/a;Ly3/a;Ly3/a;Lcom/bumptech/glide/load/engine/p;Lcom/bumptech/glide/load/engine/m;Lcom/bumptech/glide/load/engine/a;Lcom/bumptech/glide/load/engine/i$b;Lcom/bumptech/glide/load/engine/i$a;Lcom/bumptech/glide/load/engine/v;Z)V
    .locals 11
    ...
    .line 3
    iput-object v8, v7, Lcom/bumptech/glide/load/engine/i;->c:Lx3/h;
    ...
    invoke-direct {v9, p2}, Lcom/bumptech/glide/load/engine/i$c;-><init>(Lx3/a$a;)V
    ...
    invoke-direct/range {v0 .. v6}, Lcom/bumptech/glide/load/engine/i$b;-><init>(Ly3/a;Ly3/a;Ly3/a;Ly3/a;Lcom/bumptech/glide/load/engine/k;Lcom/bumptech/glide/load/engine/n$a;)V
    ...
    .line 18
    invoke-interface {p1, p0}, Lx3/h;->c(Lx3/h$a;)V

    return-void
.end method

.method public constructor <init>(Lx3/h;Lx3/a$a;Ly3/a;Ly3/a;Ly3/a;Ly3/a;Z)V
    .locals 14
...
.method public static j(Ljava/lang/String;JLt3/b;)V
    ...
    invoke-static {p1, p2}, Ln4/f;->a(J)D
...
# virtual methods
.method public declared-synchronized a(Lcom/bumptech/glide/load/engine/j;Lt3/b;)V
    .locals 1
    ...
    invoke-virtual {v0, p2, p1}, Lcom/bumptech/glide/load/engine/p;->d(Lt3/b;Lcom/bumptech/glide/load/engine/j;)V
    :try_end_0
...
.method public c(Lt3/b;Lcom/bumptech/glide/load/engine/n;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Lcom/bumptech/glide/load/engine/a;->d(Lt3/b;)V
    ...
    .line 3
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/i;->c:Lx3/h;

    invoke-interface {v0, p1, p2}, Lx3/h;->b(Lt3/b;Lcom/bumptech/glide/load/engine/s;)Lcom/bumptech/glide/load/engine/s;
...
.method public declared-synchronized d(Lcom/bumptech/glide/load/engine/j;Lt3/b;Lcom/bumptech/glide/load/engine/n;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p2, p3}, Lcom/bumptech/glide/load/engine/a;->a(Lt3/b;Lcom/bumptech/glide/load/engine/n;)V

    .line 3
    :cond_0
    iget-object p3, p0, Lcom/bumptech/glide/load/engine/i;->a:Lcom/bumptech/glide/load/engine/p;

    invoke-virtual {p3, p2, p1}, Lcom/bumptech/glide/load/engine/p;->d(Lt3/b;Lcom/bumptech/glide/load/engine/j;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final e(Lt3/b;)Lcom/bumptech/glide/load/engine/n;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v0, p1}, Lx3/h;->a(Lt3/b;)Lcom/bumptech/glide/load/engine/s;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/bumptech/glide/load/engine/n;-><init>(Lcom/bumptech/glide/load/engine/s;ZZLt3/b;Lcom/bumptech/glide/load/engine/n$a;)V
...
.method public f(Lcom/bumptech/glide/e;Ljava/lang/Object;Lt3/b;IILjava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/Priority;Lcom/bumptech/glide/load/engine/h;Ljava/util/Map;ZZLt3/e;ZZZZLcom/bumptech/glide/request/h;Ljava/util/concurrent/Executor;)Lcom/bumptech/glide/load/engine/i$d;
    .locals 24
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    .line 3
    invoke-virtual/range {v0 .. v8}, Lcom/bumptech/glide/load/engine/m;->a(Ljava/lang/Object;Lt3/b;IILjava/util/Map;Ljava/lang/Class;Ljava/lang/Class;Lt3/e;)Lcom/bumptech/glide/load/engine/l;
    ...
    .line 5
    :try_start_0
    invoke-virtual {v15, v0, v12, v13, v14}, Lcom/bumptech/glide/load/engine/i;->i(Lcom/bumptech/glide/load/engine/l;ZJ)Lcom/bumptech/glide/load/engine/n;
    ...
    .line 8
    sget-object v0, Lcom/bumptech/glide/load/DataSource;->n:Lcom/bumptech/glide/load/DataSource;

    move-object/from16 v2, p18

    invoke-interface {v2, v1, v0}, Lcom/bumptech/glide/request/h;->onResourceReady(Lcom/bumptech/glide/load/engine/s;Lcom/bumptech/glide/load/DataSource;)V
...
.method public final g(Lt3/b;)Lcom/bumptech/glide/load/engine/n;
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/bumptech/glide/load/engine/a;->e(Lt3/b;)Lcom/bumptech/glide/load/engine/n;
...
.method public final h(Lt3/b;)Lcom/bumptech/glide/load/engine/n;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/load/engine/i;->e(Lt3/b;)Lcom/bumptech/glide/load/engine/n;
    ...
    invoke-virtual {v1, p1, v0}, Lcom/bumptech/glide/load/engine/a;->a(Lt3/b;Lcom/bumptech/glide/load/engine/n;)V
...
.method public final i(Lcom/bumptech/glide/load/engine/l;ZJ)Lcom/bumptech/glide/load/engine/n;
    ...
    .line 1
    :cond_0
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/load/engine/i;->g(Lt3/b;)Lcom/bumptech/glide/load/engine/n;
    ...
    .line 3
    invoke-static {v0, p3, p4, p1}, Lcom/bumptech/glide/load/engine/i;->j(Ljava/lang/String;JLt3/b;)V
    ...
    .line 4
    :cond_2
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/load/engine/i;->h(Lt3/b;)Lcom/bumptech/glide/load/engine/n;
...
.method public final l(Lcom/bumptech/glide/e;Ljava/lang/Object;Lt3/b;IILjava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/Priority;Lcom/bumptech/glide/load/engine/h;Ljava/util/Map;ZZLt3/e;ZZZZLcom/bumptech/glide/request/h;Ljava/util/concurrent/Executor;Lcom/bumptech/glide/load/engine/l;J)Lcom/bumptech/glide/load/engine/i$d;
    ...
    invoke-virtual {v3, v15, v12}, Lcom/bumptech/glide/load/engine/p;->a(Lt3/b;Z)Lcom/bumptech/glide/load/engine/j;
    ...
    .line 4
    invoke-static {v2, v13, v14, v15}, Lcom/bumptech/glide/load/engine/i;->j(Ljava/lang/String;JLt3/b;)V
    ...
    .line 7
    invoke-virtual/range {v3 .. v8}, Lcom/bumptech/glide/load/engine/i$b;->a(Lt3/b;ZZZZ)Lcom/bumptech/glide/load/engine/j;
    ...
    .line 9
    invoke-virtual/range {v3 .. v19}, Lcom/bumptech/glide/load/engine/i$a;->a(Lcom/bumptech/glide/e;Ljava/lang/Object;Lcom/bumptech/glide/load/engine/l;Lt3/b;IILjava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/Priority;Lcom/bumptech/glide/load/engine/h;Ljava/util/Map;ZZZLt3/e;Lcom/bumptech/glide/load/engine/DecodeJob$b;)Lcom/bumptech/glide/load/engine/DecodeJob;
    ...
    invoke-virtual {v4, v2, v1}, Lcom/bumptech/glide/load/engine/p;->c(Lt3/b;Lcom/bumptech/glide/load/engine/j;)V
    ...
    .line 14
    invoke-static {v2, v6, v7, v4}, Lcom/bumptech/glide/load/engine/i;->j(Ljava/lang/String;JLt3/b;)V
