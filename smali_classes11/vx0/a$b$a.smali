...
.field public final synthetic g:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLogSegment;",
            ">;"
        }
    .end annotation
.end field
...
.method public constructor <init>(Lij3/z;Lij3/x;Lij3/z;Lij3/b0;Ljava/lang/Object;Lij3/b0;Ljava/util/List;)V
    ...
    iput-object p1, p0, Lvx0/a$b$a;->a:Lij3/z;

    iput-object p2, p0, Lvx0/a$b$a;->b:Lij3/x;

    iput-object p3, p0, Lvx0/a$b$a;->c:Lij3/z;

    iput-object p4, p0, Lvx0/a$b$a;->d:Lij3/b0;

    iput-object p5, p0, Lvx0/a$b$a;->e:Ljava/lang/Object;

    iput-object p6, p0, Lvx0/a$b$a;->f:Lij3/b0;

    iput-object p7, p0, Lvx0/a$b$a;->g:Ljava/util/List;
...
.method public bridge synthetic a(Lcom/gotokeep/keep/link2/data/LinkBusinessError;ILjava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lvx0/a$b$a;->b(Lcom/gotokeep/keep/link2/data/LinkBusinessError;ILcom/keep/kirin/proto/services/machine/Machine$TrainLogResponseMessage;)V
...
.method public b(Lcom/gotokeep/keep/link2/data/LinkBusinessError;ILcom/keep/kirin/proto/services/machine/Machine$TrainLogResponseMessage;)V
    ...
    .line 1
    iget-object v0, p0, Lvx0/a$b$a;->a:Lij3/z;
    ...
    .line 4
    :cond_1
    iget-object p1, p0, Lvx0/a$b$a;->c:Lij3/z;

    iget-object p2, p0, Lvx0/a$b$a;->f:Lij3/b0;

    iget-object v1, p0, Lvx0/a$b$a;->g:Ljava/util/List;

    iget-object v2, p0, Lvx0/a$b$a;->b:Lij3/x;
    ...
    .line 8
    new-instance v3, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLog;

    invoke-direct {v3}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLog;-><init>()V
    ...
    invoke-virtual {v3, v4}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLog;->l(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v4}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLog;->o(I)V
    ...
    invoke-virtual {v3, v4}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLog;->j(I)V
    ...
    invoke-virtual {v3, v4}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLog;->i(S)V
    ...
    invoke-virtual {v3, v4}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLog;->m(B)V
    ...
    invoke-virtual {v3, v4}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLog;->k(S)V

    .line 15
    invoke-virtual {v3, v1}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLog;->n(Ljava/util/List;)V

    .line 16
    invoke-virtual {p1}, Lcom/keep/kirin/proto/services/machine/Machine$TrainLogSummaryMessage;->getSteps()I

    move-result p1

    int-to-short p1, p1

    invoke-virtual {v3, p1}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLog;->p(S)V
    ...
    .line 24
    new-instance v4, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLogSegment;

    invoke-direct {v4}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLogSegment;-><init>()V
    ...
    invoke-virtual {v4, v5}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLogSegment;->m(S)V
    ...
    invoke-virtual {v4, v5}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLogSegment;->h(B)V
    ...
    invoke-virtual {v4, v5}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLogSegment;->i(S)V
    ...
    invoke-virtual {v4, v5}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLogSegment;->n(S)V

    .line 29
    invoke-interface {v3}, Lcom/keep/kirin/proto/services/machine/Machine$TrainLogSegmentListMessage$TrainLogSegmentMessageOrBuilder;->getSpm()I

    move-result v5

    int-to-short v5, v5

    invoke-virtual {v4, v5}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLogSegment;->l(S)V

    .line 30
    invoke-interface {v3}, Lcom/keep/kirin/proto/services/machine/Machine$TrainLogSegmentListMessage$TrainLogSegmentMessageOrBuilder;->getPace()I

    move-result v5

    int-to-short v5, v5

    invoke-virtual {v4, v5}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLogSegment;->g(S)V

    .line 31
    invoke-interface {v3}, Lcom/keep/kirin/proto/services/machine/Machine$TrainLogSegmentListMessage$TrainLogSegmentMessageOrBuilder;->getSpeed()I

    move-result v5

    int-to-short v5, v5

    invoke-virtual {v4, v5}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLogSegment;->k(S)V

    .line 32
    invoke-interface {v3}, Lcom/keep/kirin/proto/services/machine/Machine$TrainLogSegmentListMessage$TrainLogSegmentMessageOrBuilder;->getSlope()I

    move-result v3

    int-to-short v3, v3

    invoke-virtual {v4, v3}, Lcom/gotokeep/keep/kt/business/puncheur/linkcontract/param/SpinningLogSegment;->j(S)V
    ...
    .line 37
    iget-object p1, p0, Lvx0/a$b$a;->b:Lij3/x;

    iget-object p2, p0, Lvx0/a$b$a;->c:Lij3/z;

    iget-object p3, p0, Lvx0/a$b$a;->d:Lij3/b0;
    ...
    .line 43
    iget-object p1, p0, Lvx0/a$b$a;->d:Lij3/b0;
    ...
    :cond_5
    :goto_4
    iget-object p1, p0, Lvx0/a$b$a;->e:Ljava/lang/Object;

    iget-object p2, p0, Lvx0/a$b$a;->b:Lij3/x;

    iget-object p3, p0, Lvx0/a$b$a;->c:Lij3/z;
