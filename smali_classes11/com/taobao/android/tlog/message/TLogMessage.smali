...
.method public init(Lcom/taobao/tao/log/message/MessageInfo;)V
    ...
    const-string v4, "\u521d\u59cb\u5316\u6d88\u606f\u901a\u9053"

    invoke-interface {v2, v3, v0, v4}, Lcom/taobao/tao/log/monitor/TLogMonitor;->stageInfo(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public sendMsg(Lcom/taobao/tao/log/message/MessageInfo;)Lcom/taobao/tao/log/message/MessageReponse;
    ...
    .line 2
    iget-object v1, p1, Lcom/taobao/tao/log/message/MessageInfo;->appKey:Ljava/lang/String;

    .line 3
    iget-object v2, p1, Lcom/taobao/tao/log/message/MessageInfo;->content:Ljava/lang/String;

    .line 4
    iget-object v3, p1, Lcom/taobao/tao/log/message/MessageInfo;->accsServiceId:Ljava/lang/String;

    .line 5
    iget-object p1, p1, Lcom/taobao/tao/log/message/MessageInfo;->accsTag:Ljava/lang/String;
    ...
    .line 7
    :cond_0
    invoke-static {v1}, Lcom/taobao/accs/AccsClientConfig;->getConfig(Ljava/lang/String;)Lcom/taobao/accs/AccsClientConfig;
    ...
    .line 9
    :try_start_0
    invoke-static {p1}, Lcom/taobao/accs/ACCSClient;->getAccsClient(Ljava/lang/String;)Lcom/taobao/accs/ACCSClient;
    ...
    invoke-direct {v4, v5, v3, v2, v1}, Lcom/taobao/accs/ACCSManager$AccsRequest;-><init>(Ljava/lang/String;Ljava/lang/String;[BLjava/lang/String;)V

    .line 11
    invoke-virtual {p1, v4}, Lcom/taobao/accs/ACCSClient;->sendRequest(Lcom/taobao/accs/ACCSManager$AccsRequest;)Ljava/lang/String;

    .line 12
    new-instance p1, Lcom/taobao/tao/log/message/MessageReponse;

    invoke-direct {p1}, Lcom/taobao/tao/log/message/MessageReponse;-><init>()V

    .line 13
    iput-object v1, p1, Lcom/taobao/tao/log/message/MessageReponse;->result:Ljava/lang/String;

    const-string v2, "dataId"

    .line 14
    iput-object v2, p1, Lcom/taobao/tao/log/message/MessageReponse;->dataId:Ljava/lang/String;

    .line 15
    iput-object v3, p1, Lcom/taobao/tao/log/message/MessageReponse;->serviceId:Ljava/lang/String;

    const-string v2, "userId"

    .line 16
    iput-object v2, p1, Lcom/taobao/tao/log/message/MessageReponse;->userId:Ljava/lang/String;
    ...
    invoke-interface {v2, v3, v0, p1}, Lcom/taobao/tao/log/monitor/TLogMonitor;->stageError(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    const-string v2, "ut_tlog_accs_send_err"

    invoke-static {v2, v0, p1}, Lcom/taobao/tao/log/statistics/TLogEventHelper;->errorEvent(Ljava/lang/String;Lcom/taobao/tao/log/statistics/ErrorCode;Ljava/lang/String;)V
...
.method public sendStartUp(Lcom/taobao/tao/log/message/MessageInfo;)Lcom/taobao/tao/log/message/MessageReponse;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/taobao/android/tlog/message/TLogMessage;->sendMsg(Lcom/taobao/tao/log/message/MessageInfo;)Lcom/taobao/tao/log/message/MessageReponse;
