...
.method public final tI()Lorg/json/JSONObject;
    ...
    invoke-static {v2}, Lcom/kwad/sdk/collector/e;->ba(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v0, v1, v2}, Lcom/kwad/sdk/utils/s;->putValue(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0}, Lcom/kwad/sdk/collector/model/jni/UploadEntryNative;->tK()Ljava/lang/String;
