...
.method public processUploadingFailed(Ljava/util/List;)V
    ...
    invoke-virtual {p1, v0}, Lcom/nirvana/tools/logger/cache/ACMCacheManager;->deleteRecords(Ljava/util/List;)V
...
.method public startLoop()V
    ...
    new-instance v3, Lcom/nirvana/tools/logger/upload/ACMMonitorUploadManager$1;

    invoke-direct {v3, p0}, Lcom/nirvana/tools/logger/upload/ACMMonitorUploadManager$1;-><init>(Lcom/nirvana/tools/logger/upload/ACMMonitorUploadManager;)V

    invoke-direct {v0, v1, v2, v3}, Lcom/nirvana/tools/logger/executor/Timer;-><init>(JLjava/lang/Runnable;)V
