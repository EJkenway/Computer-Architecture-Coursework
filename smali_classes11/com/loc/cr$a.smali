.class public final Lcom/loc/cr$a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/loc/cr$a;->f:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/loc/cr$a;->g:Ljava/util/List;

    return-void
.end method

.method public static a(Lcom/loc/dr;Lcom/loc/dr;)Z
    .locals 4
...
.method public final a()V
    ...
    iput-byte v0, p0, Lcom/loc/cr$a;->a:B
    ...
    iput-object v0, p0, Lcom/loc/cr$a;->c:Lcom/loc/dr;

    iput-object v0, p0, Lcom/loc/cr$a;->d:Lcom/loc/dr;

    iput-object v0, p0, Lcom/loc/cr$a;->e:Lcom/loc/dr;

    iget-object v0, p0, Lcom/loc/cr$a;->f:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iget-object v0, p0, Lcom/loc/cr$a;->g:Ljava/util/List;
...
.method public final a(BLjava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {p0}, Lcom/loc/cr$a;->a()V

    iput-byte p1, p0, Lcom/loc/cr$a;->a:B

    iput-object p2, p0, Lcom/loc/cr$a;->b:Ljava/lang/String;

    if-eqz p3, :cond_2

    iget-object p1, p0, Lcom/loc/cr$a;->f:Ljava/util/List;
    ...
    iget-boolean v0, p2, Lcom/loc/dr;->h:Z

    if-eqz v0, :cond_1

    iput-object p2, p0, Lcom/loc/cr$a;->d:Lcom/loc/dr;
    ...
    iput-object p2, p0, Lcom/loc/cr$a;->e:Lcom/loc/dr;

    goto :goto_0

    :cond_2
    iget-object p1, p0, Lcom/loc/cr$a;->d:Lcom/loc/dr;

    if-nez p1, :cond_3

    iget-object p1, p0, Lcom/loc/cr$a;->e:Lcom/loc/dr;

    :cond_3
    iput-object p1, p0, Lcom/loc/cr$a;->c:Lcom/loc/dr;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-byte v1, p0, Lcom/loc/cr$a;->a:B
    ...
    iget-object v1, p0, Lcom/loc/cr$a;->b:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/loc/cr$a;->c:Lcom/loc/dr;
    ...
    iget-object v1, p0, Lcom/loc/cr$a;->d:Lcom/loc/dr;
    ...
    iget-object v1, p0, Lcom/loc/cr$a;->e:Lcom/loc/dr;
    ...
    iget-object v1, p0, Lcom/loc/cr$a;->f:Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/loc/cr$a;->g:Ljava/util/List;
