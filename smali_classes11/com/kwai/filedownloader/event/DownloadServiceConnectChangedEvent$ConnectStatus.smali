...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lcom/kwai/filedownloader/event/DownloadServiceConnectChangedEvent$ConnectStatus;

    const-string v3, "disconnected"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/kwai/filedownloader/event/DownloadServiceConnectChangedEvent$ConnectStatus;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/kwai/filedownloader/event/DownloadServiceConnectChangedEvent$ConnectStatus;->disconnected:Lcom/kwai/filedownloader/event/DownloadServiceConnectChangedEvent$ConnectStatus;

    new-instance v3, Lcom/kwai/filedownloader/event/DownloadServiceConnectChangedEvent$ConnectStatus;

    const-string v5, "lost"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/kwai/filedownloader/event/DownloadServiceConnectChangedEvent$ConnectStatus;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/kwai/filedownloader/event/DownloadServiceConnectChangedEvent$ConnectStatus;->lost:Lcom/kwai/filedownloader/event/DownloadServiceConnectChangedEvent$ConnectStatus;

    const/4 v5, 0x3

    new-array v5, v5, [Lcom/kwai/filedownloader/event/DownloadServiceConnectChangedEvent$ConnectStatus;
    ...
    sput-object v5, Lcom/kwai/filedownloader/event/DownloadServiceConnectChangedEvent$ConnectStatus;->$VALUES:[Lcom/kwai/filedownloader/event/DownloadServiceConnectChangedEvent$ConnectStatus;
