...
.method public static a(BLcom/kwai/filedownloader/c/c;Lcom/kwai/filedownloader/download/d$a;)Lcom/kwai/filedownloader/message/MessageSnapshot;
    .locals 8
    ...
    invoke-static {v6, v5, v3}, Lcom/kwai/filedownloader/e/d;->h(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p2}, Lcom/kwai/filedownloader/download/d$a;->getException()Ljava/lang/Exception;
    ...
    :goto_0
    invoke-virtual {p1}, Lcom/kwai/filedownloader/c/c;->FG()Z
    ...
    invoke-virtual {p2}, Lcom/kwai/filedownloader/download/d$a;->FE()I
    ...
    :cond_7
    invoke-virtual {p1}, Lcom/kwai/filedownloader/c/c;->Fw()Z

    move-result p0

    if-eqz p0, :cond_8

    invoke-virtual {p1}, Lcom/kwai/filedownloader/c/c;->getFilename()Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lcom/kwai/filedownloader/download/d$a;->Hq()Z
    ...
    invoke-virtual {p1}, Lcom/kwai/filedownloader/c/c;->HM()Ljava/lang/String;
    ...
    invoke-static {p2, p1}, Lcom/kwai/filedownloader/e/f;->j(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
...
.method public static e(Lcom/kwai/filedownloader/a;)Lcom/kwai/filedownloader/message/MessageSnapshot;
    .locals 7

    invoke-interface {p0}, Lcom/kwai/filedownloader/a;->FG()Z
    ...
    invoke-interface {p0}, Lcom/kwai/filedownloader/a;->Fy()J

    move-result-wide v3

    invoke-interface {p0}, Lcom/kwai/filedownloader/a;->Fz()J
    ...
    invoke-interface {p0}, Lcom/kwai/filedownloader/a;->getSmallFileSoFarBytes()I

    move-result v2

    invoke-interface {p0}, Lcom/kwai/filedownloader/a;->getSmallFileTotalBytes()I
...
.method public static t(Lcom/kwai/filedownloader/message/MessageSnapshot;)Lcom/kwai/filedownloader/message/MessageSnapshot;
    .locals 4
    ...
    invoke-virtual {p0}, Lcom/kwai/filedownloader/message/MessageSnapshot;->getId()I
    ...
    invoke-static {p0, v1}, Lcom/kwai/filedownloader/e/f;->j(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
