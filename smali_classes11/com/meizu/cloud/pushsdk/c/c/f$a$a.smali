...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2}, Lcom/meizu/cloud/pushsdk/c/c/f$a$a;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/meizu/cloud/pushsdk/c/c/f$a$a;->a:Lcom/meizu/cloud/pushsdk/c/c/f$a$a;

    new-instance v1, Lcom/meizu/cloud/pushsdk/c/c/f$a$a;

    const-string v3, "MISSING_SCHEME"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/meizu/cloud/pushsdk/c/c/f$a$a;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/meizu/cloud/pushsdk/c/c/f$a$a;->b:Lcom/meizu/cloud/pushsdk/c/c/f$a$a;

    new-instance v3, Lcom/meizu/cloud/pushsdk/c/c/f$a$a;

    const-string v5, "UNSUPPORTED_SCHEME"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/meizu/cloud/pushsdk/c/c/f$a$a;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/meizu/cloud/pushsdk/c/c/f$a$a;->c:Lcom/meizu/cloud/pushsdk/c/c/f$a$a;

    new-instance v5, Lcom/meizu/cloud/pushsdk/c/c/f$a$a;

    const-string v7, "INVALID_PORT"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/meizu/cloud/pushsdk/c/c/f$a$a;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/meizu/cloud/pushsdk/c/c/f$a$a;->d:Lcom/meizu/cloud/pushsdk/c/c/f$a$a;

    new-instance v7, Lcom/meizu/cloud/pushsdk/c/c/f$a$a;

    const-string v9, "INVALID_HOST"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/meizu/cloud/pushsdk/c/c/f$a$a;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/meizu/cloud/pushsdk/c/c/f$a$a;->e:Lcom/meizu/cloud/pushsdk/c/c/f$a$a;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/meizu/cloud/pushsdk/c/c/f$a$a;
    ...
    sput-object v9, Lcom/meizu/cloud/pushsdk/c/c/f$a$a;->f:[Lcom/meizu/cloud/pushsdk/c/c/f$a$a;
