...
.method public static createReuseGLContext(Landroid/opengl/EGLContext;Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;I)Lcom/ss/android/ttve/common/TESharedContext;
    ...
    .line 5
    sget v3, Lcom/ss/android/ttve/common/TESharedContext;->mBitsR:I
    ...
    sget v1, Lcom/ss/android/ttve/common/TESharedContext;->mBitsG:I
    ...
    sget v1, Lcom/ss/android/ttve/common/TESharedContext;->mBitsB:I
    ...
    sget v1, Lcom/ss/android/ttve/common/TESharedContext;->mBitsA:I
    ...
    :cond_0
    new-array p3, p0, [Landroid/opengl/EGLConfig;
...
.method private initEGL(Landroid/opengl/EGLContext;IIILjava/lang/Object;)Z
    ...
    iput-object v6, v0, Lcom/ss/android/ttve/common/TESharedContext;->mConfig:Landroid/opengl/EGLConfig;

    .line 17
    iget-object v7, v0, Lcom/ss/android/ttve/common/TESharedContext;->mDisplay:Landroid/opengl/EGLDisplay;

    invoke-static {v7, v6, v2, v4, v14}, Landroid/opengl/EGL14;->eglCreateContext(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLConfig;Landroid/opengl/EGLContext;[II)Landroid/opengl/EGLContext;
    ...
    invoke-static {v1, v2, v4, v15, v14}, Landroid/opengl/EGL14;->eglCreateWindowSurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLConfig;Ljava/lang/Object;[II)Landroid/opengl/EGLSurface;
    ...
    iget-object v4, v0, Lcom/ss/android/ttve/common/TESharedContext;->mContext:Landroid/opengl/EGLContext;

    const/16 v5, 0x3098

    invoke-static {v1, v4, v5, v2, v14}, Landroid/opengl/EGL14;->eglQueryContext(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLContext;I[II)Z
