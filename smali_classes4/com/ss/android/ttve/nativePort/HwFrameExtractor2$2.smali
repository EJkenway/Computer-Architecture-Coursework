...
# direct methods
.method public constructor <init>(Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;[Ljava/util/List;)V
    .locals 0
...
.method public onImageAvailable(Landroid/media/ImageReader;)V
    ...
    .line 4
    iget-object v3, p0, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2$2;->val$sensArray:[Ljava/util/List;
    ...
    .line 5
    iget-object v3, p0, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2$2;->this$0:Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;

    iget-object v3, v3, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;->frameAvailable:Lcom/ss/android/vesdk/VEFrameAvailableListener;
    ...
    invoke-static {v3}, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;->access$500(Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;)I

    move-result v6

    iget-object v3, p0, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2$2;->this$0:Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;

    invoke-static {v3}, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;->access$600(Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;)I

    move-result v7

    iget-object v3, p0, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2$2;->this$0:Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;

    iget v8, v3, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;->mRotation:I
    ...
    iget-object v3, v3, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;->mConvertFrame:Lcom/ss/android/ttve/model/VEFrame;
    ...
    iget v5, v3, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;->mRotation:I

    if-eqz v5, :cond_3

    .line 19
    iget-object v5, v3, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;->mRotatedFrame:Lcom/ss/android/ttve/model/VEFrame;

    .line 20
    iget-object v3, v3, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;->mScaleFrame:Lcom/ss/android/ttve/model/VEFrame;
    ...
    .line 21
    :cond_3
    iget-object v5, v3, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;->mScaleFrame:Lcom/ss/android/ttve/model/VEFrame;

    .line 22
    :goto_1
    iget-object v3, p0, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2$2;->this$0:Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;

    iget-object v3, v3, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;->mRGBAFrame:Lcom/ss/android/ttve/model/VEFrame;
    ...
    iget-object v5, v3, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;->mRGBAFrame:Lcom/ss/android/ttve/model/VEFrame;
    ...
    invoke-static {v3, v5, v6, v7, v8}, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;->access$700(Lcom/ss/android/ttve/nativePort/HwFrameExtractor2;Ljava/nio/ByteBuffer;III)V

    .line 25
    :cond_5
    iget-object v3, p0, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2$2;->imageTs:Ljava/util/List;
    ...
    .line 26
    iget-object v1, p0, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2$2;->imageTs:Ljava/util/List;
    ...
    .line 28
    iget v1, p0, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2$2;->imageIndex:I

    add-int/2addr v1, v4

    iput v1, p0, Lcom/ss/android/ttve/nativePort/HwFrameExtractor2$2;->imageIndex:I
