...
# direct methods
.method public static a(Ljava/lang/ref/WeakReference;)Lcom/loc/bj;
    .locals 1
...
.method public static a(Landroid/content/Context;Lcom/loc/bj;Ljava/lang/String;IILjava/lang/String;)V
    .locals 0

    invoke-static {p0, p2}, Lcom/loc/ai;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    iput-object p0, p1, Lcom/loc/bj;->a:Ljava/lang/String;

    iput p3, p1, Lcom/loc/bj;->d:I

    int-to-long p2, p4

    iput-wide p2, p1, Lcom/loc/bj;->b:J

    iput-object p5, p1, Lcom/loc/bj;->c:Ljava/lang/String;

    return-void
.end method

.method public static a(Lcom/loc/az;Ljava/lang/String;)[B
    .locals 4
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/loc/az;->a(Ljava/lang/String;)Lcom/loc/az$b;
    ...
    :try_start_1
    invoke-virtual {p0}, Lcom/loc/az$b;->a()Ljava/io/InputStream;
    ...
    :goto_0
    :try_start_3
    invoke-virtual {p0}, Lcom/loc/az$b;->close()V
    :try_end_3
    ...
    invoke-static {p1, v2, v3}, Lcom/loc/ak;->b(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_8
