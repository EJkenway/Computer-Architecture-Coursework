...
.method private determineOffsetOfEndOfCentralDirectory(Ljava/io/RandomAccessFile;)J
    ...
    .line 4
    iget-object v6, p0, Lcom/qiyukf/module/zip4j/headers/HeaderReader;->rawIO:Lcom/qiyukf/module/zip4j/util/RawIO;

    invoke-virtual {v6, v1, v5}, Lcom/qiyukf/module/zip4j/util/RawIO;->readIntLittleEndian([BI)I

    move-result v6

    int-to-long v9, v6

    sget-object v6, Lcom/qiyukf/module/zip4j/headers/HeaderSignature;->END_OF_CENTRAL_DIRECTORY:Lcom/qiyukf/module/zip4j/headers/HeaderSignature;

    invoke-virtual {v6}, Lcom/qiyukf/module/zip4j/headers/HeaderSignature;->getValue()J
...
.method private readCentralDirectory(Ljava/io/RandomAccessFile;Lcom/qiyukf/module/zip4j/util/RawIO;Ljava/nio/charset/Charset;)Lcom/qiyukf/module/zip4j/model/CentralDirectory;
    ...
    invoke-static {v11, v12}, Lcom/qiyukf/module/zip4j/util/BitUtils;->isBitSet(BI)Z

    move-result v11

    invoke-virtual {v14, v11}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setEncrypted(Z)V
    ...
    invoke-static {v11, v15}, Lcom/qiyukf/module/zip4j/util/BitUtils;->isBitSet(BI)Z

    move-result v11

    invoke-virtual {v14, v11}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setDataDescriptorExists(Z)V
    ...
    invoke-virtual {v14, v11}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setFileNameUTF8Encoded(Z)V
    ...
    invoke-virtual {v14, v10}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setGeneralPurposeFlag([B)V
    ...
    invoke-static {v10}, Lcom/qiyukf/module/zip4j/model/enums/CompressionMethod;->getCompressionMethodFromCode(I)Lcom/qiyukf/module/zip4j/model/enums/CompressionMethod;

    move-result-object v10

    invoke-virtual {v14, v10}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setCompressionMethod(Lcom/qiyukf/module/zip4j/model/enums/CompressionMethod;)V
    ...
    invoke-virtual {v14, v10, v11}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setLastModifiedTime(J)V
    ...
    .line 19
    invoke-virtual {v2, v10, v12}, Lcom/qiyukf/module/zip4j/util/RawIO;->readLongLittleEndian([BI)J

    move-result-wide v6

    invoke-virtual {v14, v6, v7}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setCrc(J)V

    .line 20
    invoke-virtual {v14, v10}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setCrcRawData([B)V

    const/4 v6, 0x4

    .line 21
    invoke-virtual {v2, v1, v6}, Lcom/qiyukf/module/zip4j/util/RawIO;->readLongLittleEndian(Ljava/io/RandomAccessFile;I)J

    move-result-wide v11

    invoke-virtual {v14, v11, v12}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setCompressedSize(J)V
    ...
    invoke-virtual {v14, v11, v12}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setUncompressedSize(J)V
    ...
    .line 24
    invoke-virtual {v14, v11}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setFileNameLength(I)V
    ...
    invoke-virtual {v14, v12}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setExtraFieldLength(I)V
    ...
    .line 27
    invoke-virtual {v14, v12}, Lcom/qiyukf/module/zip4j/model/FileHeader;->setFileCommentLength(I)V
    ...
    invoke-virtual {v14, v6}, Lcom/qiyukf/module/zip4j/model/FileHeader;->setDiskNumberStart(I)V
    ...
    invoke-virtual {v14, v15}, Lcom/qiyukf/module/zip4j/model/FileHeader;->setInternalFileAttributes([B)V
    ...
    invoke-virtual {v14, v15}, Lcom/qiyukf/module/zip4j/model/FileHeader;->setExternalFileAttributes([B)V
    ...
    .line 34
    invoke-virtual {v2, v10, v7}, Lcom/qiyukf/module/zip4j/util/RawIO;->readLongLittleEndian([BI)J

    move-result-wide v8

    invoke-virtual {v14, v8, v9}, Lcom/qiyukf/module/zip4j/model/FileHeader;->setOffsetLocalHeader(J)V
    ...
    :goto_3
    invoke-virtual {v14, v8}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setDirectory(Z)V
...
.method private readZip64ExtendedInfo(Ljava/util/List;Lcom/qiyukf/module/zip4j/util/RawIO;JJJI)Lcom/qiyukf/module/zip4j/model/Zip64ExtendedInfo;
    ...
    check-cast v2, Lcom/qiyukf/module/zip4j/model/ExtraDataRecord;

    if-eqz v2, :cond_5

    .line 26
    sget-object v4, Lcom/qiyukf/module/zip4j/headers/HeaderSignature;->ZIP64_EXTRA_FIELD_SIGNATURE:Lcom/qiyukf/module/zip4j/headers/HeaderSignature;

    invoke-virtual {v4}, Lcom/qiyukf/module/zip4j/headers/HeaderSignature;->getValue()J

    move-result-wide v4

    invoke-virtual {v2}, Lcom/qiyukf/module/zip4j/model/ExtraDataRecord;->getHeader()J
    ...
    .line 27
    new-instance v1, Lcom/qiyukf/module/zip4j/model/Zip64ExtendedInfo;

    invoke-direct {v1}, Lcom/qiyukf/module/zip4j/model/Zip64ExtendedInfo;-><init>()V

    .line 28
    invoke-virtual {v2}, Lcom/qiyukf/module/zip4j/model/ExtraDataRecord;->getData()[B

    move-result-object v4

    .line 29
    invoke-virtual {v2}, Lcom/qiyukf/module/zip4j/model/ExtraDataRecord;->getSizeOfData()I
    ...
    .line 31
    invoke-virtual {p2, v4, v5}, Lcom/qiyukf/module/zip4j/util/RawIO;->readLongLittleEndian([BI)J

    move-result-wide v8

    invoke-virtual {v1, v8, v9}, Lcom/qiyukf/module/zip4j/model/Zip64ExtendedInfo;->setUncompressedSize(J)V
    ...
    invoke-virtual {v1, v8, v9}, Lcom/qiyukf/module/zip4j/model/Zip64ExtendedInfo;->setCompressedSize(J)V
    ...
    invoke-virtual {v1, v6, v7}, Lcom/qiyukf/module/zip4j/model/Zip64ExtendedInfo;->setOffsetLocalHeader(J)V
    ...
    .line 37
    invoke-virtual {p2, v4, v5}, Lcom/qiyukf/module/zip4j/util/RawIO;->readIntLittleEndian([BI)I

    move-result v0

    invoke-virtual {v1, v0}, Lcom/qiyukf/module/zip4j/model/Zip64ExtendedInfo;->setDiskNumberStart(I)V
...
.method public readLocalFileHeader(Ljava/io/InputStream;Ljava/nio/charset/Charset;)Lcom/qiyukf/module/zip4j/model/LocalFileHeader;
    ...
    .line 6
    invoke-static {p1, v4}, Lcom/qiyukf/module/zip4j/util/Zip4jUtil;->readFully(Ljava/io/InputStream;[B)I
    ...
    invoke-static {v6, v5}, Lcom/qiyukf/module/zip4j/util/BitUtils;->isBitSet(BI)Z

    move-result v6

    invoke-virtual {v0, v6}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setEncrypted(Z)V
    ...
    invoke-static {v6, v7}, Lcom/qiyukf/module/zip4j/util/BitUtils;->isBitSet(BI)Z

    move-result v6

    invoke-virtual {v0, v6}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setDataDescriptorExists(Z)V
    ...
    invoke-static {v9, v7}, Lcom/qiyukf/module/zip4j/util/BitUtils;->isBitSet(BI)Z

    move-result v7

    invoke-virtual {v0, v7}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setFileNameUTF8Encoded(Z)V
    ...
    invoke-virtual {v0, v4}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setGeneralPurposeFlag([B)V

    .line 11
    iget-object v4, p0, Lcom/qiyukf/module/zip4j/headers/HeaderReader;->rawIO:Lcom/qiyukf/module/zip4j/util/RawIO;

    .line 12
    invoke-virtual {v4, p1}, Lcom/qiyukf/module/zip4j/util/RawIO;->readShortLittleEndian(Ljava/io/InputStream;)I

    move-result v4

    .line 13
    invoke-static {v4}, Lcom/qiyukf/module/zip4j/model/enums/CompressionMethod;->getCompressionMethodFromCode(I)Lcom/qiyukf/module/zip4j/model/enums/CompressionMethod;

    move-result-object v4

    invoke-virtual {v0, v4}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setCompressionMethod(Lcom/qiyukf/module/zip4j/model/enums/CompressionMethod;)V

    .line 14
    iget-object v4, p0, Lcom/qiyukf/module/zip4j/headers/HeaderReader;->rawIO:Lcom/qiyukf/module/zip4j/util/RawIO;

    invoke-virtual {v4, p1}, Lcom/qiyukf/module/zip4j/util/RawIO;->readIntLittleEndian(Ljava/io/InputStream;)I

    move-result v4

    int-to-long v9, v4

    invoke-virtual {v0, v9, v10}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setLastModifiedTime(J)V
    ...
    invoke-virtual {v4, v2, v5}, Lcom/qiyukf/module/zip4j/util/RawIO;->readLongLittleEndian([BI)J

    move-result-wide v9

    invoke-virtual {v0, v9, v10}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setCrc(J)V
    ...
    invoke-virtual {v0, v9, v10}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setCompressedSize(J)V
    ...
    :cond_3
    :goto_0
    invoke-virtual {v0, v6}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setDirectory(Z)V
    ...
    .line 31
    :cond_5
    invoke-virtual {v0, v8}, Lcom/qiyukf/module/zip4j/model/AbstractFileHeader;->setFileName(Ljava/lang/String;)V
