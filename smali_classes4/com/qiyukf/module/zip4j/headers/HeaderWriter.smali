...
.method private updateFileSizesInLocalFileHeader(Lcom/qiyukf/module/zip4j/io/outputstream/SplitOutputStream;Lcom/qiyukf/module/zip4j/model/FileHeader;)V
    ...
    invoke-virtual {v0, v1, v5, v2, v3}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeLongLittleEndian([BIJ)V

    .line 3
    iget-object v0, p0, Lcom/qiyukf/module/zip4j/headers/HeaderWriter;->longBuff:[B

    invoke-virtual {p1, v0, v5, v4}, Lcom/qiyukf/module/zip4j/io/outputstream/SplitOutputStream;->write([BII)V
    ...
    invoke-virtual {p1, p2, v5, v4}, Lcom/qiyukf/module/zip4j/io/outputstream/SplitOutputStream;->write([BII)V
...
.method private writeEndOfCentralDirectoryRecord(Lcom/qiyukf/module/zip4j/model/ZipModel;IJLjava/io/ByteArrayOutputStream;Lcom/qiyukf/module/zip4j/util/RawIO;Ljava/nio/charset/Charset;)V
    ...
    invoke-virtual {p6, p5, v2}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeIntLittleEndian(Ljava/io/OutputStream;I)V
    ...
    .line 12
    invoke-virtual {p6, p5, v2}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeShortLittleEndian(Ljava/io/OutputStream;I)V
    ...
    .line 14
    invoke-virtual {p6, v0, v3, v1, v2}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeLongLittleEndian([BIJ)V
    ...
    .line 16
    :cond_3
    invoke-virtual {p6, v0, v3, p3, p4}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeLongLittleEndian([BIJ)V
...
.method private writeFileHeader(Lcom/qiyukf/module/zip4j/model/ZipModel;Lcom/qiyukf/module/zip4j/model/FileHeader;Ljava/io/ByteArrayOutputStream;Lcom/qiyukf/module/zip4j/util/RawIO;Ljava/nio/charset/Charset;)V
    ...
    invoke-virtual {v11}, Lcom/qiyukf/module/zip4j/headers/HeaderSignature;->getValue()J

    move-result-wide v11

    long-to-int v12, v11

    invoke-virtual {v4, v3, v12}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeIntLittleEndian(Ljava/io/OutputStream;I)V
    ...
    invoke-virtual {v4, v3, v11}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeShortLittleEndian(Ljava/io/OutputStream;I)V
    ...
    invoke-virtual {v11}, Lcom/qiyukf/module/zip4j/model/enums/CompressionMethod;->getCode()I
    ...
    invoke-virtual {v4, v11, v8, v12, v13}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeLongLittleEndian([BIJ)V
    ...
    invoke-virtual {v4, v11, v8, v13, v14}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeLongLittleEndian([BIJ)V
    ...
    invoke-virtual {v4, v11, v8, v6, v7}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeLongLittleEndian([BIJ)V
    ...
    invoke-virtual {v4, v6, v8, v13, v14}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeLongLittleEndian([BIJ)V
    ...
    .line 26
    :goto_1
    invoke-direct {v1, v2, v10}, Lcom/qiyukf/module/zip4j/headers/HeaderWriter;->calculateExtraDataRecordsSize(Lcom/qiyukf/module/zip4j/model/FileHeader;Z)I
    ...
    .line 29
    invoke-static {v11}, Lcom/qiyukf/module/zip4j/util/Zip4jUtil;->isStringNotNullAndNotEmpty(Ljava/lang/String;)Z
    ...
    invoke-virtual {v4, v5, v8, v11}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeIntLittleEndian([BII)V
    ...
    invoke-virtual {v4, v3, v6}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeShortLittleEndian(Ljava/io/OutputStream;I)V
...
.method private writeRemainingExtraDataRecordsIfPresent(Lcom/qiyukf/module/zip4j/model/FileHeader;Ljava/io/OutputStream;)V
    ...
    invoke-virtual {v1, p2, v3}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeShortLittleEndian(Ljava/io/OutputStream;I)V
...
.method private writeZip64EndOfCentralDirectoryLocator(Lcom/qiyukf/module/zip4j/model/Zip64EndOfCentralDirectoryLocator;Ljava/io/ByteArrayOutputStream;Lcom/qiyukf/module/zip4j/util/RawIO;)V
    ...
    invoke-virtual {p3, p2, v1}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeIntLittleEndian(Ljava/io/OutputStream;I)V
...
.method public updateLocalFileHeader(Lcom/qiyukf/module/zip4j/model/FileHeader;Lcom/qiyukf/module/zip4j/model/ZipModel;Lcom/qiyukf/module/zip4j/io/outputstream/SplitOutputStream;)V
    ...
    invoke-virtual {v0, v6, v7}, Lcom/qiyukf/module/zip4j/io/outputstream/SplitOutputStream;->seek(J)V
    ...
    invoke-virtual {p2, v1, v3, v6, v7}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeLongLittleEndian([BIJ)V
    ...
    invoke-virtual {v0, p2, v3, v1}, Lcom/qiyukf/module/zip4j/io/outputstream/SplitOutputStream;->write([BII)V
    ...
    .line 15
    :cond_2
    invoke-virtual {p3, v4, v5}, Lcom/qiyukf/module/zip4j/io/outputstream/SplitOutputStream;->seek(J)V
...
.method public writeExtendedLocalHeader(Lcom/qiyukf/module/zip4j/model/LocalFileHeader;Ljava/io/OutputStream;)V
    ...
    invoke-virtual {v1, v0, v3}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeIntLittleEndian(Ljava/io/OutputStream;I)V
...
.method public writeLocalFileHeader(Lcom/qiyukf/module/zip4j/model/ZipModel;Lcom/qiyukf/module/zip4j/model/LocalFileHeader;Ljava/io/OutputStream;Ljava/nio/charset/Charset;)V
    ...
    .line 15
    invoke-virtual {p1, v1}, Lcom/qiyukf/module/zip4j/model/ZipModel;->setZip64Format(Z)V

    .line 16
    invoke-virtual {p2, v1}, Lcom/qiyukf/module/zip4j/model/LocalFileHeader;->setWriteCompressedSizeInZip64ExtraRecord(Z)V
    ...
    invoke-virtual {p1, v0, v2, v3}, Lcom/qiyukf/module/zip4j/util/RawIO;->writeLongLittleEndian(Ljava/io/OutputStream;J)V
