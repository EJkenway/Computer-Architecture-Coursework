.class public Lcom/qiyukf/module/log/core/rolling/helper/Compressor;
...
# instance fields
.field public final compressionMode:Lcom/qiyukf/module/log/core/rolling/helper/CompressionMode;


# direct methods
.method public constructor <init>(Lcom/qiyukf/module/log/core/rolling/helper/CompressionMode;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lcom/qiyukf/module/log/core/rolling/helper/Compressor;->compressionMode:Lcom/qiyukf/module/log/core/rolling/helper/CompressionMode;

    return-void
.end method

.method public static computeFileNameStr_WCS(Ljava/lang/String;Lcom/qiyukf/module/log/core/rolling/helper/CompressionMode;)Ljava/lang/String;
    .locals 4
    ...
    .line 2
    sget-object v1, Lcom/qiyukf/module/log/core/rolling/helper/Compressor$1;->$SwitchMap$com$qiyukf$module$log$core$rolling$helper$CompressionMode:[I
...
.method private gzCompress(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v0, "] exist already. Aborting file compression."
    ...
    const-string p2, "gzedFile is not existed:"
    ...
    .line 13
    invoke-virtual {p0, v2}, Lcom/qiyukf/module/log/core/rolling/helper/Compressor;->createMissingTargetDirsIfNecessary(Ljava/io/File;)V
    ...
    invoke-direct {v1, v3, p0}, Lcom/qiyukf/module/log/core/status/WarnStatus;-><init>(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-direct {v3, p1, p0, v1}, Lcom/qiyukf/module/log/core/status/ErrorStatus;-><init>(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method private zipCompress(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 16
    :try_start_2
    invoke-virtual {p0, p3}, Lcom/qiyukf/module/log/core/rolling/helper/Compressor;->computeZipEntry(Ljava/lang/String;)Ljava/util/zip/ZipEntry;
    ...
    .line 23
    new-instance p3, Lcom/qiyukf/module/log/core/status/WarnStatus;
    ...
    invoke-direct {p3, v1, p0}, Lcom/qiyukf/module/log/core/status/WarnStatus;-><init>(Ljava/lang/String;Ljava/lang/Object;)V

    invoke-virtual {p0, p3}, Lcom/qiyukf/module/log/core/spi/ContextAwareBase;->addStatus(Lcom/qiyukf/module/log/core/status/Status;)V
    :try_end_4
    .catch Ljava/lang/Exception; {:try_start_4 .. :try_end_4} :catch_3
    .catchall {:try_start_4 .. :try_end_4} :catchall_2
    ...
    invoke-direct {v1, p1, p0, p3}, Lcom/qiyukf/module/log/core/status/ErrorStatus;-><init>(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public compress(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1
    sget-object v0, Lcom/qiyukf/module/log/core/rolling/helper/Compressor$1;->$SwitchMap$com$qiyukf$module$log$core$rolling$helper$CompressionMode:[I

    iget-object v1, p0, Lcom/qiyukf/module/log/core/rolling/helper/Compressor;->compressionMode:Lcom/qiyukf/module/log/core/rolling/helper/CompressionMode;
    ...
    const-string p2, "----> gzOrZip is not existed"
    ...
    .line 4
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lcom/qiyukf/module/log/core/rolling/helper/Compressor;->zipCompress(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    return-void

    .line 5
    :cond_2
    invoke-direct {p0, p1, p2}, Lcom/qiyukf/module/log/core/rolling/helper/Compressor;->gzCompress(Ljava/lang/String;Ljava/lang/String;)V
...
.method public computeZipEntry(Ljava/io/File;)Ljava/util/zip/ZipEntry;
    ...
    invoke-virtual {p0, p1}, Lcom/qiyukf/module/log/core/rolling/helper/Compressor;->computeZipEntry(Ljava/lang/String;)Ljava/util/zip/ZipEntry;
...
.method public computeZipEntry(Ljava/lang/String;)Ljava/util/zip/ZipEntry;
    ...
    .line 2
    iget-object v0, p0, Lcom/qiyukf/module/log/core/rolling/helper/Compressor;->compressionMode:Lcom/qiyukf/module/log/core/rolling/helper/CompressionMode;

    invoke-static {p1, v0}, Lcom/qiyukf/module/log/core/rolling/helper/Compressor;->computeFileNameStr_WCS(Ljava/lang/String;Lcom/qiyukf/module/log/core/rolling/helper/CompressionMode;)Ljava/lang/String;
