...
.method private static a(Ljava/util/Map;Ljava/nio/channels/FileChannel;JJJLjava/nio/ByteBuffer;)V
    ...
    .line 93
    new-instance v0, Lcom/noah/plugin/api/signature/B;
    ...
    invoke-direct/range {v9 .. v14}, Lcom/noah/plugin/api/signature/B;-><init>(Ljava/nio/channels/FileChannel;JJ)V
    ...
    .line 96
    invoke-static {v2}, Lcom/noah/plugin/api/signature/G;->a(Ljava/nio/ByteBuffer;)V
    ...
    .line 99
    new-instance v3, Lcom/noah/plugin/api/signature/G;

    invoke-direct {v3, v2}, Lcom/noah/plugin/api/signature/G;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    :try_start_0
    new-array v5, v5, [Lcom/noah/plugin/api/signature/A;
    ...
    .line 104
    invoke-static {v4, v5}, Lcom/noah/plugin/api/signature/G;->a([I[Lcom/noah/plugin/api/signature/A;)[[B
...
.method private static a(Ljava/nio/ByteBuffer;Ljava/util/Map;Ljava/security/cert/CertificateFactory;)[Ljava/security/cert/X509Certificate;
    ...
    .line 80
    new-instance v4, Lcom/noah/plugin/api/signature/X509CertificateEx;

    invoke-direct {v4, v3, v2}, Lcom/noah/plugin/api/signature/X509CertificateEx;-><init>(Ljava/security/cert/X509Certificate;[B)V
...
.method private static a([I[Lcom/noah/plugin/api/signature/A;)[[B
    .locals 25
    ...
    .line 129
    invoke-interface {v5}, Lcom/noah/plugin/api/signature/A;->a()J
    ...
    invoke-static {v4, v2, v3}, Lcom/noah/plugin/api/signature/G;->a(I[BI)V
    ...
    :cond_3
    :try_start_1
    invoke-interface {v5, v8, v11, v12, v4}, Lcom/noah/plugin/api/signature/A;->a([Ljava/security/MessageDigest;JI)V
    :try_end_1
    ...
    .line 136
    invoke-static {v3}, Lcom/noah/plugin/api/signature/G;->d(I)I
...
.method private static a(Ljava/nio/channels/FileChannel;Lcom/noah/plugin/api/signature/C;)[[Ljava/security/cert/X509Certificate;
    .locals 10
...
.method private static b(Ljava/io/RandomAccessFile;)Lcom/noah/plugin/api/signature/C;
    .locals 11
    ...
    .line 9
    new-instance p0, Lcom/noah/plugin/api/signature/C;
...
.method private static d(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 10
    invoke-static {p0, v3}, Lcom/noah/plugin/api/signature/G;->b(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
