...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/noah/plugin/api/common/SplitAABInfoProvider;->packageName:Ljava/lang/String;

    .line 3
    iput-object p1, p0, Lcom/noah/plugin/api/common/SplitAABInfoProvider;->context:Landroid/content/Context;
...
.method private getFusedModules()Ljava/util/Set;
    ...
    .line 2
    :try_start_0
    iget-object v3, p0, Lcom/noah/plugin/api/common/SplitAABInfoProvider;->context:Landroid/content/Context;

    invoke-virtual {v3}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v3

    iget-object v4, p0, Lcom/noah/plugin/api/common/SplitAABInfoProvider;->packageName:Ljava/lang/String;
...
.method private getSplitInstallInfo()[Ljava/lang/String;
    ...
    .line 1
    :try_start_0
    iget-object v2, p0, Lcom/noah/plugin/api/common/SplitAABInfoProvider;->context:Landroid/content/Context;

    invoke-virtual {v2}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v2

    iget-object v3, p0, Lcom/noah/plugin/api/common/SplitAABInfoProvider;->packageName:Ljava/lang/String;
...
.method public getInstalledSplitsForAAB()Ljava/util/Set;
    ...
    .line 1
    invoke-direct {p0}, Lcom/noah/plugin/api/common/SplitAABInfoProvider;->getFusedModules()Ljava/util/Set;
    ...
    .line 3
    :cond_0
    invoke-direct {p0}, Lcom/noah/plugin/api/common/SplitAABInfoProvider;->getSplitInstallInfo()[Ljava/lang/String;
    ...
    invoke-static {v2, v4, v5}, Lcom/noah/plugin/api/common/SplitLog;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 9
    invoke-direct {p0, v4}, Lcom/noah/plugin/api/common/SplitAABInfoProvider;->cutSplitName(Ljava/lang/String;)Ljava/lang/String;
