...
.method public constructor <init>(Ljava/io/File;)V
    ...
    iput-object v0, p0, Lcom/noah/plugin/api/common/SplitElfFile;->sectionNameToHeaderMap:Ljava/util/Map;
    ...
    iput-object v0, p0, Lcom/noah/plugin/api/common/SplitElfFile;->fis:Ljava/io/FileInputStream;
    ...
    invoke-direct {v0, p1, v1}, Lcom/noah/plugin/api/common/SplitElfFile$ElfHeader;-><init>(Ljava/nio/channels/FileChannel;Lcom/noah/plugin/api/common/SplitElfFile$1;)V
    ...
    iget-short v2, v2, Lcom/noah/plugin/api/common/SplitElfFile$ElfHeader;->ePhEntSize:S
    ...
    iget-object v2, v2, Lcom/noah/plugin/api/common/SplitElfFile$ElfHeader;->eIndent:[B
    ...
    iget-wide v2, v2, Lcom/noah/plugin/api/common/SplitElfFile$ElfHeader;->ePhOff:J
    ...
    iget-short v2, v2, Lcom/noah/plugin/api/common/SplitElfFile$ElfHeader;->ePhNum:S

    new-array v2, v2, [Lcom/noah/plugin/api/common/SplitElfFile$ProgramHeader;

    iput-object v2, p0, Lcom/noah/plugin/api/common/SplitElfFile;->programHeaders:[Lcom/noah/plugin/api/common/SplitElfFile$ProgramHeader;
    ...
    .line 11
    :goto_1
    iget-object v4, p0, Lcom/noah/plugin/api/common/SplitElfFile;->programHeaders:[Lcom/noah/plugin/api/common/SplitElfFile$ProgramHeader;
    ...
    .line 12
    invoke-static {p1, v0, v4}, Lcom/noah/plugin/api/common/SplitElfFile;->readUntilLimit(Ljava/nio/channels/FileChannel;Ljava/nio/ByteBuffer;Ljava/lang/String;)V

    .line 13
    iget-object v4, p0, Lcom/noah/plugin/api/common/SplitElfFile;->programHeaders:[Lcom/noah/plugin/api/common/SplitElfFile$ProgramHeader;

    new-instance v6, Lcom/noah/plugin/api/common/SplitElfFile$ProgramHeader;

    iget-object v7, p0, Lcom/noah/plugin/api/common/SplitElfFile;->elfHeader:Lcom/noah/plugin/api/common/SplitElfFile$ElfHeader;

    iget-object v7, v7, Lcom/noah/plugin/api/common/SplitElfFile$ElfHeader;->eIndent:[B

    aget-byte v5, v7, v5

    invoke-direct {v6, v0, v5, v1}, Lcom/noah/plugin/api/common/SplitElfFile$ProgramHeader;-><init>(Ljava/nio/ByteBuffer;ILcom/noah/plugin/api/common/SplitElfFile$1;)V
    ...
    .line 14
    :cond_1
    iget-object v3, p0, Lcom/noah/plugin/api/common/SplitElfFile;->elfHeader:Lcom/noah/plugin/api/common/SplitElfFile$ElfHeader;

    iget-wide v3, v3, Lcom/noah/plugin/api/common/SplitElfFile$ElfHeader;->eShOff:J
    ...
    iget-short v3, v3, Lcom/noah/plugin/api/common/SplitElfFile$ElfHeader;->eShEntSize:S
    ...
    iget-short v3, v3, Lcom/noah/plugin/api/common/SplitElfFile$ElfHeader;->eShNum:S

    new-array v3, v3, [Lcom/noah/plugin/api/common/SplitElfFile$SectionHeader;

    iput-object v3, p0, Lcom/noah/plugin/api/common/SplitElfFile;->sectionHeaders:[Lcom/noah/plugin/api/common/SplitElfFile$SectionHeader;

    const/4 v3, 0x0

    .line 17
    :goto_2
    iget-object v4, p0, Lcom/noah/plugin/api/common/SplitElfFile;->sectionHeaders:[Lcom/noah/plugin/api/common/SplitElfFile$SectionHeader;
    ...
    new-instance v6, Lcom/noah/plugin/api/common/SplitElfFile$SectionHeader;
    ...
    invoke-direct {v6, v0, v7, v1}, Lcom/noah/plugin/api/common/SplitElfFile$SectionHeader;-><init>(Ljava/nio/ByteBuffer;ILcom/noah/plugin/api/common/SplitElfFile$1;)V
    ...
    .line 26
    iget-object v5, p0, Lcom/noah/plugin/api/common/SplitElfFile;->sectionNameToHeaderMap:Ljava/util/Map;
...
.method public static synthetic access$300(IIILjava/lang/String;)V
    ...
    .line 1
    invoke-static {p0, p1, p2, p3}, Lcom/noah/plugin/api/common/SplitElfFile;->assertInRange(IIILjava/lang/String;)V
...
.method public close()V
    ...
    .line 1
    iget-object v0, p0, Lcom/noah/plugin/api/common/SplitElfFile;->fis:Ljava/io/FileInputStream;

    invoke-virtual {v0}, Ljava/io/FileInputStream;->close()V

    .line 2
    iget-object v0, p0, Lcom/noah/plugin/api/common/SplitElfFile;->sectionNameToHeaderMap:Ljava/util/Map;
...
.method public getSection(Lcom/noah/plugin/api/common/SplitElfFile$SectionHeader;)Ljava/nio/ByteBuffer;
    ...
    .line 2
    iget-object v1, p0, Lcom/noah/plugin/api/common/SplitElfFile;->fis:Ljava/io/FileInputStream;
