...
.field public final mTask:Lcom/noah/plugin/api/library/core/tasks/TaskWrapper;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallService;Lcom/noah/plugin/api/library/core/tasks/TaskWrapper;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallServiceCallbackImpl;->mSplitInstallService:Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallService;

    .line 3
    iput-object p2, p0, Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallServiceCallbackImpl;->mTask:Lcom/noah/plugin/api/library/core/tasks/TaskWrapper;
...
.method public onCancelInstall(ILandroid/os/Bundle;)V
    ...
    .line 1
    iget-object p2, p0, Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallServiceCallbackImpl;->mSplitInstallService:Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallService;

    iget-object p2, p2, Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallService;->mSplitRemoteManager:Lcom/noah/plugin/api/library/core/remote/RemoteManager;

    invoke-virtual {p2}, Lcom/noah/plugin/api/library/core/remote/RemoteManager;->unbindService()V

    .line 2
    sget-object p2, Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallService;->playCore:Lcom/noah/plugin/api/library/core/splitcompat/util/PlayCore;
    ...
    invoke-virtual {p2, p1, v0}, Lcom/noah/plugin/api/library/core/splitcompat/util/PlayCore;->info(Ljava/lang/String;[Ljava/lang/Object;)I
...
.method public onCompleteInstall(I)V
    ...
    .line 1
    iget-object v0, p0, Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallServiceCallbackImpl;->mSplitInstallService:Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallService;
    ...
    .line 2
    sget-object v0, Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallService;->playCore:Lcom/noah/plugin/api/library/core/splitcompat/util/PlayCore;
    ...
    invoke-virtual {v0, p1, v1}, Lcom/noah/plugin/api/library/core/splitcompat/util/PlayCore;->info(Ljava/lang/String;[Ljava/lang/Object;)I
...
.method public onDeferredInstall(Landroid/os/Bundle;)V
    ...
    .line 1
    iget-object p1, p0, Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallServiceCallbackImpl;->mSplitInstallService:Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallService;

    iget-object p1, p1, Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallService;->mSplitRemoteManager:Lcom/noah/plugin/api/library/core/remote/RemoteManager;

    invoke-virtual {p1}, Lcom/noah/plugin/api/library/core/remote/RemoteManager;->unbindService()V

    .line 2
    sget-object p1, Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallService;->playCore:Lcom/noah/plugin/api/library/core/splitcompat/util/PlayCore;
...
.method public final onError(Landroid/os/Bundle;)V
    ...
    .line 4
    iget-object v0, p0, Lcom/noah/plugin/api/library/core/splitinstall/SplitInstallServiceCallbackImpl;->mTask:Lcom/noah/plugin/api/library/core/tasks/TaskWrapper;
