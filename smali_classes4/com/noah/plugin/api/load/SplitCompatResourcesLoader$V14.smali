...
.method public static synthetic access$100(Landroid/content/Context;Landroid/content/res/Resources;Ljava/util/List;)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$V14;->installSplitResDirs(Landroid/content/Context;Landroid/content/res/Resources;Ljava/util/List;)V
...
.method private static checkOrUpdateResourcesForContext(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources;)V
    ...
    .line 2
    invoke-static {}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$VersionCompat;->mResourcesInContextThemeWrapper()Ljava/lang/reflect/Field;
    ...
    .line 5
    invoke-static {}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$VersionCompat;->mThemeInContextThemeWrapper()Ljava/lang/reflect/Field;
    ...
    .line 6
    :cond_0
    invoke-static {p0}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$V14;->getBaseContext(Landroid/content/Context;)Landroid/content/Context;
    ...
    .line 8
    invoke-static {}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$VersionCompat;->mResourcesInContextImpl()Ljava/lang/reflect/Field;
    ...
    .line 10
    invoke-static {}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$VersionCompat;->mThemeInContentImpl()Ljava/lang/reflect/Field;
...
.method private static createResources(Landroid/content/Context;Landroid/content/res/Resources;Ljava/util/List;)Landroid/content/res/Resources;
    ...
    .line 3
    invoke-static {p0, v0}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$V14;->getAppResDirs(Ljava/lang/String;Landroid/content/res/AssetManager;)Ljava/util/List;
    ...
    .line 5
    invoke-static {}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$V14;->createAssetManager()Landroid/content/res/AssetManager;
    ...
    .line 10
    :cond_1
    invoke-static {p1, p2}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$V14;->newResources(Landroid/content/res/Resources;Landroid/content/res/AssetManager;)Landroid/content/res/Resources;
...
.method private static installSplitResDirs(Landroid/content/Context;Landroid/content/res/Resources;Ljava/util/List;)V
    ...
    .line 1
    invoke-static {p0, p1, p2}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$V14;->createResources(Landroid/content/Context;Landroid/content/res/Resources;Ljava/util/List;)Landroid/content/res/Resources;

    move-result-object p2

    .line 2
    invoke-static {p0, p1, p2}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$V14;->checkOrUpdateResourcesForContext(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources;)V
    ...
    .line 4
    invoke-static {}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$VersionCompat;->mActivitiesInActivityThread()Ljava/lang/reflect/Field;
    ...
    .line 7
    invoke-static {v2, v5}, Lcom/noah/plugin/api/load/HiddenApiReflection;->findField(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/reflect/Field;
    ...
    .line 9
    invoke-static {v2, p1, p2}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$V14;->checkOrUpdateResourcesForContext(Landroid/content/Context;Landroid/content/res/Resources;Landroid/content/res/Resources;)V
    ...
    .line 11
    invoke-static {}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$VersionCompat;->mActiveResourcesInActivityThread()Ljava/lang/reflect/Field;
    ...
    .line 12
    :cond_2
    invoke-static {}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$VersionCompat;->getResourcesManager()Ljava/lang/Object;

    move-result-object p0

    .line 13
    invoke-static {}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$VersionCompat;->mActiveResourcesInResourcesManager()Ljava/lang/reflect/Field;
    ...
    .line 17
    invoke-static {v4, v1, p0}, Lcom/noah/plugin/api/common/SplitLog;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 18
    :cond_5
    invoke-static {}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$VersionCompat;->mPackagesInActivityThread()Ljava/lang/reflect/Field;
    ...
    .line 21
    :cond_7
    invoke-static {}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$VersionCompat;->mResourcesInLoadedApk()Ljava/lang/reflect/Field;
    ...
    .line 22
    invoke-static {v4, v5, v2}, Lcom/noah/plugin/api/common/SplitLog;->i(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 24
    :cond_8
    invoke-static {}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader$VersionCompat;->mResourcePackagesInActivityThread()Ljava/lang/reflect/Field;
    ...
    invoke-static {p0, p1}, Lcom/noah/plugin/api/load/SplitCompatResourcesLoader;->access$300(Landroid/content/res/AssetManager;Z)Ljava/util/List;
...
.method private static newResources(Landroid/content/res/Resources;Landroid/content/res/AssetManager;)Landroid/content/res/Resources;
    ...
    invoke-static {p0, v1}, Lcom/noah/plugin/api/load/HiddenApiReflection;->findConstructor(Ljava/lang/Object;[Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
