...
.method private loadDex(Ljava/lang/ClassLoader;Ljava/util/List;Ljava/io/File;)V
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p3, v0}, Lcom/noah/plugin/api/load/SplitCompatDexLoader;->load(Ljava/lang/ClassLoader;Ljava/io/File;Ljava/util/List;)V

    .line 5
    invoke-static {p1, p2, p3}, Lcom/noah/plugin/api/load/SplitUnKnownFileTypeDexLoader;->loadDex(Ljava/lang/ClassLoader;Ljava/util/List;Ljava/io/File;)V
    :try_end_0
...
.method private loadLibrary(Ljava/lang/ClassLoader;Ljava/io/File;)V
    ...
    .line 1
    :try_start_0
    invoke-static {p1, p2}, Lcom/noah/plugin/api/load/SplitCompatLibraryLoader;->load(Ljava/lang/ClassLoader;Ljava/io/File;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public loadCode2(Ljava/util/List;Ljava/io/File;Ljava/io/File;)V
    ...
    .line 2
    invoke-direct {p0, v0, p3}, Lcom/noah/plugin/api/load/SplitLoaderImpl2;->loadLibrary(Ljava/lang/ClassLoader;Ljava/io/File;)V

    .line 3
    invoke-direct {p0, v0, p1, p2}, Lcom/noah/plugin/api/load/SplitLoaderImpl2;->loadDex(Ljava/lang/ClassLoader;Ljava/util/List;Ljava/io/File;)V
