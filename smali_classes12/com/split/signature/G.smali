...
.method private static C(I)Landroid/util/Pair;
    .locals 6
...
.method private static a(II)I
    ...
    .line 1
    invoke-static {p0}, Lcom/split/signature/G;->q(I)I

    move-result p0

    .line 2
    invoke-static {p1}, Lcom/split/signature/G;->q(I)I

    move-result p1

    .line 3
    invoke-static {p0, p1}, Lcom/split/signature/G;->r(II)I
...
.method private static d(Ljava/nio/ByteBuffer;J)J
    ...
    .line 1
    invoke-static {p0}, Lcom/split/signature/G;->i(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, v0}, Lcom/split/signature/G;->c(Ljava/nio/ByteBuffer;I)J
    ...
    invoke-static {p0, v2}, Lcom/split/signature/G;->c(Ljava/nio/ByteBuffer;I)J
...
.method private static e(Ljava/io/RandomAccessFile;I)Landroid/util/Pair;
    ...
    .line 7
    invoke-static {p1}, Lcom/split/signature/G;->i(Ljava/nio/ByteBuffer;)V
...
.method private static f(Ljava/io/RandomAccessFile;J)Landroid/util/Pair;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static h(I[BI)V
    .locals 1
...
.method private static i(Ljava/nio/ByteBuffer;)V
    .locals 1
...
.method private static j(Ljava/util/Map;Ljava/nio/channels/FileChannel;JJJLjava/nio/ByteBuffer;)V
    ...
    .line 5
    invoke-static {v2}, Lcom/split/signature/G;->i(Ljava/nio/ByteBuffer;)V
    ...
    .line 13
    invoke-static {v4, v5}, Lcom/split/signature/G;->m([I[Lcom/split/signature/A;)[[B
    ...
    invoke-static {v1}, Lcom/split/signature/G;->w(I)Ljava/lang/String;
...
.method private static l(Ljava/nio/ByteBuffer;Ljava/util/Map;Ljava/security/cert/CertificateFactory;)[Ljava/security/cert/X509Certificate;
    ...
    .line 1
    invoke-static {p0}, Lcom/split/signature/G;->t(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 3
    invoke-static {p0}, Lcom/split/signature/G;->x(Ljava/nio/ByteBuffer;)[B
    ...
    .line 6
    :try_start_0
    invoke-static {v1}, Lcom/split/signature/G;->t(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 9
    invoke-static {v10}, Lcom/split/signature/G;->k(I)Z
    ...
    .line 10
    :cond_1
    invoke-static {v9}, Lcom/split/signature/G;->x(Ljava/nio/ByteBuffer;)[B
    ...
    .line 15
    :cond_5
    invoke-static {v6}, Lcom/split/signature/G;->A(I)Ljava/lang/String;

    move-result-object v1

    .line 16
    invoke-static {v6}, Lcom/split/signature/G;->C(I)Landroid/util/Pair;
    ...
    .line 24
    invoke-static {v0}, Lcom/split/signature/G;->t(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 30
    invoke-static {v8}, Lcom/split/signature/G;->x(Ljava/nio/ByteBuffer;)[B
    ...
    .line 34
    invoke-static {v6}, Lcom/split/signature/G;->q(I)I
    ...
    .line 40
    invoke-static {p1}, Lcom/split/signature/G;->x(Ljava/nio/ByteBuffer;)[B
...
.method private static m([I[Lcom/split/signature/A;)[[B
    .locals 25
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-static {v9, v10}, Lcom/split/signature/G;->b(J)J
    ...
    invoke-static {v8}, Lcom/split/signature/G;->y(I)I
    ...
    .line 8
    invoke-static {v2, v8, v10}, Lcom/split/signature/G;->h(I[BI)V
    ...
    invoke-static {v12}, Lcom/split/signature/G;->w(I)Ljava/lang/String;
    ...
    invoke-static {v4, v2, v3}, Lcom/split/signature/G;->h(I[BI)V
    ...
    :cond_3
    :try_start_1
    invoke-interface {v5, v8, v11, v12, v4}, Lcom/split/signature/A;->a([Ljava/security/MessageDigest;JI)V
    :try_end_1
    ...
    .line 24
    invoke-static {v3}, Lcom/split/signature/G;->y(I)I
    ...
    .line 33
    invoke-static {v2}, Lcom/split/signature/G;->w(I)Ljava/lang/String;
...
.method private static n(Ljava/io/RandomAccessFile;)[[Ljava/security/cert/X509Certificate;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    .line 1
    invoke-static {p0}, Lcom/split/signature/G;->s(Ljava/io/RandomAccessFile;)Lcom/split/signature/c;
    ...
    invoke-static {p0, v0}, Lcom/split/signature/G;->p(Ljava/nio/channels/FileChannel;Lcom/split/signature/c;)[[Ljava/security/cert/X509Certificate;
...
.method public static o(Ljava/lang/String;)[[Ljava/security/cert/X509Certificate;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    .line 2
    :try_start_0
    invoke-static {v0}, Lcom/split/signature/G;->n(Ljava/io/RandomAccessFile;)[[Ljava/security/cert/X509Certificate;
...
.method private static p(Ljava/nio/channels/FileChannel;Lcom/split/signature/c;)[[Ljava/security/cert/X509Certificate;
    .locals 10
    ...
    invoke-static {v2}, Lcom/split/signature/G;->t(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v4, v0, v1}, Lcom/split/signature/G;->l(Ljava/nio/ByteBuffer;Ljava/util/Map;Ljava/security/cert/CertificateFactory;)[Ljava/security/cert/X509Certificate;
    ...
    .line 8
    iget-wide v2, p1, Lcom/split/signature/c;->a:J

    iget-wide v4, p1, Lcom/split/signature/c;->b:J

    iget-wide v6, p1, Lcom/split/signature/c;->c:J

    iget-object v8, p1, Lcom/split/signature/c;->b:Ljava/nio/ByteBuffer;

    move-object v1, p0

    invoke-static/range {v0 .. v8}, Lcom/split/signature/G;->j(Ljava/util/Map;Ljava/nio/channels/FileChannel;JJJLjava/nio/ByteBuffer;)V
...
.method private static s(Ljava/io/RandomAccessFile;)Lcom/split/signature/c;
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    .line 1
    invoke-static {p0}, Lcom/split/signature/G;->v(Ljava/io/RandomAccessFile;)Landroid/util/Pair;
    ...
    .line 5
    invoke-static {v10, v8, v9}, Lcom/split/signature/G;->d(Ljava/nio/ByteBuffer;J)J

    move-result-wide v6

    .line 6
    invoke-static {p0, v6, v7}, Lcom/split/signature/G;->f(Ljava/io/RandomAccessFile;J)Landroid/util/Pair;
    ...
    .line 8
    invoke-static {v0}, Lcom/split/signature/G;->z(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
...
.method private static t(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 4
    invoke-static {p0, v0}, Lcom/split/signature/G;->u(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
...
.method private static u(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    .locals 3
...
.method private static v(Ljava/io/RandomAccessFile;)Landroid/util/Pair;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, v0}, Lcom/split/signature/G;->e(Ljava/io/RandomAccessFile;I)Landroid/util/Pair;
...
.method private static x(Ljava/nio/ByteBuffer;)[B
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private static z(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/split/signature/D;
    ...
    .line 1
    invoke-static {p0}, Lcom/split/signature/G;->B(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p0, v1, v0}, Lcom/split/signature/G;->g(Ljava/nio/ByteBuffer;II)Ljava/nio/ByteBuffer;
    ...
    .line 9
    invoke-static {p0, v3}, Lcom/split/signature/G;->u(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
...
.method public a([Ljava/security/MessageDigest;JI)V
    ...
    .line 8
    iget-object p2, p0, Lcom/split/signature/G;->a:Ljava/nio/ByteBuffer;
