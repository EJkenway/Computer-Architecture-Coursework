...
.method public static constructor <clinit>()V
    ...
    const-string v5, "com.alibaba.j256.ormlite.android.AndroidLog"

    invoke-direct {v1, v2, v3, v4, v5}, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;-><init>(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V

    sput-object v1, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;->ANDROID:Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;
    ...
    const-string v7, "com.alibaba.j256.ormlite.logger.Slf4jLoggingLog"

    invoke-direct {v2, v4, v5, v6, v7}, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;-><init>(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V

    sput-object v2, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;->SLF4J:Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;

    .line 3
    new-instance v4, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;
    ...
    const-string v9, "com.alibaba.j256.ormlite.logger.CommonsLoggingLog"

    invoke-direct {v4, v6, v7, v8, v9}, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;-><init>(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V

    sput-object v4, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;->COMMONS_LOGGING:Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;

    .line 4
    new-instance v6, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;
    ...
    const-string v11, "com.alibaba.j256.ormlite.logger.Log4j2Log"

    invoke-direct {v6, v8, v9, v10, v11}, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;-><init>(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V

    sput-object v6, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;->LOG4J2:Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;

    .line 5
    new-instance v8, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;
    ...
    const-string v13, "com.alibaba.j256.ormlite.logger.Log4jLog"

    invoke-direct {v8, v10, v11, v12, v13}, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;-><init>(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V

    sput-object v8, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;->LOG4J:Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;

    .line 6
    new-instance v10, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType$1;
    ...
    invoke-direct {v10, v13, v14, v12, v0}, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType$1;-><init>(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V

    sput-object v10, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;->LOCAL:Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;

    const/4 v0, 0x6

    new-array v0, v0, [Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;
    ...
    .line 7
    sput-object v0, Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;->$VALUES:[Lcom/alibaba/j256/ormlite/logger/LoggerFactory$LogType;
