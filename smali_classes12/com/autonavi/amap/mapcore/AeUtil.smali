...
.field public static final SO_FILENAME:Ljava/lang/String; = "AMapSDK_MAP_v6_5_0"

.field public static final SO_FILENAME_NAVI:Ljava/lang/String; = "AMapSDK_NAVI_v6_3_0"
...
.method public static synthetic access$000(Ljava/lang/String;Landroid/content/Context;)V
    .locals 0

    .line 1
    invoke-static {p0, p1}, Lcom/autonavi/amap/mapcore/AeUtil;->loadEngineRes(Ljava/lang/String;Landroid/content/Context;)V
...
.method public static initResource(Landroid/content/Context;)Lcom/autonavi/ae/gmap/GLMapEngine$InitParam;
    .locals 10
    ...
    .line 7
    :try_start_0
    invoke-static {v3}, Lcom/amap/api/mapcore/util/kr;->a(I)Lcom/amap/api/mapcore/util/kr;

    move-result-object v3

    new-instance v4, Lcom/autonavi/amap/mapcore/AeUtil$1;

    invoke-direct {v4, v0, p0}, Lcom/autonavi/amap/mapcore/AeUtil$1;-><init>(Ljava/lang/String;Landroid/content/Context;)V

    invoke-virtual {v3, v4}, Lcom/amap/api/mapcore/util/kr;->a(Lcom/amap/api/mapcore/util/ks;)V
    :try_end_0
    ...
    .line 9
    :cond_1
    invoke-static {v0, p0}, Lcom/autonavi/amap/mapcore/AeUtil;->loadEngineRes(Ljava/lang/String;Landroid/content/Context;)V

    .line 10
    :goto_0
    new-instance v3, Lcom/autonavi/ae/gmap/GLMapEngine$InitParam;

    invoke-direct {v3}, Lcom/autonavi/ae/gmap/GLMapEngine$InitParam;-><init>()V

    .line 11
    new-instance v4, Ljava/io/File;

    const-string v5, "GNaviConfig.xml"
    ...
    const-string v6, "ae/GNaviConfig.xml"

    invoke-static {v6, v4, p0}, Lcom/autonavi/amap/mapcore/AeUtil;->readAssetsFileAndSave(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V

    .line 14
    :goto_1
    iput-object v0, v3, Lcom/autonavi/ae/gmap/GLMapEngine$InitParam;->mRootPath:Ljava/lang/String;
    ...
    iput-object p0, v3, Lcom/autonavi/ae/gmap/GLMapEngine$InitParam;->mConfigPath:Ljava/lang/String;
    ...
    iput-object p0, v3, Lcom/autonavi/ae/gmap/GLMapEngine$InitParam;->mOfflineDataPath:Ljava/lang/String;

    .line 17
    iput-object v1, v3, Lcom/autonavi/ae/gmap/GLMapEngine$InitParam;->mP3dCrossPath:Ljava/lang/String;
...
.method public static loadLib(Landroid/content/Context;)V
    ...
    const-string v2, "AMapSDK_MAP_v6_5_0"

    invoke-virtual {v0, p0, v1, v2}, Lcom/amap/api/mapcore/util/io;->a(Landroid/content/Context;Lcom/amap/api/mapcore/util/ip;Ljava/lang/String;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
