...
.method public constructor <init>(Lij3/z;Lij3/x;Lij3/z;Lij3/b0;Ljava/lang/Object;Lij3/b0;Ljava/util/List;)V
    ...
    iput-object p1, p0, Lm61/a$d$a;->a:Lij3/z;

    iput-object p2, p0, Lm61/a$d$a;->b:Lij3/x;

    iput-object p3, p0, Lm61/a$d$a;->c:Lij3/z;

    iput-object p4, p0, Lm61/a$d$a;->d:Lij3/b0;

    iput-object p5, p0, Lm61/a$d$a;->e:Ljava/lang/Object;

    iput-object p6, p0, Lm61/a$d$a;->f:Lij3/b0;

    iput-object p7, p0, Lm61/a$d$a;->g:Ljava/util/List;
...
.method public bridge synthetic a(Lcom/gotokeep/keep/link2/data/LinkBusinessError;ILjava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lm61/a$d$a;->b(Lcom/gotokeep/keep/link2/data/LinkBusinessError;ILcom/keep/kirin/proto/services/machine/Machine$TrainLogResponseMessage;)V
...
.method public b(Lcom/gotokeep/keep/link2/data/LinkBusinessError;ILcom/keep/kirin/proto/services/machine/Machine$TrainLogResponseMessage;)V
    ...
    .line 1
    iget-object v0, p0, Lm61/a$d$a;->a:Lij3/z;
    ...
    .line 4
    :cond_1
    iget-object p1, p0, Lm61/a$d$a;->c:Lij3/z;

    iget-object p2, p0, Lm61/a$d$a;->f:Lij3/b0;

    iget-object v1, p0, Lm61/a$d$a;->g:Ljava/util/List;

    iget-object v2, p0, Lm61/a$d$a;->b:Lij3/x;
    ...
    .line 8
    new-instance v3, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLog;

    invoke-direct {v3}, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLog;-><init>()V
    ...
    invoke-virtual {v3, v4}, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLog;->k(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v4}, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLog;->n(I)V
    ...
    invoke-virtual {v3, v4}, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLog;->i(I)V
    ...
    invoke-virtual {v3, v4}, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLog;->h(S)V
    ...
    invoke-virtual {v3, v4}, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLog;->l(B)V
    ...
    invoke-virtual {v3, p1}, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLog;->j(S)V

    .line 15
    invoke-virtual {v3, v1}, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLog;->m(Ljava/util/List;)V
    ...
    .line 23
    new-instance v4, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLogSegment;

    invoke-direct {v4}, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLogSegment;-><init>()V
    ...
    invoke-virtual {v4, v5}, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLogSegment;->j(S)V
    ...
    invoke-virtual {v4, v5}, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLogSegment;->g(B)V
    ...
    invoke-virtual {v4, v5}, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLogSegment;->h(S)V
    ...
    invoke-virtual {v4, v5}, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLogSegment;->k(S)V
    ...
    invoke-virtual {v4, v5}, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLogSegment;->i(I)V
    ...
    invoke-virtual {v4, v3}, Lcom/gotokeep/keep/kt/business/rowing/linkcontract/param/SpinningLogSegment;->f(I)V
    ...
    .line 34
    iget-object p1, p0, Lm61/a$d$a;->b:Lij3/x;

    iget-object p2, p0, Lm61/a$d$a;->c:Lij3/z;

    iget-object p3, p0, Lm61/a$d$a;->d:Lij3/b0;
    ...
    .line 40
    iget-object p1, p0, Lm61/a$d$a;->d:Lij3/b0;
    ...
    :cond_5
    :goto_4
    iget-object p1, p0, Lm61/a$d$a;->e:Ljava/lang/Object;

    iget-object p2, p0, Lm61/a$d$a;->b:Lij3/x;

    iget-object p3, p0, Lm61/a$d$a;->c:Lij3/z;
