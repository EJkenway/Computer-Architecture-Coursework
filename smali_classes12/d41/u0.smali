...
.method public constructor <init>(Lcom/gotokeep/keep/kt/business/common/mvp/view/KitCourseFilterView;Lj41/a;Landroidx/appcompat/app/AppCompatActivity;)V
    .locals 1
    ...
    .line 2
    iput-object p2, p0, Ld41/u0;->g:Lj41/a;

    .line 3
    iput-object p3, p0, Ld41/u0;->h:Landroidx/appcompat/app/AppCompatActivity;

    .line 4
    new-instance p2, Ld41/u0$c;

    invoke-direct {p2, p0, p1}, Ld41/u0$c;-><init>(Ld41/u0;Lcom/gotokeep/keep/kt/business/common/mvp/view/KitCourseFilterView;)V

    iput-object p2, p0, Ld41/u0;->n:Lhj3/p;
    ...
    new-instance p3, Ld41/u0$a;

    invoke-direct {p3, p0}, Ld41/u0$a;-><init>(Ld41/u0;)V
    ...
    new-instance p2, Ld41/r0;

    invoke-direct {p2, p0}, Ld41/r0;-><init>(Ld41/u0;)V
    ...
    .line 7
    invoke-virtual {p0, p1}, Ld41/u0;->Z1(I)V

    .line 8
    invoke-virtual {p0}, Ld41/u0;->P1()V

    return-void
.end method

.method public static final synthetic A1(Ld41/u0;)V
    .locals 0

    .line 1
    invoke-virtual {p0}, Ld41/u0;->O1()V

    return-void
.end method

.method public static final synthetic B1(Ld41/u0;Lb41/p;)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1}, Ld41/u0;->Y1(Lb41/p;)V

    return-void
.end method

.method public static final synthetic E1(Ld41/u0;)V
    .locals 0

    .line 1
    invoke-virtual {p0}, Ld41/u0;->a2()V

    return-void
.end method

.method public static final synthetic H1(Ld41/u0;Landroid/view/View;)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1}, Ld41/u0;->b2(Landroid/view/View;)V

    return-void
.end method

.method public static final Q1(Ld41/u0;Lwi3/f;)V
    .locals 4
    ...
    iget-object v1, p0, Ld41/u0;->j:Lb41/p;
    ...
    :cond_0
    iget-object v3, p0, Ld41/u0;->g:Lj41/a;

    invoke-virtual {v3}, Lj41/a;->p1()Ljava/lang/String;
    ...
    :goto_1
    invoke-virtual {p0, v0, p1}, Ld41/u0;->X1(IZ)V

    return-void
.end method

.method public static final S1(Ld41/u0;Ljava/lang/Integer;)V
    .locals 1
...
.method public static synthetic q1(Ld41/u0;Ljava/lang/Integer;)V
    .locals 0

    invoke-static {p0, p1}, Ld41/u0;->S1(Ld41/u0;Ljava/lang/Integer;)V

    return-void
.end method

.method public static synthetic r1(Ld41/u0;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Ld41/u0;->u1(Ld41/u0;Landroid/view/View;)V

    return-void
.end method

.method public static synthetic s1(Ld41/u0;Lwi3/f;)V
    .locals 0

    invoke-static {p0, p1}, Ld41/u0;->Q1(Ld41/u0;Lwi3/f;)V

    return-void
.end method

.method public static final u1(Ld41/u0;Landroid/view/View;)V
    .locals 0
...
.method public static final synthetic v1(Ld41/u0;)V
    .locals 0

    .line 1
    invoke-virtual {p0}, Ld41/u0;->K1()V

    return-void
.end method

.method public static final synthetic x1(Ld41/u0;)Ld41/b;
    .locals 0

    .line 1
    iget-object p0, p0, Ld41/u0;->i:Ld41/b;

    return-object p0
.end method

.method public static final synthetic y1(Ld41/u0;Lb41/p;)Ljava/lang/String;
    .locals 0

    .line 1
    invoke-virtual {p0, p1}, Ld41/u0;->L1(Lb41/p;)Ljava/lang/String;
...
.method public static final synthetic z1(Ld41/u0;)Lb41/p;
    .locals 0

    .line 1
    iget-object p0, p0, Ld41/u0;->j:Lb41/p;
...
.method public I1(Lb41/p;)V
    ...
    .line 1
    iput-object p1, p0, Ld41/u0;->j:Lb41/p;
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, p1}, Ld41/u0;->J1(Lb41/p;)V

    return-void
.end method

.method public final J1(Lb41/p;)V
    .locals 1
    ...
    invoke-virtual {p0, v0}, Ld41/u0;->V1(Lqu0/f;)V
    ...
    invoke-virtual {p0, p1}, Ld41/u0;->T1(Lqu0/f$b;)Landroid/view/View;
...
.method public final K1()V
    ...
    .line 1
    iget-object v0, p0, Ld41/u0;->o:Lk41/j;
...
.method public final L1(Lb41/p;)Ljava/lang/String;
    .locals 3
...
.method public final M1()Lj41/a;
    .locals 1

    .line 1
    iget-object v0, p0, Ld41/u0;->g:Lj41/a;
...
.method public final P1()V
    ...
    iget-object v1, p0, Ld41/u0;->h:Landroidx/appcompat/app/AppCompatActivity;

    new-instance v2, Ld41/t0;

    invoke-direct {v2, p0}, Ld41/t0;-><init>(Ld41/u0;)V
    ...
    invoke-virtual {v0}, Lj41/a;->S1()Landroidx/lifecycle/MutableLiveData;

    move-result-object v0

    iget-object v1, p0, Ld41/u0;->h:Landroidx/appcompat/app/AppCompatActivity;

    new-instance v2, Ld41/s0;

    invoke-direct {v2, p0}, Ld41/s0;-><init>(Ld41/u0;)V
...
.method public final T1(Lqu0/f$b;)Landroid/view/View;
    ...
    .line 4
    new-instance v4, Ld41/u0$b;

    invoke-direct {v4, p1, v1, v0, p0}, Ld41/u0$b;-><init>(Lqu0/f$b;Ljava/util/List;Lcom/gotokeep/keep/kt/business/puncheur/mvp/view/CourseSortView;Ld41/u0;)V
...
.method public final V1(Lqu0/f;)V
    ...
    iget-object v6, p0, Ld41/u0;->n:Lhj3/p;
    ...
    iput-object v2, p0, Ld41/u0;->i:Ld41/b;
...
.method public final X1(IZ)V
    ...
    :cond_1
    invoke-virtual {v0, p1, p2}, Lk41/j;->y(IZ)V
...
.method public final Y1(Lb41/p;)V
    .locals 1
    ...
    :cond_1
    invoke-virtual {v0, p1}, Lk41/j;->x(Lb41/p;)V
...
.method public final a2()V
    ...
    .line 1
    iget-object v0, p0, Ld41/u0;->j:Lb41/p;
    ...
    .line 3
    new-instance v3, Ld41/u0$d;

    invoke-direct {v3, v0}, Ld41/u0$d;-><init>(Lb41/p;)V

    new-instance v4, Ld41/u0$e;

    invoke-direct {v4, v0, p0}, Ld41/u0$e;-><init>(Lb41/p;Ld41/u0;)V

    new-instance v5, Ld41/u0$f;

    invoke-direct {v5, v0, p0}, Ld41/u0$f;-><init>(Lb41/p;Ld41/u0;)V

    .line 4
    invoke-direct {v1, v2, v3, v4, v5}, Lk41/j;-><init>(Landroid/content/Context;Lhj3/a;Lhj3/a;Lhj3/a;)V

    .line 5
    invoke-virtual {v1, v0}, Lk41/j;->q(Lb41/p;)V

    .line 6
    invoke-virtual {v1}, Landroid/app/Dialog;->show()V

    .line 7
    iput-object v1, p0, Ld41/u0;->o:Lk41/j;
...
.method public bridge synthetic bind(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Ld41/u0;->I1(Lb41/p;)V
