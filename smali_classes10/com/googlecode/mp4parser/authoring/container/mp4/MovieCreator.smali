...
.method public static a(Lcom/googlecode/mp4parser/DataSource;)Lcom/googlecode/mp4parser/authoring/Movie;
    .locals 11
    ...
    .line 3
    invoke-virtual {v0}, Lcom/coremedia/iso/IsoFile;->j()Lcom/coremedia/iso/boxes/MovieBox;
    ...
    invoke-virtual {p0}, Lcom/coremedia/iso/boxes/MovieBox;->g()Lcom/coremedia/iso/boxes/MovieHeaderBox;

    move-result-object p0

    invoke-virtual {p0}, Lcom/coremedia/iso/boxes/MovieHeaderBox;->q()Lcom/googlecode/mp4parser/util/Matrix;

    move-result-object p0

    invoke-virtual {v1, p0}, Lcom/googlecode/mp4parser/authoring/Movie;->h(Lcom/googlecode/mp4parser/util/Matrix;)V
    ...
    .line 7
    invoke-static {v3, v4}, Lcom/googlecode/mp4parser/util/Path;->e(Lcom/googlecode/mp4parser/AbstractContainerBox;Ljava/lang/String;)Lcom/coremedia/iso/boxes/Box;
    ...
    .line 8
    invoke-virtual {v4}, Lcom/coremedia/iso/boxes/SchemeTypeBox;->n()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/coremedia/iso/boxes/TrackBox;->k()Lcom/coremedia/iso/boxes/TrackHeaderBox;
    ...
    invoke-virtual {v1, v4}, Lcom/googlecode/mp4parser/authoring/Movie;->a(Lcom/googlecode/mp4parser/authoring/Track;)V
...
.method public static b(Ljava/lang/String;)Lcom/googlecode/mp4parser/authoring/Movie;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {v0}, Lcom/googlecode/mp4parser/authoring/container/mp4/MovieCreator;->a(Lcom/googlecode/mp4parser/DataSource;)Lcom/googlecode/mp4parser/authoring/Movie;
