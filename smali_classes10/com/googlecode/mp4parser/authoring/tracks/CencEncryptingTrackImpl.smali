...
.method public constructor <init>(Lcom/googlecode/mp4parser/authoring/Track;Ljava/util/UUID;Ljava/util/Map;Ljava/util/Map;Ljava/lang/String;ZZ)V
    ...
    iput-object v4, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Ljava/util/Map;

    const/4 v4, 0x0

    .line 6
    iput-boolean v4, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Z

    .line 7
    iput-boolean v4, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->b:Z

    const/4 v5, 0x0

    .line 8
    iput-object v5, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Lcom/coremedia/iso/boxes/SampleDescriptionBox;

    move-object/from16 v6, p1

    .line 9
    iput-object v6, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Lcom/googlecode/mp4parser/authoring/Track;

    .line 10
    iput-object v2, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Ljava/util/Map;

    .line 11
    iput-object v1, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Ljava/util/UUID;

    .line 12
    iput-boolean v3, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Z

    move-object/from16 v7, p5

    .line 13
    iput-object v7, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Ljava/lang/String;
    ...
    iput-object v7, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->b:Ljava/util/Map;
    ...
    .line 17
    iget-object v9, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->b:Ljava/util/Map;
    ...
    iget-object v8, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->b:Ljava/util/Map;
    ...
    iput-object v7, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Ljava/util/List;
    ...
    iput-object v7, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->b:Ljava/util/List;
    ...
    iput-object v3, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Lcom/googlecode/mp4parser/util/RangeStartMap;
    ...
    invoke-virtual {v1}, Lcom/coremedia/iso/boxes/SampleDescriptionBox;->g()Lcom/coremedia/iso/boxes/sampleentry/AbstractSampleEntry;
    ...
    .line 31
    :goto_5
    iget-object v2, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Ljava/util/List;
    ...
    .line 34
    iget-object v5, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->b:Ljava/util/List;

    invoke-interface {v5, v3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 35
    iget-object v5, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Lcom/googlecode/mp4parser/util/RangeStartMap;
    ...
    .line 41
    iput-object v6, v3, Lcom/mp4parser/iso23001/part7/CencSampleAuxiliaryDataFormat;->a:[B
    ...
    .line 43
    iget-boolean v5, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->b:Z
    ...
    invoke-virtual {v3, v2, v6, v7}, Lcom/mp4parser/iso23001/part7/CencSampleAuxiliaryDataFormat;->a(IJ)Lcom/mp4parser/iso23001/part7/CencSampleAuxiliaryDataFormat$Pair;

    move-result-object v2

    aput-object v2, v5, v4

    iput-object v5, v3, Lcom/mp4parser/iso23001/part7/CencSampleAuxiliaryDataFormat;->a:[Lcom/mp4parser/iso23001/part7/CencSampleAuxiliaryDataFormat$Pair;
    ...
    iput-object v2, v3, Lcom/mp4parser/iso23001/part7/CencSampleAuxiliaryDataFormat;->a:[Lcom/mp4parser/iso23001/part7/CencSampleAuxiliaryDataFormat$Pair;

    goto :goto_c

    .line 48
    :cond_a
    invoke-static {v2, v13}, Lcom/coremedia/iso/IsoTypeReaderVariable;->a(Ljava/nio/ByteBuffer;I)J
    ...
    invoke-virtual {v0, v12}, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a(Ljava/nio/ByteBuffer;)Z
    ...
    .line 51
    invoke-virtual {v3, v12, v14, v15}, Lcom/mp4parser/iso23001/part7/CencSampleAuxiliaryDataFormat;->a(IJ)Lcom/mp4parser/iso23001/part7/CencSampleAuxiliaryDataFormat$Pair;
    ...
    .line 56
    iput-object v1, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Ljava/lang/Object;
    ...
    .line 57
    iput-boolean v11, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->b:Z

    .line 58
    invoke-virtual {v2}, Lcom/mp4parser/iso14496/part15/AvcConfigurationBox;->r()I
    ...
    .line 62
    invoke-virtual {v1}, Lcom/mp4parser/iso14496/part15/HevcConfigurationBox;->y()I
    ...
    .line 64
    iget-object v3, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Lcom/googlecode/mp4parser/util/RangeStartMap;
    ...
    invoke-virtual {v3, v4, v15}, Lcom/googlecode/mp4parser/util/RangeStartMap;->a(Ljava/lang/Comparable;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v4}, Lcom/googlecode/mp4parser/boxes/mp4/samplegrouping/CencSampleEncryptionInformationGroupEntry;->e()Ljava/util/UUID;
    ...
    invoke-virtual {v3, v15, v4}, Lcom/googlecode/mp4parser/util/RangeStartMap;->a(Ljava/lang/Comparable;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v3}, Lcom/googlecode/mp4parser/boxes/mp4/samplegrouping/CencSampleEncryptionInformationGroupEntry;->e()Ljava/util/UUID;
    ...
    invoke-virtual {v3, v4, v5}, Lcom/googlecode/mp4parser/util/RangeStartMap;->a(Ljava/lang/Comparable;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 75
    iget-object v5, v0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->b:Ljava/util/Map;
...
.method public a(Ljava/nio/ByteBuffer;)Z
    ...
    .line 1
    iget-object v0, p0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Ljava/lang/Object;
    ...
    invoke-static {p1}, Lcom/googlecode/mp4parser/authoring/tracks/h265/H265TrackImpl;->f(Ljava/nio/ByteBuffer;)Lcom/googlecode/mp4parser/authoring/tracks/h265/H265NalUnitHeader;

    move-result-object p1

    .line 3
    iget p1, p1, Lcom/googlecode/mp4parser/authoring/tracks/h265/H265NalUnitHeader;->b:I
    ...
    invoke-static {p1}, Lcom/googlecode/mp4parser/authoring/tracks/h264/H264TrackImpl;->n(Ljava/nio/ByteBuffer;)Lcom/googlecode/mp4parser/authoring/tracks/h264/H264NalUnitHeader;

    move-result-object p1

    .line 6
    iget p1, p1, Lcom/googlecode/mp4parser/authoring/tracks/h264/H264NalUnitHeader;->b:I
...
.method public getDefaultKeyId()Ljava/util/UUID;
    ...
    .line 1
    iget-object v0, p0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Ljava/util/UUID;
...
.method public getName()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Lcom/googlecode/mp4parser/authoring/Track;
...
.method public declared-synchronized getSampleDescriptionBox()Lcom/coremedia/iso/boxes/SampleDescriptionBox;
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Lcom/coremedia/iso/boxes/SampleDescriptionBox;
    ...
    iput-object v0, p0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Lcom/coremedia/iso/boxes/SampleDescriptionBox;
    :try_end_1
    ...
    .line 6
    iget-object v2, p0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Lcom/coremedia/iso/boxes/SampleDescriptionBox;

    invoke-virtual {v2}, Lcom/coremedia/iso/boxes/SampleDescriptionBox;->g()Lcom/coremedia/iso/boxes/sampleentry/AbstractSampleEntry;
    ...
    invoke-virtual {v0, v2}, Lcom/coremedia/iso/boxes/OriginalFormatBox;->m(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Lcom/coremedia/iso/boxes/sampleentry/AudioSampleEntry;->I(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Lcom/coremedia/iso/boxes/sampleentry/VisualSampleEntry;->u(Ljava/lang/String;)V
    ...
    .line 12
    invoke-virtual {v2, v0}, Lcom/googlecode/mp4parser/BasicContainer;->a(Lcom/coremedia/iso/boxes/Box;)V
    ...
    invoke-virtual {v0, v3}, Lcom/coremedia/iso/boxes/SchemeTypeBox;->q(Ljava/lang/String;)V

    const/high16 v3, 0x10000

    .line 15
    invoke-virtual {v0, v3}, Lcom/coremedia/iso/boxes/SchemeTypeBox;->s(I)V
    ...
    .line 19
    iget-object v4, p0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Ljava/util/UUID;
    ...
    :goto_1
    invoke-virtual {v3, v4}, Lcom/googlecode/mp4parser/boxes/AbstractTrackEncryptionBox;->r(I)V
    ...
    :goto_2
    invoke-virtual {v3, v1}, Lcom/googlecode/mp4parser/boxes/AbstractTrackEncryptionBox;->q(I)V

    .line 21
    iget-object v1, p0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Ljava/util/UUID;
    ...
    :cond_3
    invoke-virtual {v3, v1}, Lcom/googlecode/mp4parser/boxes/AbstractTrackEncryptionBox;->s(Ljava/util/UUID;)V
    ...
    invoke-virtual {v0}, Lcom/coremedia/iso/boxes/SampleDescriptionBox;->g()Lcom/coremedia/iso/boxes/sampleentry/AbstractSampleEntry;
...
.method public getSampleEncryptionEntries()Ljava/util/List;
    ...
    .line 1
    iget-object v0, p0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->b:Ljava/util/List;
...
.method public getSampleGroups()Ljava/util/Map;
    ...
    .line 1
    iget-object v0, p0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->b:Ljava/util/Map;
...
.method public getSamples()Ljava/util/List;
    ...
    iget-object v1, p0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->a:Lcom/googlecode/mp4parser/util/RangeStartMap;
...
.method public hasSubSampleEncryption()Z
    ...
    .line 1
    iget-boolean v0, p0, Lcom/googlecode/mp4parser/authoring/tracks/CencEncryptingTrackImpl;->b:Z
