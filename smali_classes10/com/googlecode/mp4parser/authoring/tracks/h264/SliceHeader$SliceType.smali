...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;

    const-string v3, "B"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;->B:Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;

    new-instance v3, Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;

    const-string v5, "I"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;->I:Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;

    new-instance v5, Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;

    const-string v7, "SP"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;->SP:Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;

    new-instance v7, Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;

    const-string v9, "SI"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;->SI:Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;
    ...
    .line 2
    sput-object v9, Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;->ENUM$VALUES:[Lcom/googlecode/mp4parser/authoring/tracks/h264/SliceHeader$SliceType;
