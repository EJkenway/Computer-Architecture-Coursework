.class public final Lcom/ksad/download/e;
...
.method public static a(Ljava/io/File;IZ)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v2}, Lcom/ksad/download/c;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-static {v2, p0}, Lcom/ksad/download/e;->a(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
    ...
    invoke-static {}, Lcom/ksad/download/c;->P()Z

    move-result p0

    if-eqz p0, :cond_1

    invoke-static {v0}, Lcom/ksad/download/e;->a(Landroid/content/Intent;)Landroid/content/Intent;
...
.method public static e(Ljava/lang/String;I)Landroid/app/PendingIntent;
    .locals 3
...
.method public static l(Lcom/ksad/download/DownloadTask;)Landroid/app/PendingIntent;
    .locals 6
    ...
    invoke-virtual {v3}, Lcom/ksad/download/c;->getContext()Landroid/content/Context;

    move-result-object v3

    invoke-static {v3, v0}, Lcom/ksad/download/e;->a(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
    ...
    invoke-static {v1}, Lcom/ksad/download/e;->a(Landroid/content/Intent;)Landroid/content/Intent;
