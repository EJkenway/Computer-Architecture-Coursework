...
.method public constructor <init>(Ljava/util/List;)V
    ...
    .line 5
    :goto_0
    iget v1, p0, Lcom/google/android/exoplayer/text/webvtt/WebvttSubtitle;->numCues:I
    ...
    .line 8
    iget-wide v4, v1, Lcom/google/android/exoplayer/text/webvtt/WebvttCue;->endTime:J
    ...
    .line 9
    :cond_0
    iget-object p1, p0, Lcom/google/android/exoplayer/text/webvtt/WebvttSubtitle;->cueTimesUs:[J
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer/text/webvtt/WebvttSubtitle;->sortedCueTimesUs:[J
...
.method public getCues(J)Ljava/util/List;
    ...
    .line 1
    :goto_0
    iget v4, p0, Lcom/google/android/exoplayer/text/webvtt/WebvttSubtitle;->numCues:I
    ...
    .line 4
    :cond_0
    iget-object v4, p0, Lcom/google/android/exoplayer/text/webvtt/WebvttSubtitle;->cues:Ljava/util/List;

    invoke-interface {v4, v3}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Lcom/google/android/exoplayer/text/webvtt/WebvttCue;

    .line 5
    invoke-virtual {v4}, Lcom/google/android/exoplayer/text/webvtt/WebvttCue;->isNormalCue()Z
    ...
    .line 7
    iget-object v6, v1, Lcom/google/android/exoplayer/text/Cue;->text:Ljava/lang/CharSequence;
    ...
    iget-object v4, v4, Lcom/google/android/exoplayer/text/Cue;->text:Ljava/lang/CharSequence;
    ...
    .line 10
    new-instance p1, Lcom/google/android/exoplayer/text/webvtt/WebvttCue;

    invoke-direct {p1, v0}, Lcom/google/android/exoplayer/text/webvtt/WebvttCue;-><init>(Ljava/lang/CharSequence;)V
...
.method public getEventTime(I)J
    ...
    .line 2
    iget-object v2, p0, Lcom/google/android/exoplayer/text/webvtt/WebvttSubtitle;->sortedCueTimesUs:[J
...
.method public getNextEventTimeIndex(J)I
    ...
    .line 2
    iget-object p2, p0, Lcom/google/android/exoplayer/text/webvtt/WebvttSubtitle;->sortedCueTimesUs:[J
