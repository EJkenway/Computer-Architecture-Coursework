...
.method public static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lcom/google/android/filament/MaterialInstance$FloatElement;

    const-string v3, "FLOAT2"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/google/android/filament/MaterialInstance$FloatElement;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/google/android/filament/MaterialInstance$FloatElement;->FLOAT2:Lcom/google/android/filament/MaterialInstance$FloatElement;

    .line 3
    new-instance v3, Lcom/google/android/filament/MaterialInstance$FloatElement;

    const-string v5, "FLOAT3"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/google/android/filament/MaterialInstance$FloatElement;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/google/android/filament/MaterialInstance$FloatElement;->FLOAT3:Lcom/google/android/filament/MaterialInstance$FloatElement;

    .line 4
    new-instance v5, Lcom/google/android/filament/MaterialInstance$FloatElement;

    const-string v7, "FLOAT4"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/google/android/filament/MaterialInstance$FloatElement;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/google/android/filament/MaterialInstance$FloatElement;->FLOAT4:Lcom/google/android/filament/MaterialInstance$FloatElement;

    .line 5
    new-instance v7, Lcom/google/android/filament/MaterialInstance$FloatElement;

    const-string v9, "MAT3"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/google/android/filament/MaterialInstance$FloatElement;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/google/android/filament/MaterialInstance$FloatElement;->MAT3:Lcom/google/android/filament/MaterialInstance$FloatElement;

    .line 6
    new-instance v9, Lcom/google/android/filament/MaterialInstance$FloatElement;

    const-string v11, "MAT4"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lcom/google/android/filament/MaterialInstance$FloatElement;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/google/android/filament/MaterialInstance$FloatElement;->MAT4:Lcom/google/android/filament/MaterialInstance$FloatElement;

    const/4 v11, 0x6

    new-array v11, v11, [Lcom/google/android/filament/MaterialInstance$FloatElement;
    ...
    .line 7
    sput-object v11, Lcom/google/android/filament/MaterialInstance$FloatElement;->$VALUES:[Lcom/google/android/filament/MaterialInstance$FloatElement;
