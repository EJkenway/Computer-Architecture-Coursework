...
.method public setScope(I)Lno/nordicsemi/android/dfu/DfuServiceInitiator;
    .locals 2
    .param p1    # I
        .annotation build Lno/nordicsemi/android/dfu/DfuScope;
        .end annotation
    .end param
...
.method public start(Landroid/content/Context;Ljava/lang/Class;)Lno/nordicsemi/android/dfu/DfuServiceController;
    ...
    .line 18
    iget-boolean p2, p0, Lno/nordicsemi/android/dfu/DfuServiceInitiator;->disableResume:Z
    ...
    .line 19
    iget p2, p0, Lno/nordicsemi/android/dfu/DfuServiceInitiator;->numberOfRetries:I

    const-string v1, "no.nordicsemi.android.dfu.extra.EXTRA_MAX_DFU_ATTEMPTS"

    invoke-virtual {v0, v1, p2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    .line 20
    iget p2, p0, Lno/nordicsemi/android/dfu/DfuServiceInitiator;->mbrSize:I

    const-string v1, "no.nordicsemi.android.dfu.extra.EXTRA_MBR_SIZE"
    ...
    .line 23
    :cond_0
    iget p2, p0, Lno/nordicsemi/android/dfu/DfuServiceInitiator;->currentMtu:I

    const-string v1, "no.nordicsemi.android.dfu.extra.EXTRA_CURRENT_MTU"
