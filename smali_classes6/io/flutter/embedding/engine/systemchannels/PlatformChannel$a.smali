...
# instance fields
.field public final synthetic a:Lio/flutter/embedding/engine/systemchannels/PlatformChannel;
...
.method public a(Lri3/h;Lri3/i$d;)V
    ...
    invoke-static {v1}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel;->a(Lio/flutter/embedding/engine/systemchannels/PlatformChannel;)Lio/flutter/embedding/engine/systemchannels/PlatformChannel$d;
    ...
    invoke-static {p1}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel;->a(Lio/flutter/embedding/engine/systemchannels/PlatformChannel;)Lio/flutter/embedding/engine/systemchannels/PlatformChannel$d;

    move-result-object p1

    invoke-interface {p1}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel$d;->b()Z
    ...
    invoke-interface {v1, p1}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel$d;->h(Ljava/lang/String;)V

    .line 13
    invoke-interface {p2, v3}, Lri3/i$d;->a(Ljava/lang/Object;)V
    ...
    .line 18
    invoke-static {v2}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel;->a(Lio/flutter/embedding/engine/systemchannels/PlatformChannel;)Lio/flutter/embedding/engine/systemchannels/PlatformChannel$d;

    move-result-object v2

    invoke-interface {v2, p1}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel$d;->c(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$ClipboardContentFormat;)Ljava/lang/CharSequence;
    ...
    .line 21
    invoke-interface {p2, v2}, Lri3/i$d;->a(Ljava/lang/Object;)V
    ...
    invoke-interface {p1}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel$d;->g()V
    ...
    .line 26
    invoke-static {v1, p1}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel;->e(Lio/flutter/embedding/engine/systemchannels/PlatformChannel;Lorg/json/JSONObject;)Lio/flutter/embedding/engine/systemchannels/PlatformChannel$e;
    ...
    invoke-interface {v1, p1}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel$d;->a(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$e;)V
    ...
    invoke-interface {p1}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel$d;->d()V
    ...
    invoke-interface {v1, p1}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel$d;->e(Ljava/util/List;)V
    ...
    .line 37
    invoke-static {v1, p1}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel;->c(Lio/flutter/embedding/engine/systemchannels/PlatformChannel;Lorg/json/JSONObject;)Lio/flutter/embedding/engine/systemchannels/PlatformChannel$c;
    ...
    invoke-interface {v1, p1}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel$d;->f(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$c;)V
    ...
    invoke-interface {v1, p1}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel$d;->j(I)V
    ...
    invoke-interface {v1, p1}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel$d;->k(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$HapticFeedbackType;)V
    ...
    invoke-interface {v1, p1}, Lio/flutter/embedding/engine/systemchannels/PlatformChannel$d;->i(Lio/flutter/embedding/engine/systemchannels/PlatformChannel$SoundType;)V
