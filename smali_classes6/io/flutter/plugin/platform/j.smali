...
.field public b:Lio/flutter/embedding/android/b;

.field public c:Landroid/content/Context;

.field public d:Landroid/view/View;

.field public e:Lio/flutter/view/f;

.field public f:Lio/flutter/plugin/editing/TextInputPlugin;

.field public g:Lqi3/h;
...
.field public final r:Lio/flutter/embedding/android/g;

.field public final s:Lqi3/h$e;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/j;->s:Lqi3/h$e;
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/j;->a:Lio/flutter/plugin/platform/f;
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/j;->r:Lio/flutter/embedding/android/g;
...
.method private synthetic K()V
    ...
    .line 1
    invoke-virtual {p0, v0}, Lio/flutter/plugin/platform/j;->E(Z)V

    return-void
.end method

.method public static T(Ljava/lang/Object;F)Landroid/view/MotionEvent$PointerCoords;
    .locals 3
...
.method public static V(Ljava/lang/Object;)Landroid/view/MotionEvent$PointerProperties;
    .locals 2
...
.method public static synthetic d(Lio/flutter/plugin/platform/j;)V
    .locals 0
...
.method public static synthetic f(Lio/flutter/plugin/platform/j;)Lio/flutter/plugin/platform/f;
    .locals 0

    .line 1
    iget-object p0, p0, Lio/flutter/plugin/platform/j;->a:Lio/flutter/plugin/platform/f;

    return-object p0
.end method

.method public static synthetic g(Lio/flutter/plugin/platform/j;)Ljava/util/HashMap;
    .locals 0
...
.method public static synthetic h(Lio/flutter/plugin/platform/j;)Lio/flutter/plugin/editing/TextInputPlugin;
    .locals 0

    .line 1
    iget-object p0, p0, Lio/flutter/plugin/platform/j;->f:Lio/flutter/plugin/editing/TextInputPlugin;

    return-object p0
.end method

.method public static synthetic i(Lio/flutter/plugin/platform/j;Lio/flutter/plugin/platform/k;)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1}, Lio/flutter/plugin/platform/j;->L(Lio/flutter/plugin/platform/k;)V

    return-void
.end method

.method public static synthetic j(Lio/flutter/plugin/platform/j;Lio/flutter/plugin/platform/k;)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1}, Lio/flutter/plugin/platform/j;->Z(Lio/flutter/plugin/platform/k;)V

    return-void
.end method

.method public static synthetic k(Lio/flutter/plugin/platform/j;)Lqi3/h;
    .locals 0

    .line 1
    iget-object p0, p0, Lio/flutter/plugin/platform/j;->g:Lqi3/h;

    return-object p0
.end method

.method public static synthetic l(Lio/flutter/plugin/platform/j;)Landroid/content/Context;
    .locals 0
...
.method public static synthetic m(Lio/flutter/plugin/platform/j;)Landroid/util/SparseArray;
    .locals 0
...
.method public static synthetic n(Lio/flutter/plugin/platform/j;)Landroid/util/SparseArray;
    .locals 0
...
.method public static synthetic o(Lio/flutter/plugin/platform/j;D)I
    .locals 0

    .line 1
    invoke-virtual {p0, p1, p2}, Lio/flutter/plugin/platform/j;->Y(D)I
...
.method public static synthetic p(Lio/flutter/plugin/platform/j;II)V
    .locals 0

    .line 1
    invoke-virtual {p0, p1, p2}, Lio/flutter/plugin/platform/j;->b0(II)V

    return-void
.end method

.method public static synthetic q(Lio/flutter/plugin/platform/j;)Lio/flutter/view/f;
    .locals 0

    .line 1
    iget-object p0, p0, Lio/flutter/plugin/platform/j;->e:Lio/flutter/view/f;

    return-object p0
.end method

.method public static synthetic r(Lio/flutter/plugin/platform/j;)Lio/flutter/plugin/platform/a;
    .locals 0

    .line 1
    iget-object p0, p0, Lio/flutter/plugin/platform/j;->h:Lio/flutter/plugin/platform/a;

    return-object p0
.end method

.method public static synthetic s(Lio/flutter/plugin/platform/j;)Landroid/view/View;
    .locals 0
...
.method public B()V
    ...
    .line 1
    iget-object v0, p0, Lio/flutter/plugin/platform/j;->g:Lqi3/h;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lqi3/h;->e(Lqi3/h$e;)V

    .line 2
    iput-object v1, p0, Lio/flutter/plugin/platform/j;->g:Lqi3/h;

    .line 3
    iput-object v1, p0, Lio/flutter/plugin/platform/j;->c:Landroid/content/Context;

    .line 4
    iput-object v1, p0, Lio/flutter/plugin/platform/j;->e:Lio/flutter/view/f;
...
.method public D()V
    ...
    .line 1
    iput-object v0, p0, Lio/flutter/plugin/platform/j;->f:Lio/flutter/plugin/editing/TextInputPlugin;
...
.method public final E(Z)V
    ...
    invoke-virtual {v2, v4}, Lio/flutter/embedding/android/FlutterView;->i(Lio/flutter/embedding/android/FlutterImageView;)V
...
.method public final F()V
    ...
    .line 5
    iget-object v0, p0, Lio/flutter/plugin/platform/j;->s:Lqi3/h$e;
    ...
    invoke-interface {v0, v1}, Lqi3/h$e;->d(I)V
...
.method public H()Lio/flutter/plugin/platform/e;
    .locals 1

    .line 1
    iget-object v0, p0, Lio/flutter/plugin/platform/j;->a:Lio/flutter/plugin/platform/f;
...
.method public I(I)V
    ...
    invoke-direct {v1, v2, v3, v4}, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;-><init>(Landroid/content/Context;FLio/flutter/embedding/android/b;)V
...
.method public final J()V
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/android/FlutterView;->l()V
...
.method public final L(Lio/flutter/plugin/platform/k;)V
    .locals 1
    ...
    .line 1
    iget-object v0, p0, Lio/flutter/plugin/platform/j;->f:Lio/flutter/plugin/editing/TextInputPlugin;
    ...
    .line 2
    :cond_0
    invoke-virtual {v0}, Lio/flutter/plugin/editing/TextInputPlugin;->u()V
...
.method public O()V
    ...
    .line 1
    invoke-virtual {p0}, Lio/flutter/plugin/platform/j;->F()V
...
.method public P(IIIII)V
    ...
    .line 1
    invoke-virtual {p0}, Lio/flutter/plugin/platform/j;->J()V
...
.method public R()V
    ...
    invoke-direct {v1, p0}, Lio/flutter/plugin/platform/h;-><init>(Lio/flutter/plugin/platform/j;)V

    invoke-virtual {v0, v1}, Lio/flutter/embedding/android/FlutterView;->v(Ljava/lang/Runnable;)V
    ...
    .line 7
    :cond_1
    invoke-virtual {p0, v2}, Lio/flutter/plugin/platform/j;->E(Z)V
...
.method public X(FLqi3/h$d;Z)Landroid/view/MotionEvent;
    .locals 20
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
    ...
    .line 1
    iget-wide v1, v0, Lqi3/h$d;->p:J

    .line 2
    invoke-static {v1, v2}, Lio/flutter/embedding/android/g$a;->c(J)Lio/flutter/embedding/android/g$a;
    ...
    .line 3
    iget-object v3, v2, Lio/flutter/plugin/platform/j;->r:Lio/flutter/embedding/android/g;

    invoke-virtual {v3, v1}, Lio/flutter/embedding/android/g;->b(Lio/flutter/embedding/android/g$a;)Landroid/view/MotionEvent;

    move-result-object v1

    .line 4
    iget-object v3, v0, Lqi3/h$d;->f:Ljava/lang/Object;
    ...
    .line 7
    iget-object v3, v0, Lqi3/h$d;->g:Ljava/lang/Object;
    ...
    .line 22
    :cond_0
    iget-object v1, v0, Lqi3/h$d;->b:Ljava/lang/Number;
    ...
    iget-object v1, v0, Lqi3/h$d;->c:Ljava/lang/Number;
    ...
    iget v8, v0, Lqi3/h$d;->d:I

    iget v9, v0, Lqi3/h$d;->e:I

    iget v12, v0, Lqi3/h$d;->h:I

    iget v13, v0, Lqi3/h$d;->i:I

    iget v14, v0, Lqi3/h$d;->j:F

    iget v15, v0, Lqi3/h$d;->k:F

    iget v1, v0, Lqi3/h$d;->l:I

    iget v3, v0, Lqi3/h$d;->m:I

    iget v2, v0, Lqi3/h$d;->n:I

    iget v0, v0, Lqi3/h$d;->o:I
...
.method public final Y(D)I
    ...
    .line 1
    invoke-virtual {p0}, Lio/flutter/plugin/platform/j;->G()F
...
.method public final Z(Lio/flutter/plugin/platform/k;)V
    .locals 1
    .param p1    # Lio/flutter/plugin/platform/k;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 2
    :cond_0
    invoke-virtual {v0}, Lio/flutter/plugin/editing/TextInputPlugin;->G()V
...
.method public a(Lio/flutter/view/AccessibilityBridge;)V
    ...
    invoke-virtual {v0, p1}, Lio/flutter/plugin/platform/a;->b(Lio/flutter/view/AccessibilityBridge;)V
...
.method public c()V
    ...
    invoke-virtual {v0, v1}, Lio/flutter/plugin/platform/a;->b(Lio/flutter/view/AccessibilityBridge;)V

    return-void
.end method

.method public t(Landroid/content/Context;Lio/flutter/view/f;Lgi3/a;)V
    .locals 1
    .param p3    # Lgi3/a;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 3
    iput-object p2, p0, Lio/flutter/plugin/platform/j;->e:Lio/flutter/view/f;

    .line 4
    new-instance p1, Lqi3/h;

    invoke-direct {p1, p3}, Lqi3/h;-><init>(Lgi3/a;)V

    iput-object p1, p0, Lio/flutter/plugin/platform/j;->g:Lqi3/h;

    .line 5
    iget-object p2, p0, Lio/flutter/plugin/platform/j;->s:Lqi3/h$e;

    invoke-virtual {p1, p2}, Lqi3/h;->e(Lqi3/h$e;)V
...
.method public u(Lio/flutter/plugin/editing/TextInputPlugin;)V
    ...
    .line 1
    iput-object p1, p0, Lio/flutter/plugin/platform/j;->f:Lio/flutter/plugin/editing/TextInputPlugin;

    return-void
.end method

.method public v(Lpi3/a;)V
    .locals 2
    ...
    invoke-direct {v0, p1, v1}, Lio/flutter/embedding/android/b;-><init>(Lpi3/a;Z)V
...
.method public y()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    sget-object v4, Lio/flutter/embedding/android/FlutterImageView$SurfaceKind;->h:Lio/flutter/embedding/android/FlutterImageView$SurfaceKind;
    ...
    .line 5
    invoke-virtual {p0, v0}, Lio/flutter/plugin/platform/j;->z(Lio/flutter/embedding/android/FlutterImageView;)Lio/flutter/embedding/engine/FlutterOverlaySurface;
...
.method public z(Lio/flutter/embedding/android/FlutterImageView;)Lio/flutter/embedding/engine/FlutterOverlaySurface;
    .locals 2
