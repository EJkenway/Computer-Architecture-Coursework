...
.method public static synthetic i(Lio/flutter/plugin/platform/j$a;Lqi3/h$b;Landroid/view/View;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/plugin/platform/j$a;->k(Lqi3/h$b;Landroid/view/View;Z)V

    return-void
.end method

.method private synthetic k(Lqi3/h$b;Landroid/view/View;Z)V
    .locals 0
    ...
    invoke-static {p2}, Lio/flutter/plugin/platform/j;->k(Lio/flutter/plugin/platform/j;)Lqi3/h;

    move-result-object p2

    iget p1, p1, Lqi3/h$b;->a:I

    invoke-virtual {p2, p1}, Lqi3/h;->d(I)V
...
.method public a(II)V
    ...
    .line 2
    invoke-virtual {p0, v0}, Lio/flutter/plugin/platform/j$a;->j(I)V
...
.method public b(Lqi3/h$b;)J
    ...
    invoke-static {v0}, Lio/flutter/plugin/platform/j;->f(Lio/flutter/plugin/platform/j;)Lio/flutter/plugin/platform/f;

    move-result-object v0

    iget-object v1, p1, Lqi3/h$b;->b:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lio/flutter/plugin/platform/f;->a(Ljava/lang/String;)Lio/flutter/plugin/platform/d;
    ...
    .line 5
    iget-object v1, p1, Lqi3/h$b;->f:Ljava/nio/ByteBuffer;

    if-eqz v1, :cond_0

    .line 6
    invoke-virtual {v4}, Lio/flutter/plugin/platform/d;->b()Lri3/g;

    move-result-object v0

    iget-object v1, p1, Lqi3/h$b;->f:Ljava/nio/ByteBuffer;

    invoke-interface {v0, v1}, Lri3/g;->a(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    invoke-static {v0}, Lio/flutter/plugin/platform/j;->q(Lio/flutter/plugin/platform/j;)Lio/flutter/view/f;
    ...
    .line 13
    invoke-static {v1}, Lio/flutter/plugin/platform/j;->r(Lio/flutter/plugin/platform/j;)Lio/flutter/plugin/platform/a;

    move-result-object v3

    iget v8, p1, Lqi3/h$b;->a:I

    new-instance v10, Lio/flutter/plugin/platform/i;

    invoke-direct {v10, p0, p1}, Lio/flutter/plugin/platform/i;-><init>(Lio/flutter/plugin/platform/j$a;Lqi3/h$b;)V

    move-object v5, v0

    .line 14
    invoke-static/range {v2 .. v10}, Lio/flutter/plugin/platform/k;->a(Landroid/content/Context;Lio/flutter/plugin/platform/a;Lio/flutter/plugin/platform/d;Lio/flutter/view/f$a;IIILjava/lang/Object;Landroid/view/View$OnFocusChangeListener;)Lio/flutter/plugin/platform/k;
    ...
    .line 21
    invoke-interface {v0}, Lio/flutter/view/f$a;->id()J
    ...
    iget-object v2, p1, Lqi3/h$b;->b:Ljava/lang/String;
    ...
    iget-object p1, p1, Lqi3/h$b;->b:Ljava/lang/String;
...
.method public c(Lqi3/h$c;Ljava/lang/Runnable;)V
    .locals 5
    .param p1    # Lqi3/h$c;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public e(Lqi3/h$b;)V
    ...
    .line 4
    iget-object v2, p1, Lqi3/h$b;->f:Ljava/nio/ByteBuffer;

    if-eqz v2, :cond_0

    .line 5
    invoke-virtual {v0}, Lio/flutter/plugin/platform/d;->b()Lri3/g;

    move-result-object v1

    iget-object v2, p1, Lqi3/h$b;->f:Ljava/nio/ByteBuffer;

    invoke-interface {v1, v2}, Lri3/g;->a(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
...
.method public f(I)V
    ...
    invoke-static {v1}, Lio/flutter/plugin/platform/j;->h(Lio/flutter/plugin/platform/j;)Lio/flutter/plugin/editing/TextInputPlugin;
    ...
    invoke-virtual {v1, p1}, Lio/flutter/plugin/editing/TextInputPlugin;->l(I)V
...
.method public g(Lqi3/h$d;)V
    ...
    .line 3
    invoke-virtual {p0, v2}, Lio/flutter/plugin/platform/j$a;->j(I)V
    ...
    invoke-virtual {v0, v1, p1, v2}, Lio/flutter/plugin/platform/j;->X(FLqi3/h$d;Z)Landroid/view/MotionEvent;
