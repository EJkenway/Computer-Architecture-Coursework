...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lorg/joda/time/format/j;"
    }
.end annotation


# static fields
.field public static final enum g:Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;
...
.field public static final synthetic p:[Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;
...
.method public static constructor <clinit>()V
    ...
    .line 2
    sput-object v1, Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;->p:[Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;
    ...
    sput-object v0, Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;->j:Ljava/util/List;

    .line 4
    new-instance v0, Ljava/util/ArrayList;

    invoke-static {}, Lorg/joda/time/b;->i()Ljava/util/Set;

    move-result-object v1

    invoke-direct {v0, v1}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    sput-object v0, Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;->h:Ljava/util/List;
    ...
    sput-object v1, Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;->i:Ljava/util/Map;
    ...
    .line 13
    sget-object v7, Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;->i:Ljava/util/Map;
    ...
    .line 16
    :cond_2
    sget-object v5, Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;->j:Ljava/util/List;
    ...
    .line 18
    :cond_3
    sput v1, Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;->n:I

    .line 19
    sput v3, Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;->o:I
...
.method public static final values()[Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;
    ...
    .line 1
    sget-object v0, Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;->p:[Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;
...
.method public a()I
    ...
    .line 1
    sget v0, Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;->n:I
...
.method public c(Ljava/lang/Appendable;JLvn3/a;ILorg/joda/time/b;Ljava/util/Locale;)V
    ...
    .line 1
    invoke-virtual {p6}, Lorg/joda/time/b;->n()Ljava/lang/String;
...
.method public d(Lorg/joda/time/format/d;Ljava/lang/CharSequence;I)I
    ...
    .line 1
    sget-object v0, Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;->j:Ljava/util/List;
    ...
    .line 3
    sget v2, Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;->o:I
    ...
    .line 8
    :goto_1
    sget-object v1, Lorg/joda/time/format/DateTimeFormatterBuilder$TimeZoneId;->i:Ljava/util/Map;
