...
.method public a(IIIZI)V
    ...
    .line 1
    iget p4, p0, Lfk3/e;->d:I

    if-ne p1, p4, :cond_1

    iget p4, p0, Lfk3/e;->e:I
    ...
    .line 2
    iget-object p4, p0, Lfk3/e;->b:Landroid/graphics/Bitmap;
    ...
    .line 4
    iget-object p1, p0, Lfk3/e;->a:Landroid/graphics/Canvas;

    iget-object p2, p0, Lfk3/e;->b:Landroid/graphics/Bitmap;

    invoke-virtual {p1, p2}, Landroid/graphics/Canvas;->setBitmap(Landroid/graphics/Bitmap;)V

    .line 5
    invoke-virtual {p0}, Lfk3/e;->d()V
    ...
    .line 7
    invoke-virtual {p0}, Lfk3/e;->c()V

    .line 8
    :cond_3
    iput p1, p0, Lfk3/e;->d:I

    .line 9
    iput p2, p0, Lfk3/e;->e:I
    ...
    iput-object p1, p0, Lfk3/e;->b:Landroid/graphics/Bitmap;

    if-lez p3, :cond_5

    .line 13
    iput p3, p0, Lfk3/e;->f:I
    ...
    iput-object p1, p0, Lfk3/e;->a:Landroid/graphics/Canvas;
...
.method public final declared-synchronized b(Landroid/graphics/Canvas;FFLandroid/graphics/Paint;)Z
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lfk3/e;->c:[[Landroid/graphics/Bitmap;
    ...
    .line 2
    :goto_0
    iget-object v3, p0, Lfk3/e;->c:[[Landroid/graphics/Bitmap;
    ...
    .line 3
    :goto_1
    iget-object v4, p0, Lfk3/e;->c:[[Landroid/graphics/Bitmap;
    ...
    :cond_5
    :try_start_1
    iget-object v0, p0, Lfk3/e;->b:Landroid/graphics/Bitmap;
...
.method public declared-synchronized c()V
    ...
    .line 2
    iput-object v1, p0, Lfk3/e;->b:Landroid/graphics/Bitmap;

    const/4 v1, 0x0

    .line 3
    iput v1, p0, Lfk3/e;->e:I

    iput v1, p0, Lfk3/e;->d:I
...
.method public final d()V
    ...
    .line 2
    iput-object v1, p0, Lfk3/e;->c:[[Landroid/graphics/Bitmap;
...
.method public e(IIII)V
    ...
    .line 2
    iget v0, p0, Lfk3/e;->d:I

    if-lez v0, :cond_8

    iget v1, p0, Lfk3/e;->e:I

    if-lez v1, :cond_8

    iget-object v2, p0, Lfk3/e;->b:Landroid/graphics/Bitmap;
    ...
    .line 10
    iget-object v0, p0, Lfk3/e;->a:Landroid/graphics/Canvas;
    ...
    iput-object v0, p0, Lfk3/e;->a:Landroid/graphics/Canvas;

    .line 12
    iget v3, p0, Lfk3/e;->f:I
    ...
    .line 19
    :cond_5
    iget-object v6, p0, Lfk3/e;->a:Landroid/graphics/Canvas;
    ...
    iget-object v7, p0, Lfk3/e;->b:Landroid/graphics/Bitmap;
    ...
    iget-object p3, p0, Lfk3/e;->b:Landroid/graphics/Bitmap;

    invoke-virtual {p1, p3}, Landroid/graphics/Canvas;->setBitmap(Landroid/graphics/Bitmap;)V

    .line 24
    iput-object p2, p0, Lfk3/e;->c:[[Landroid/graphics/Bitmap;
