.class public Lcom/taobao/login4android/jsbridge/JSBridgeService$d;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/taobao/login4android/jsbridge/JSBridgeService;->refreshYoukuOpenSid(Landroid/taobao/windvane/jsbridge/WVCallBackContext;Ljava/lang/String;)V
.end annotation
...
.method public constructor <init>(Lcom/taobao/login4android/jsbridge/JSBridgeService;Landroid/taobao/windvane/jsbridge/WVCallBackContext;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/taobao/login4android/jsbridge/JSBridgeService$d;->a:Lcom/taobao/login4android/jsbridge/JSBridgeService;

    iput-object p2, p0, Lcom/taobao/login4android/jsbridge/JSBridgeService$d;->a:Landroid/taobao/windvane/jsbridge/WVCallBackContext;
...
.method public onError(Ljava/lang/String;Lcom/ali/user/mobile/rpc/RpcResponse;)V
    ...
    .line 2
    :goto_0
    iget-object v0, p0, Lcom/taobao/login4android/jsbridge/JSBridgeService$d;->a:Lcom/taobao/login4android/jsbridge/JSBridgeService;

    iget-object v1, p0, Lcom/taobao/login4android/jsbridge/JSBridgeService$d;->a:Landroid/taobao/windvane/jsbridge/WVCallBackContext;
...
.method public onSuccess(Lcom/ali/user/mobile/rpc/RpcResponse;)V
    ...
    .line 1
    iget-object p1, p0, Lcom/taobao/login4android/jsbridge/JSBridgeService$d;->a:Lcom/taobao/login4android/jsbridge/JSBridgeService;

    iget-object v2, p0, Lcom/taobao/login4android/jsbridge/JSBridgeService$d;->a:Landroid/taobao/windvane/jsbridge/WVCallBackContext;
    ...
    .line 2
    :cond_0
    instance-of v2, p1, Lcom/taobao/login4android/biz/getYouKuOpenSid/mtop/GetYoukuOpenSidResponseData;

    if-eqz v2, :cond_2

    .line 3
    check-cast p1, Lcom/taobao/login4android/biz/getYouKuOpenSid/mtop/GetYoukuOpenSidResponseData;

    .line 4
    iget-object p1, p1, Lcom/taobao/login4android/biz/getYouKuOpenSid/mtop/GetYoukuOpenSidResponseData;->returnValue:[Ljava/lang/String;
    ...
    .line 8
    iget-object v0, p0, Lcom/taobao/login4android/jsbridge/JSBridgeService$d;->a:Landroid/taobao/windvane/jsbridge/WVCallBackContext;
...
.method public onSystemError(Ljava/lang/String;Lcom/ali/user/mobile/rpc/RpcResponse;)V
    ...
    .line 1
    iget-object p2, p0, Lcom/taobao/login4android/jsbridge/JSBridgeService$d;->a:Lcom/taobao/login4android/jsbridge/JSBridgeService;
