...
.method public static final g([Ljava/lang/Object;[Ljava/lang/Object;)Z
    ...
    invoke-static {v4, v5}, Lkotlin/collections/c;->g([Ljava/lang/Object;[Ljava/lang/Object;)Z
    ...
    invoke-virtual {v4}, Lkotlin/UByteArray;->s()[B

    move-result-object v4

    check-cast v5, Lkotlin/UByteArray;

    invoke-virtual {v5}, Lkotlin/UByteArray;->s()[B

    move-result-object v5

    invoke-static {v4, v5}, Lkotlin/collections/unsigned/UArraysKt___UArraysKt;->x0([B[B)Z
    ...
    invoke-virtual {v4}, Lkotlin/UShortArray;->s()[S

    move-result-object v4

    check-cast v5, Lkotlin/UShortArray;

    invoke-virtual {v5}, Lkotlin/UShortArray;->s()[S

    move-result-object v5

    invoke-static {v4, v5}, Lkotlin/collections/unsigned/UArraysKt___UArraysKt;->u0([S[S)Z
    ...
    invoke-virtual {v4}, Lkotlin/UIntArray;->s()[I

    move-result-object v4

    check-cast v5, Lkotlin/UIntArray;

    invoke-virtual {v5}, Lkotlin/UIntArray;->s()[I

    move-result-object v5

    invoke-static {v4, v5}, Lkotlin/collections/unsigned/UArraysKt___UArraysKt;->v0([I[I)Z
    ...
    invoke-virtual {v4}, Lkotlin/ULongArray;->s()[J

    move-result-object v4

    check-cast v5, Lkotlin/ULongArray;

    invoke-virtual {v5}, Lkotlin/ULongArray;->s()[J

    move-result-object v5

    invoke-static {v4, v5}, Lkotlin/collections/unsigned/UArraysKt___UArraysKt;->z0([J[J)Z
...
.method public static final h([Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {p0, v1, v0}, Lkotlin/collections/c;->i([Ljava/lang/Object;Ljava/lang/StringBuilder;Ljava/util/List;)V
...
.method private static final i([Ljava/lang/Object;Ljava/lang/StringBuilder;Ljava/util/List;)V
    ...
    invoke-static {v2, p1, p2}, Lkotlin/collections/c;->i([Ljava/lang/Object;Ljava/lang/StringBuilder;Ljava/util/List;)V
    ...
    invoke-virtual {v2}, Lkotlin/UByteArray;->s()[B

    move-result-object v2

    invoke-static {v2}, Lkotlin/collections/unsigned/UArraysKt___UArraysKt;->L0([B)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lkotlin/UShortArray;->s()[S

    move-result-object v2

    invoke-static {v2}, Lkotlin/collections/unsigned/UArraysKt___UArraysKt;->P0([S)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lkotlin/UIntArray;->s()[I

    move-result-object v2

    invoke-static {v2}, Lkotlin/collections/unsigned/UArraysKt___UArraysKt;->O0([I)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lkotlin/ULongArray;->s()[J

    move-result-object v2

    invoke-static {v2}, Lkotlin/collections/unsigned/UArraysKt___UArraysKt;->R0([J)Ljava/lang/String;
    ...
    .line 24
    invoke-static {p2}, Lkotlin/collections/CollectionsKt__CollectionsKt;->G(Ljava/util/List;)I
...
.method public static final j([[Ljava/lang/Object;)Ljava/util/List;
    ...
    .line 3
    invoke-static {v0, v3}, Lkotlin/collections/h;->s0(Ljava/util/Collection;[Ljava/lang/Object;)Z
...
.method private static final k([Ljava/lang/Object;Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<C:[",
