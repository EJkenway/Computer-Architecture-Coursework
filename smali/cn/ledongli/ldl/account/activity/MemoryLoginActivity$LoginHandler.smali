.class public final Lcn/ledongli/ldl/account/activity/MemoryLoginActivity$LoginHandler;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "activity",
        "<init>",
        "(Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;)V",
        "usercenter_release"
    }
    k = 0x1
    mv = {
...
.method public constructor <init>(Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;)V
    ...
    iput-object v0, p0, Lcn/ledongli/ldl/account/activity/MemoryLoginActivity$LoginHandler;->mActivityRef:Ljava/lang/ref/WeakReference;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    sget-object v0, Lcn/ledongli/ldl/account/activity/MemoryLoginActivity$LoginHandler;->$ipChange:Lcom/android/alibaba/ip/runtime/IpChange;

    const-string v1, "4644"
    ...
    .line 1
    iget-object v0, p0, Lcn/ledongli/ldl/account/activity/MemoryLoginActivity$LoginHandler;->mActivityRef:Ljava/lang/ref/WeakReference;

    invoke-virtual {v0}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;
    ...
    .line 3
    :pswitch_0
    invoke-static {v0}, Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;->access$openClick(Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;)V

    .line 4
    invoke-virtual {v0}, Lcn/ledongli/ldl/activity/NoSwipeBaseActivity;->hideDialog()V

    .line 5
    invoke-static {v0, p1}, Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;->access$showErrorMsg(Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;Landroid/os/Message;)V
    ...
    .line 7
    invoke-static {v0}, Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;->access$closeClick(Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;)V

    .line 8
    sget v1, Lcn/ledongli/ldl/utils/AccountLoignHelper;->TYPE_ALIPAY:I

    invoke-static {v0, p1}, Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;->access$getStringObjFromMessage(Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;Landroid/os/Message;)Ljava/lang/String;

    move-result-object p1

    invoke-static {v0, v1, p1}, Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;->access$loginToServer(Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;ILjava/lang/String;)V
    ...
    .line 10
    invoke-virtual {v0, p1, p1}, Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;->loginWechat(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 18
    invoke-virtual {v0}, Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;->login()V
    ...
    invoke-static {v0}, Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;->access$getMWechatLoginObserver$p(Lcn/ledongli/ldl/account/activity/MemoryLoginActivity;)Lcn/ledongli/ldl/account/activity/MemoryLoginActivity$WechatLoginObserver;
