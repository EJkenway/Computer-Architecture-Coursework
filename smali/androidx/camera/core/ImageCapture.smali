...
.field private mImageReaderCloseFuture:Lcom/google/common/util/concurrent/a;
...
.method public constructor <init>(Landroidx/camera/core/impl/ImageCaptureConfig;)V
    ...
    .line 7
    invoke-static {v0}, Landroidx/camera/core/impl/utils/futures/Futures;->immediateFuture(Ljava/lang/Object;)Lcom/google/common/util/concurrent/a;

    move-result-object v0

    iput-object v0, p0, Landroidx/camera/core/ImageCapture;->mImageReaderCloseFuture:Lcom/google/common/util/concurrent/a;
...
.method public static synthetic e(Lcom/google/common/util/concurrent/a;)V
    .locals 0

    invoke-static {p0}, Landroidx/camera/core/ImageCapture;->lambda$takePictureInternal$8(Lcom/google/common/util/concurrent/a;)V
...
.method public static synthetic i(Landroidx/camera/core/ImageCapture;Landroidx/camera/core/ImageCapture$ImageCaptureRequest;)Lcom/google/common/util/concurrent/a;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/camera/core/ImageCapture;->lambda$createPipeline$1(Landroidx/camera/core/ImageCapture$ImageCaptureRequest;)Lcom/google/common/util/concurrent/a;
...
.method private synthetic lambda$createPipeline$1(Landroidx/camera/core/ImageCapture$ImageCaptureRequest;)Lcom/google/common/util/concurrent/a;
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Landroidx/camera/core/ImageCapture;->takePictureInternal(Landroidx/camera/core/ImageCapture$ImageCaptureRequest;)Lcom/google/common/util/concurrent/a;
...
.method private static synthetic lambda$takePictureInternal$8(Lcom/google/common/util/concurrent/a;)V
    .locals 1
...
.method private synthetic lambda$takePictureInternal$9(Landroidx/camera/core/ImageCapture$ImageCaptureRequest;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    .line 5
    invoke-virtual {p0, p1}, Landroidx/camera/core/ImageCapture;->issueTakePicture(Landroidx/camera/core/ImageCapture$ImageCaptureRequest;)Lcom/google/common/util/concurrent/a;
    ...
    invoke-static {p1, v0, v1}, Landroidx/camera/core/impl/utils/futures/Futures;->addCallback(Lcom/google/common/util/concurrent/a;Landroidx/camera/core/impl/utils/futures/FutureCallback;Ljava/util/concurrent/Executor;)V

    .line 7
    new-instance v0, Landroidx/camera/core/b0;

    invoke-direct {v0, p1}, Landroidx/camera/core/b0;-><init>(Lcom/google/common/util/concurrent/a;)V
...
.method private takePictureInternal(Landroidx/camera/core/ImageCapture$ImageCaptureRequest;)Lcom/google/common/util/concurrent/a;
    .locals 1
...
.method public clearPipeline()V
    ...
    iput-object v1, p0, Landroidx/camera/core/ImageCapture;->mImageReaderCloseFuture:Lcom/google/common/util/concurrent/a;
...
.method public createPipeline(Ljava/lang/String;Landroidx/camera/core/impl/ImageCaptureConfig;Landroid/util/Size;)Landroidx/camera/core/impl/SessionConfig$Builder;
    ...
    invoke-virtual {v3}, Landroidx/camera/core/ProcessingImageReader;->getCloseFuture()Lcom/google/common/util/concurrent/a;
    ...
    .line 73
    :cond_e
    invoke-static {v6}, Landroidx/camera/core/impl/utils/futures/Futures;->immediateFuture(Ljava/lang/Object;)Lcom/google/common/util/concurrent/a;

    move-result-object v3

    :goto_7
    iput-object v3, v0, Landroidx/camera/core/ImageCapture;->mImageReaderCloseFuture:Lcom/google/common/util/concurrent/a;

    .line 74
    iget-object v3, v0, Landroidx/camera/core/ImageCapture;->mDeferrableSurface:Landroidx/camera/core/impl/DeferrableSurface;

    invoke-virtual {v3}, Landroidx/camera/core/impl/DeferrableSurface;->getTerminationFuture()Lcom/google/common/util/concurrent/a;
    ...
    .line 76
    invoke-interface {v3, v5, v4}, Lcom/google/common/util/concurrent/a;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method public issueTakePicture(Landroidx/camera/core/ImageCapture$ImageCaptureRequest;)Lcom/google/common/util/concurrent/a;
    .locals 7
    .param p1    # Landroidx/camera/core/ImageCapture$ImageCaptureRequest;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-interface {p1, v0, v1, v2}, Landroidx/camera/core/impl/CameraControlInternal;->submitStillCaptureRequests(Ljava/util/List;II)Lcom/google/common/util/concurrent/a;
    ...
    .line 41
    invoke-static {p1, v0, v1}, Landroidx/camera/core/impl/utils/futures/Futures;->transform(Lcom/google/common/util/concurrent/a;Landroidx/arch/core/util/Function;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/a;
...
.method public onDetached()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/camera/core/ImageCapture;->mImageReaderCloseFuture:Lcom/google/common/util/concurrent/a;
    ...
    invoke-direct {v2, v1}, Landroidx/camera/core/c0;-><init>(Ljava/util/concurrent/ExecutorService;)V
    ...
    .line 8
    invoke-interface {v0, v2, v1}, Lcom/google/common/util/concurrent/a;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
