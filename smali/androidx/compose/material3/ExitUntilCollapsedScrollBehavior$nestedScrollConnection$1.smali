...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;-><init>(Landroidx/compose/animation/core/DecayAnimationSpec;Lhj3/a;)V
.end annotation
...
.method public onPostFling-RZ2iAVY(JJLaj3/d;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p5}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1;-><init>(Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1;Laj3/d;)V
    ...
    iput v9, v0, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1;->label:I
    ...
    invoke-static/range {v1 .. v6}, Landroidx/compose/ui/input/nestedscroll/NestedScrollConnection$DefaultImpls;->onPostFling-RZ2iAVY(Landroidx/compose/ui/input/nestedscroll/NestedScrollConnection;JJLaj3/d;)Ljava/lang/Object;
    ...
    invoke-virtual {p2}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->getContentOffset()F
    ...
    invoke-virtual {p2}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->getOffset()F
    ...
    invoke-virtual {p1}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->getDecayAnimationSpec()Landroidx/compose/animation/core/DecayAnimationSpec;
    ...
    .line 10
    iput-object p4, v0, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1;->L$0:Ljava/lang/Object;
    ...
    invoke-static {p2, p3, p1, v9, v0}, Landroidx/compose/material3/AppBarKt;->access$onTopBarFling(Landroidx/compose/material3/TopAppBarScrollBehavior;FLandroidx/compose/animation/core/DecayAnimationSpec;ZLaj3/d;)Ljava/lang/Object;
...
.method public onPostScroll-DzOQY0M(JJI)J
    ...
    invoke-virtual {p5}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->getCanScroll()Lhj3/a;
    ...
    invoke-virtual {p5}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->getContentOffset()F
    ...
    invoke-virtual {p5, v0}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->setContentOffset(F)V
    ...
    invoke-virtual {p1, v0}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->setContentOffset(F)V
    ...
    invoke-virtual {p1}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->getOffset()F
    ...
    invoke-virtual {p3}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->getOffsetLimit()F

    move-result p3

    .line 10
    invoke-static {p5, p3, v0}, Loj3/o;->m(FFF)F

    move-result p3

    invoke-virtual {p2, p3}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->setOffset(F)V
    ...
    invoke-virtual {p3}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->getOffset()F
    ...
    invoke-virtual {p4}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->getOffset()F
    ...
    invoke-virtual {p1}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->getOffsetLimit()F

    move-result p1

    .line 16
    invoke-static {p5, p1, v0}, Loj3/o;->m(FFF)F

    move-result p1

    invoke-virtual {p4, p1}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->setOffset(F)V
...
.method public onPreScroll-OzD1aCk(JI)J
    ...
    invoke-virtual {p3}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->getCanScroll()Lhj3/a;
    ...
    invoke-virtual {v1}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->getOffsetLimit()F

    move-result v1

    invoke-static {p3, v1, v0}, Loj3/o;->m(FFF)F
    ...
    invoke-virtual {p3, v0}, Landroidx/compose/material3/ExitUntilCollapsedScrollBehavior;->setOffset(F)V
