...
.method public static synthetic horizontalGradient-8A-3gB4$default(Landroidx/compose/ui/graphics/Brush$Companion;[Lwi3/f;FFIILjava/lang/Object;)Landroidx/compose/ui/graphics/Brush;
    .locals 0
    ...
    .line 4
    :cond_2
    invoke-virtual {p0, p1, p2, p3, p4}, Landroidx/compose/ui/graphics/Brush$Companion;->horizontalGradient-8A-3gB4([Lwi3/f;FFI)Landroidx/compose/ui/graphics/Brush;
...
.method public static synthetic linearGradient-mHitzGk$default(Landroidx/compose/ui/graphics/Brush$Companion;[Lwi3/f;JJIILjava/lang/Object;)Landroidx/compose/ui/graphics/Brush;
    .locals 7
    ...
    .line 4
    invoke-virtual/range {v0 .. v6}, Landroidx/compose/ui/graphics/Brush$Companion;->linearGradient-mHitzGk([Lwi3/f;JJI)Landroidx/compose/ui/graphics/Brush;
...
.method public static synthetic radialGradient-P_Vx-Ks$default(Landroidx/compose/ui/graphics/Brush$Companion;[Lwi3/f;JFIILjava/lang/Object;)Landroidx/compose/ui/graphics/Brush;
    .locals 6
    ...
    .line 3
    invoke-virtual/range {v0 .. v5}, Landroidx/compose/ui/graphics/Brush$Companion;->radialGradient-P_Vx-Ks([Lwi3/f;JFI)Landroidx/compose/ui/graphics/Brush;
...
.method public static synthetic sweepGradient-Uv8p0NA$default(Landroidx/compose/ui/graphics/Brush$Companion;[Lwi3/f;JILjava/lang/Object;)Landroidx/compose/ui/graphics/Brush;
    .locals 0
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Landroidx/compose/ui/graphics/Brush$Companion;->sweepGradient-Uv8p0NA([Lwi3/f;J)Landroidx/compose/ui/graphics/Brush;
...
.method public static synthetic verticalGradient-8A-3gB4$default(Landroidx/compose/ui/graphics/Brush$Companion;[Lwi3/f;FFIILjava/lang/Object;)Landroidx/compose/ui/graphics/Brush;
    .locals 0
    ...
    .line 4
    :cond_2
    invoke-virtual {p0, p1, p2, p3, p4}, Landroidx/compose/ui/graphics/Brush$Companion;->verticalGradient-8A-3gB4([Lwi3/f;FFI)Landroidx/compose/ui/graphics/Brush;
...
.method public final horizontalGradient-8A-3gB4([Lwi3/f;FFI)Landroidx/compose/ui/graphics/Brush;
    .locals 7
    .annotation build Landroidx/compose/runtime/Stable;
    .end annotation
...
.method public final linearGradient-mHitzGk(Ljava/util/List;JJI)Landroidx/compose/ui/graphics/Brush;
    ...
    invoke-direct/range {v1 .. v9}, Landroidx/compose/ui/graphics/LinearGradient;-><init>(Ljava/util/List;Ljava/util/List;JJILij3/h;)V

    return-object v0
.end method

.method public final linearGradient-mHitzGk([Lwi3/f;JJI)Landroidx/compose/ui/graphics/Brush;
    .locals 11
    .annotation build Landroidx/compose/runtime/Stable;
    .end annotation
    ...
    invoke-direct/range {v2 .. v10}, Landroidx/compose/ui/graphics/LinearGradient;-><init>(Ljava/util/List;Ljava/util/List;JJILij3/h;)V
...
.method public final radialGradient-P_Vx-Ks(Ljava/util/List;JFI)Landroidx/compose/ui/graphics/Brush;
    ...
    invoke-direct/range {v1 .. v8}, Landroidx/compose/ui/graphics/RadialGradient;-><init>(Ljava/util/List;Ljava/util/List;JFILij3/h;)V

    return-object v0
.end method

.method public final radialGradient-P_Vx-Ks([Lwi3/f;JFI)Landroidx/compose/ui/graphics/Brush;
    .locals 9
    .annotation build Landroidx/compose/runtime/Stable;
    .end annotation
...
.method public final sweepGradient-Uv8p0NA(Ljava/util/List;J)Landroidx/compose/ui/graphics/Brush;
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/compose/ui/graphics/SweepGradient;-><init>(JLjava/util/List;Ljava/util/List;Lij3/h;)V

    return-object v0
.end method

.method public final sweepGradient-Uv8p0NA([Lwi3/f;J)Landroidx/compose/ui/graphics/Brush;
    .locals 7
    .annotation build Landroidx/compose/runtime/Stable;
    .end annotation
...
.method public final verticalGradient-8A-3gB4([Lwi3/f;FFI)Landroidx/compose/ui/graphics/Brush;
    .locals 7
    .annotation build Landroidx/compose/runtime/Stable;
    .end annotation
