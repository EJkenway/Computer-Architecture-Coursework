...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/compose/foundation/lazy/list/LazyListScrollingKt;->doSmoothScrollToItem(Landroidx/compose/foundation/lazy/LazyListState;IILaj3/d;)Ljava/lang/Object;
.end annotation
...
# direct methods
.method public constructor <init>(Landroidx/compose/foundation/lazy/LazyListState;IILaj3/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final create(Ljava/lang/Object;Laj3/d;)Laj3/d;
    ...
    iget v3, p0, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->$scrollOffset:I

    invoke-direct {v0, v1, v2, v3, p2}, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;-><init>(Landroidx/compose/foundation/lazy/LazyListState;IILaj3/d;)V
...
.method public final invoke(Landroidx/compose/foundation/gestures/ScrollScope;Laj3/d;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->create(Ljava/lang/Object;Laj3/d;)Laj3/d;

    move-result-object p1

    check-cast p1, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;

    sget-object p2, Lwi3/s;->a:Lwi3/s;

    invoke-virtual {p1, p2}, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->invoke(Landroidx/compose/foundation/gestures/ScrollScope;Laj3/d;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static/range {p1 .. p1}, Lwi3/h;->b(Ljava/lang/Object;)V
    :try_end_0
    .catch Landroidx/compose/foundation/lazy/list/ItemFoundInScroll; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 6
    new-instance v8, Lij3/x;

    invoke-direct {v8}, Lij3/x;-><init>()V

    iput-boolean v6, v8, Lij3/x;->g:Z
    ...
    iput-object v10, v9, Lij3/b0;->g:Ljava/lang/Object;
    ...
    iput v6, v11, Lij3/z;->g:I
    :try_end_1
    .catch Landroidx/compose/foundation/lazy/list/ItemFoundInScroll; {:try_start_1 .. :try_end_1} :catch_4
    ...
    :goto_1
    :try_start_2
    iget-boolean v7, v11, Lij3/x;->g:Z

    if-eqz v7, :cond_e

    iget-object v7, v9, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->$this_doSmoothScrollToItem:Landroidx/compose/foundation/lazy/LazyListState;
    ...
    move-result v8
    :try_end_2
    .catch Landroidx/compose/foundation/lazy/list/ItemFoundInScroll; {:try_start_2 .. :try_end_2} :catch_3
    ...
    .line 17
    iget v5, v9, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->$index:I
    ...
    .line 18
    iget v7, v9, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->$scrollOffset:I
    ...
    .line 20
    :goto_4
    iget-object v5, v12, Lij3/b0;->g:Ljava/lang/Object;
    ...
    iput-object v5, v12, Lij3/b0;->g:Ljava/lang/Object;
    ...
    .line 22
    iget-object v7, v12, Lij3/b0;->g:Ljava/lang/Object;
    ...
    :goto_7
    iget v7, v9, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->$index:I

    iget-object v4, v9, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->$this_doSmoothScrollToItem:Landroidx/compose/foundation/lazy/LazyListState;

    iget v3, v9, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->$scrollOffset:I
    :try_end_4
    .catch Landroidx/compose/foundation/lazy/list/ItemFoundInScroll; {:try_start_4 .. :try_end_4} :catch_3
    ...
    :try_start_5
    invoke-direct/range {v7 .. v18}, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3$2;-><init>(FLij3/y;Landroidx/compose/foundation/gestures/ScrollScope;Lij3/x;ZFLij3/z;ILandroidx/compose/foundation/lazy/LazyListState;ILij3/b0;)V

    const/4 v3, 0x2

    const/4 v4, 0x0

    iput-object v5, v6, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->L$0:Ljava/lang/Object;

    move-object/from16 v8, p1

    iput-object v8, v6, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->L$1:Ljava/lang/Object;

    move-object/from16 v9, v28

    iput-object v9, v6, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->L$2:Ljava/lang/Object;

    move-object/from16 v11, v29

    iput-object v11, v6, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->L$3:Ljava/lang/Object;

    iput v1, v6, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->F$0:F

    iput v2, v6, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->F$1:F

    iput v0, v6, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->I$0:I

    const/4 v7, 0x1

    iput v7, v6, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->label:I
    ...
    invoke-static/range {v16 .. v23}, Landroidx/compose/animation/core/SuspendAnimationKt;->animateTo$default(Landroidx/compose/animation/core/AnimationState;Ljava/lang/Object;Landroidx/compose/animation/core/AnimationSpec;ZLhj3/l;Laj3/d;ILjava/lang/Object;)Ljava/lang/Object;

    move-result-object v3
    :try_end_5
    .catch Landroidx/compose/foundation/lazy/list/ItemFoundInScroll; {:try_start_5 .. :try_end_5} :catch_2
    ...
    :goto_8
    :try_start_6
    iget v1, v13, Lij3/z;->g:I

    const/4 v3, 0x1

    add-int/2addr v1, v3

    iput v1, v13, Lij3/z;->g:I
    :try_end_6
    .catch Landroidx/compose/foundation/lazy/list/ItemFoundInScroll; {:try_start_6 .. :try_end_6} :catch_1
    ...
    iget-object v1, v9, Lij3/b0;->g:Ljava/lang/Object;

    check-cast v1, Landroidx/compose/animation/core/AnimationState;

    invoke-direct {v0, v10, v1}, Landroidx/compose/foundation/lazy/list/ItemFoundInScroll;-><init>(Landroidx/compose/foundation/lazy/LazyListItemInfo;Landroidx/compose/animation/core/AnimationState;)V

    throw v0
    :try_end_7
    .catch Landroidx/compose/foundation/lazy/list/ItemFoundInScroll; {:try_start_7 .. :try_end_7} :catch_4
    ...
    .line 30
    new-instance v4, Lij3/y;

    invoke-direct {v4}, Lij3/y;-><init>()V
    ...
    new-instance v8, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3$4;

    invoke-direct {v8, v0, v4, v12}, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3$4;-><init>(FLij3/y;Landroidx/compose/foundation/gestures/ScrollScope;)V
    ...
    iput v4, v1, Landroidx/compose/foundation/lazy/list/LazyListScrollingKt$doSmoothScrollToItem$3;->label:I
