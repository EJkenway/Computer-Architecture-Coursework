...
.method private constructor <init>(Landroidx/compose/ui/unit/Density;J)V
    ...
    .line 2
    iput-object p1, p0, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->density:Landroidx/compose/ui/unit/Density;

    .line 3
    iput-wide p2, p0, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->constraints:J
    ...
    iput p2, p0, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->maxWidth:F
    ...
    iput p1, p0, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->maxHeight:F

    return-void
.end method

.method public synthetic constructor <init>(Landroidx/compose/ui/unit/Density;JLij3/h;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;-><init>(Landroidx/compose/ui/unit/Density;J)V
...
.method public static synthetic copy-0kLqBqw$default(Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;Landroidx/compose/ui/unit/Density;JILjava/lang/Object;)Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;
    ...
    iget-object p1, p0, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->density:Landroidx/compose/ui/unit/Density;
    ...
    iget-wide p2, p0, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->constraints:J
...
.method public animateItemPlacement(Landroidx/compose/ui/Modifier;Landroidx/compose/animation/core/FiniteAnimationSpec;)Landroidx/compose/ui/Modifier;
    ...
    .line 1
    new-instance v0, Landroidx/compose/foundation/lazy/list/AnimateItemPlacementModifier;
    ...
    .line 3
    :goto_0
    invoke-direct {v0, p2, v1}, Landroidx/compose/foundation/lazy/list/AnimateItemPlacementModifier;-><init>(Landroidx/compose/animation/core/FiniteAnimationSpec;Lhj3/l;)V
...
.method public final component1()Landroidx/compose/ui/unit/Density;
    ...
    iget-object v0, p0, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->density:Landroidx/compose/ui/unit/Density;
...
.method public final component2-msEJaDk()J
    ...
    iget-wide v0, p0, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->constraints:J
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v1, p0, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->density:Landroidx/compose/ui/unit/Density;

    iget-object v3, p1, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->density:Landroidx/compose/ui/unit/Density;
    ...
    :cond_2
    iget-wide v3, p0, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->constraints:J

    iget-wide v5, p1, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->constraints:J
...
.method public fillParentMaxHeight(Landroidx/compose/ui/Modifier;F)Landroidx/compose/ui/Modifier;
    ...
    .line 1
    iget v0, p0, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->maxHeight:F
...
.method public fillParentMaxSize(Landroidx/compose/ui/Modifier;F)Landroidx/compose/ui/Modifier;
    ...
    .line 1
    iget v0, p0, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->maxWidth:F
    ...
    .line 3
    iget v1, p0, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->maxHeight:F
...
.method public hashCode()I
    ...
    iget-wide v1, p0, Landroidx/compose/foundation/lazy/list/LazyItemScopeImpl;->constraints:J
