.class public Landroidx/room/parser/SQLiteParser$ParseContext;
...
# virtual methods
.method public EOF()Lorg/antlr/v4/runtime/tree/TerminalNode;
    .locals 2
...
.method public accept(Lorg/antlr/v4/runtime/tree/ParseTreeVisitor;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0}, Landroidx/room/parser/SQLiteVisitor;->visitParse(Landroidx/room/parser/SQLiteParser$ParseContext;)Ljava/lang/Object;
...
.method public enterRule(Lorg/antlr/v4/runtime/tree/ParseTreeListener;)V
    ...
    invoke-interface {p1, p0}, Landroidx/room/parser/SQLiteListener;->enterParse(Landroidx/room/parser/SQLiteParser$ParseContext;)V

    :cond_0
    return-void
.end method

.method public error(I)Landroidx/room/parser/SQLiteParser$ErrorContext;
    .locals 1

    .line 2
    const-class v0, Landroidx/room/parser/SQLiteParser$ErrorContext;
    ...
    check-cast p1, Landroidx/room/parser/SQLiteParser$ErrorContext;

    return-object p1
.end method

.method public error()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public exitRule(Lorg/antlr/v4/runtime/tree/ParseTreeListener;)V
    ...
    invoke-interface {p1, p0}, Landroidx/room/parser/SQLiteListener;->exitParse(Landroidx/room/parser/SQLiteParser$ParseContext;)V
...
.method public sql_stmt_list(I)Landroidx/room/parser/SQLiteParser$Sql_stmt_listContext;
    .locals 1

    .line 2
    const-class v0, Landroidx/room/parser/SQLiteParser$Sql_stmt_listContext;

    invoke-virtual {p0, v0, p1}, Lorg/antlr/v4/runtime/ParserRuleContext;->getRuleContext(Ljava/lang/Class;I)Lorg/antlr/v4/runtime/ParserRuleContext;

    move-result-object p1

    check-cast p1, Landroidx/room/parser/SQLiteParser$Sql_stmt_listContext;

    return-object p1
.end method

.method public sql_stmt_list()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
