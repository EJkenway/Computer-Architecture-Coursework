.class public Lcom/alibaba/wireless/security/aopsdk/replace/android/nfc/NfcAdapter;
...
.method public static disableForegroundDispatch(Landroid/nfc/NfcAdapter;Landroid/app/Activity;)V
    .locals 10
    ...
    const-string v2, "android.nfc.NfcAdapter.disableForegroundDispatch(android.app.Activity)"
    ...
    .line 12
    invoke-virtual {p0, v0}, Landroid/nfc/NfcAdapter;->disableForegroundDispatch(Landroid/app/Activity;)V
...
.method public static enableForegroundDispatch(Landroid/nfc/NfcAdapter;Landroid/app/Activity;Landroid/app/PendingIntent;[Landroid/content/IntentFilter;[[Ljava/lang/String;)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Throwable;
    ...
    const-string v1, "android.nfc.NfcAdapter.enableForegroundDispatch(android.app.Activity,android.app.PendingIntent,android.content.IntentFilter[],java.lang.String[][])"
    ...
    .line 15
    invoke-virtual {p0, v0, v1, v2, v3}, Landroid/nfc/NfcAdapter;->enableForegroundDispatch(Landroid/app/Activity;Landroid/app/PendingIntent;[Landroid/content/IntentFilter;[[Ljava/lang/String;)V
    ...
    .line 28
    invoke-virtual {p0, p1, p2, p3, p4}, Landroid/nfc/NfcAdapter;->enableForegroundDispatch(Landroid/app/Activity;Landroid/app/PendingIntent;[Landroid/content/IntentFilter;[[Ljava/lang/String;)V
