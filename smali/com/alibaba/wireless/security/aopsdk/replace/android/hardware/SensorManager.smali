.class public Lcom/alibaba/wireless/security/aopsdk/replace/android/hardware/SensorManager;
...
.method public static getDefaultSensor(Landroid/hardware/SensorManager;I)Landroid/hardware/Sensor;
    .locals 10
    ...
    const-string v2, "android.hardware.SensorManager.getDefaultSensor(int)"
...
.method public static getDefaultSensor(Landroid/hardware/SensorManager;IZ)Landroid/hardware/Sensor;
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Throwable;
    ...
    const-string v2, "android.hardware.SensorManager.getDefaultSensor(int,boolean)"
    ...
    .line 37
    invoke-virtual {v1, v3}, Lcom/alibaba/wireless/security/aopsdk/Invocation;->getArgZ(I)Z
    ...
    .line 40
    invoke-virtual {p0, v0, v3}, Landroid/hardware/SensorManager;->getDefaultSensor(IZ)Landroid/hardware/Sensor;
    ...
    .line 53
    invoke-virtual {p0, p1, p2}, Landroid/hardware/SensorManager;->getDefaultSensor(IZ)Landroid/hardware/Sensor;
...
.method public static getSensorList(Landroid/hardware/SensorManager;I)Ljava/util/List;
    ...
    const-string v2, "android.hardware.SensorManager.getSensorList(int)"
