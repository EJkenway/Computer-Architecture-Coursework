.class public Lcom/alibaba/wireless/security/aopsdk/replace/android/taobao/windvane/webview/WVWebViewClient;
...
.method public static shouldInterceptRequest(Landroid/taobao/windvane/webview/WVWebViewClient;Landroid/webkit/WebView;Ljava/lang/String;)Landroid/webkit/WebResourceResponse;
    .locals 10
    ...
    const-string v1, "android.taobao.windvane.webview.WVWebViewClient.shouldInterceptRequest(android.webkit.WebView,java.lang.String)"
    ...
    .line 13
    invoke-virtual {p0, v0, v1}, Landroid/taobao/windvane/webview/WVWebViewClient;->shouldInterceptRequest(Landroid/webkit/WebView;Ljava/lang/String;)Landroid/webkit/WebResourceResponse;
    ...
    .line 26
    invoke-virtual {p0, p1, p2}, Landroid/taobao/windvane/webview/WVWebViewClient;->shouldInterceptRequest(Landroid/webkit/WebView;Ljava/lang/String;)Landroid/webkit/WebResourceResponse;
...
.method public static shouldOverrideUrlLoading(Landroid/taobao/windvane/webview/WVWebViewClient;Landroid/webkit/WebView;Ljava/lang/String;)Z
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Throwable;
    ...
    const-string v1, "android.taobao.windvane.webview.WVWebViewClient.shouldOverrideUrlLoading(android.webkit.WebView,java.lang.String)"
    ...
    .line 13
    invoke-virtual {p0, v0, v1}, Landroid/taobao/windvane/webview/WVWebViewClient;->shouldOverrideUrlLoading(Landroid/webkit/WebView;Ljava/lang/String;)Z
    ...
    .line 26
    invoke-virtual {p0, p1, p2}, Landroid/taobao/windvane/webview/WVWebViewClient;->shouldOverrideUrlLoading(Landroid/webkit/WebView;Ljava/lang/String;)Z
