.class public Landroid/taobao/windvane/monitor/WVMonitorConfigManager$2;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/taobao/windvane/monitor/WVMonitorConfigManager;->updateMonitorConfig(Landroid/taobao/windvane/config/WVConfigUpdateCallback;Ljava/lang/String;Ljava/lang/String;)V
.end annotation
...
# instance fields
.field public final synthetic this$0:Landroid/taobao/windvane/monitor/WVMonitorConfigManager;

.field public final synthetic val$callback:Landroid/taobao/windvane/config/WVConfigUpdateCallback;

.field public final synthetic val$finalMonitorConfigUrl:Ljava/lang/String;


# direct methods
.method public constructor <init>(Landroid/taobao/windvane/monitor/WVMonitorConfigManager;Landroid/taobao/windvane/config/WVConfigUpdateCallback;Ljava/lang/String;)V
    .locals 0

    .line 1
    iput-object p1, p0, Landroid/taobao/windvane/monitor/WVMonitorConfigManager$2;->this$0:Landroid/taobao/windvane/monitor/WVMonitorConfigManager;

    iput-object p2, p0, Landroid/taobao/windvane/monitor/WVMonitorConfigManager$2;->val$callback:Landroid/taobao/windvane/config/WVConfigUpdateCallback;

    iput-object p3, p0, Landroid/taobao/windvane/monitor/WVMonitorConfigManager$2;->val$finalMonitorConfigUrl:Ljava/lang/String;
...
.method public onError(ILjava/lang/String;)V
    ...
    .line 1
    iget-object v0, p0, Landroid/taobao/windvane/monitor/WVMonitorConfigManager$2;->val$callback:Landroid/taobao/windvane/config/WVConfigUpdateCallback;

    if-eqz v0, :cond_0

    .line 2
    iget-object v1, p0, Landroid/taobao/windvane/monitor/WVMonitorConfigManager$2;->val$finalMonitorConfigUrl:Ljava/lang/String;
    ...
    const-string v1, "update moniter failed! : "
...
.method public onFinish(Landroid/taobao/windvane/connect/HttpResponse;I)V
    ...
    .line 2
    iget-object p2, p0, Landroid/taobao/windvane/monitor/WVMonitorConfigManager$2;->val$callback:Landroid/taobao/windvane/config/WVConfigUpdateCallback;
    ...
    .line 5
    iget-object p1, p0, Landroid/taobao/windvane/monitor/WVMonitorConfigManager$2;->this$0:Landroid/taobao/windvane/monitor/WVMonitorConfigManager;

    invoke-virtual {p1, v0}, Landroid/taobao/windvane/monitor/WVMonitorConfigManager;->needSaveConfig(Ljava/lang/String;)Z

    move-result p1

    if-eqz p1, :cond_2

    const-string p1, "wv_main_config"
    ...
    .line 7
    iget-object p1, p0, Landroid/taobao/windvane/monitor/WVMonitorConfigManager$2;->val$callback:Landroid/taobao/windvane/config/WVConfigUpdateCallback;
    ...
    sget-object v0, Landroid/taobao/windvane/config/WVConfigUpdateCallback$CONFIG_UPDATE_STATUS;->ENCODING_ERROR:Landroid/taobao/windvane/config/WVConfigUpdateCallback$CONFIG_UPDATE_STATUS;
...
.method public bridge synthetic onFinish(Ljava/lang/Object;I)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/taobao/windvane/monitor/WVMonitorConfigManager$2;->onFinish(Landroid/taobao/windvane/connect/HttpResponse;I)V
