...
.method public onPageFinished(Lcom/uc/webview/export/WebView;Ljava/lang/String;)V
    ...
    iget-object v3, v0, Landroid/taobao/windvane/extra/uc/WVUCWebView;->wvh5PPManager:Landroid/taobao/windvane/extra/performance/WVH5PPManager;

    invoke-virtual {v3, v12, v2}, Landroid/taobao/windvane/extra/performance/WVH5PPManager;->pageDidFinishLoad(Ljava/lang/String;Lcom/uc/webview/export/WebView;)V
    ...
    .line 8
    iget-boolean v3, v1, Landroid/taobao/windvane/extra/uc/WVUCWebViewClient;->isError:Z
    ...
    .line 9
    iput-boolean v4, v1, Landroid/taobao/windvane/extra/uc/WVUCWebViewClient;->isError:Z

    .line 10
    invoke-virtual {v2, v4}, Lcom/uc/webview/export/WebView;->setVisibility(I)V
    ...
    .line 12
    instance-of v3, v2, Landroid/taobao/windvane/extra/uc/WVUCWebView;
    ...
    invoke-virtual {v0, v3, v5, v12, v6}, Landroid/taobao/windvane/service/WVEventService;->onEvent(ILandroid/taobao/windvane/webview/IWVWebView;Ljava/lang/String;[Ljava/lang/Object;)Landroid/taobao/windvane/service/WVEventResult;
    ...
    invoke-virtual {v0, v5, v12}, Landroid/taobao/windvane/jspatch/WVJsPatch;->execute(Landroid/taobao/windvane/webview/IWVWebView;Ljava/lang/String;)V
    ...
    .line 19
    invoke-interface {v5, v3, v0}, Landroid/taobao/windvane/webview/IWVWebView;->fireEvent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v7, "onPageFinished.  core type = "
...
.method public onRenderProcessGone(Lcom/uc/webview/export/WebView;Lcom/uc/webview/export/extension/RenderProcessGoneDetail;)Z
    ...
    iget v5, v5, Landroid/taobao/windvane/config/WVCommonConfigData;->webMultiPolicy:I

    const-string v6, "R_Fail"

    invoke-interface {v0, v4, v6, v5}, Landroid/taobao/windvane/monitor/WVMonitorInterface;->commitRenderType(Ljava/lang/String;Ljava/lang/String;I)V

    .line 7
    :cond_0
    iput v3, p0, Landroid/taobao/windvane/extra/uc/WVUCWebViewClient;->crashCount:I
...
.method public shouldInterceptRequest(Lcom/uc/webview/export/WebView;Lcom/uc/webview/export/WebResourceRequest;)Lcom/uc/webview/export/WebResourceResponse;
    ...
    :cond_6
    :goto_0
    const-string p1, "shouldInterceptRequest, invalid request."
...
.method public shouldOverrideUrlLoading(Lcom/uc/webview/export/WebView;Ljava/lang/String;)Z
    ...
    const-string v3, "WVUCWebViewClient"
    ...
    const-string v0, "shouldOverrideUrlLoading filter url="
    ...
    const-string v2, "WVUCWebView.shouldOverrideUrlLoading"

    .line 11
    invoke-static {v0, p1, v2, p2}, Landroid/taobao/windvane/monitor/AppMonitorUtil;->commitFail(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v5, v2, Landroid/taobao/windvane/extra/uc/WVUCWebView;->wvh5PPManager:Landroid/taobao/windvane/extra/performance/WVH5PPManager;
    ...
    invoke-interface {v4, v0, v5, p2}, Landroid/taobao/windvane/urlintercept/WVURLIntercepterInterface;->shouldOverrideUrlLoading(Landroid/content/Context;Landroid/taobao/windvane/webview/IWVWebView;Ljava/lang/String;)Z
    ...
    const-string v4, "shouldOverrideUrlLoading: doFilter error, "
    ...
    invoke-virtual {v0, v2, p2}, Landroid/taobao/windvane/extra/uc/UCNetworkDelegate;->onUrlChange(Landroid/taobao/windvane/extra/uc/WVUCWebView;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p2, v0}, Lcom/taobao/weaver/prefetch/WMLPrefetch;->g(Ljava/lang/String;Ljava/util/Map;)Ljava/lang/String;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    const-string v0, "shouldOverrideUrlLoading: ActivityNotFoundException, url="
