...
# instance fields
.field public tStart:Ljava/lang/String;
...
.method public getEmbedView(Lcom/uc/webview/export/extension/EmbedViewConfig;Lcom/uc/webview/export/extension/IEmbedViewContainer;)Lcom/uc/webview/export/extension/IEmbedView;
    ...
    :cond_2
    const-string p1, "viewType should not be lost"
...
.method public onGpuProcessGone(Ljava/lang/String;)V
    ...
    const-string v1, "onGpuProcessGone"
...
.method public onWebViewEvent(Lcom/uc/webview/export/WebView;ILjava/lang/Object;)V
    ...
    const-string v0, "onRenderProcessReady"
    ...
    iget-object v3, v3, Landroid/taobao/windvane/extra/uc/WVUCWebView;->wvh5PPManager:Landroid/taobao/windvane/extra/performance/WVH5PPManager;

    invoke-virtual {v3, v0, v1}, Landroid/taobao/windvane/extra/performance/WVH5PPManager;->recordUCT1(J)V
    ...
    iget-object v3, v3, Landroid/taobao/windvane/extra/uc/WVUCWebView;->pageTracker:Landroid/taobao/windvane/extra/performance2/WVPageTracker;

    invoke-virtual {v3, v0, v1}, Landroid/taobao/windvane/extra/performance2/WVPageTracker;->onPageReceivedT1(J)V
    :try_end_1
    ...
    .line 35
    instance-of v3, p1, Landroid/taobao/windvane/extra/uc/WVUCWebView;
    ...
    iget-object v3, v3, Landroid/taobao/windvane/extra/uc/WVUCWebView;->wpData:Landroid/taobao/windvane/extra/performance2/WVWPData;

    if-eqz v3, :cond_a

    .line 36
    iput-object v1, v3, Landroid/taobao/windvane/extra/performance2/WVWPData;->t2:Ljava/lang/String;
    ...
    iget-object v1, v1, Landroid/taobao/windvane/extra/uc/WVUCWebView;->wvh5PPManager:Landroid/taobao/windvane/extra/performance/WVH5PPManager;

    invoke-virtual {v1, v6, v7}, Landroid/taobao/windvane/extra/performance/WVH5PPManager;->recordUCT2(J)V
    ...
    invoke-static {v5, v0, v1}, Landroid/taobao/windvane/extra/performance2/UCTracker;->commitUCT2(Ljava/lang/String;J)V

    .line 42
    :cond_e
    invoke-static {v6, v7}, Landroid/taobao/windvane/utils/TimeUtils;->generateUptimeFromCurrentTime(J)J
    ...
    const-string v4, "LauncherProcedure is not Alive"

    const-string v5, "H5_UC_T2"

    const-string v8, "WVUCClient"
    ...
    .line 46
    :cond_f
    invoke-static {v8, v4}, Landroid/taobao/windvane/util/TaoLog;->v(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 50
    invoke-static {v8, v1}, Landroid/taobao/windvane/util/TaoLog;->v(Ljava/lang/String;Ljava/lang/String;)V

    .line 51
    :goto_4
    sget-object v1, Lcom/taobao/monitor/procedure/ProcedureManagerProxy;->a:Lcom/taobao/monitor/procedure/ProcedureManagerProxy;

    invoke-virtual {v1, p1}, Lcom/taobao/monitor/procedure/ProcedureManagerProxy;->getProcedure(Landroid/view/View;)Lcom/taobao/monitor/procedure/IProcedure;
    ...
    .line 56
    sget-object v0, Lcom/taobao/monitor/procedure/PageManagerProxy;->PROXY:Lcom/taobao/monitor/procedure/PageManagerProxy;

    invoke-virtual {v0, p1}, Lcom/taobao/monitor/procedure/PageManagerProxy;->getPageGroup(Landroid/view/View;)Lcom/taobao/monitor/procedure/IPage;
    ...
    invoke-interface {v0, v4, v5}, Lcom/taobao/monitor/procedure/IPage$PageRenderStandard;->onPageVisible(J)V
    :try_end_3
    ...
    invoke-virtual {v1, v0, v5}, Landroid/taobao/windvane/ha/UCHAReporter;->putLinkIdWithUrl(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "page use webgl, url = ["
