...
.field public popupClickListener:Landroid/view/View$OnClickListener;
...
.method public static synthetic access$002(Landroid/taobao/windvane/jsbridge/api/WVCamera;Z)Z
    .locals 0
...
.method public static synthetic access$102(Landroid/taobao/windvane/jsbridge/api/WVCamera;Z)Z
    .locals 0
...
.method public static synthetic access$200(Landroid/taobao/windvane/jsbridge/api/WVCamera;)V
    .locals 0
...
.method public static synthetic access$300(Landroid/taobao/windvane/jsbridge/api/WVCamera;)V
    .locals 0
...
.method public static synthetic access$400(Landroid/taobao/windvane/jsbridge/api/WVCamera;)Landroid/taobao/windvane/view/PopupWindowController;
    .locals 0
...
.method public static synthetic access$500(Landroid/taobao/windvane/jsbridge/api/WVCamera;)[Ljava/lang/String;
    .locals 0
...
.method public static synthetic access$600(Landroid/taobao/windvane/jsbridge/api/WVCamera;)V
    .locals 0
...
.method public static synthetic access$700(Landroid/taobao/windvane/jsbridge/api/WVCamera;)V
    .locals 0
...
.method public static synthetic access$800(Landroid/taobao/windvane/jsbridge/api/WVCamera;)Landroid/taobao/windvane/jsbridge/WVCallBackContext;
    .locals 0
...
.method public static synthetic access$900(Landroid/taobao/windvane/jsbridge/api/WVCamera;Ljava/lang/String;Landroid/taobao/windvane/jsbridge/api/WVCamera$UploadParams;)V
    .locals 0
...
.method private chosePhotoInternal()V
    ...
    const-string v2, "mutipleSelection only support in taobao!"
    ...
    const-string v2, "taobao://go/ImgFileListActivity"
...
.method private initTakePhoto(Landroid/taobao/windvane/jsbridge/WVCallBackContext;Ljava/lang/String;)V
    ...
    const-string p2, "takePhoto, call this method too frequent,  "
    ...
    const-string v2, "mutipleSelection"
    ...
    const-string v2, "reducePermission"
    ...
    const-string v0, "takePhoto fail, params: "
...
.method private openCamara()V
    ...
    new-instance v1, Landroid/taobao/windvane/jsbridge/api/WVCamera$3;

    invoke-direct {v1, p0}, Landroid/taobao/windvane/jsbridge/api/WVCamera$3;-><init>(Landroid/taobao/windvane/jsbridge/api/WVCamera;)V
...
.method private openCamaraInternal()V
    ...
    const-string v2, "start to open system camera."
    ...
    iput-object v3, v2, Landroid/taobao/windvane/jsbridge/api/WVCamera$UploadParams;->localUrl:Ljava/lang/String;
    ...
    invoke-virtual {v2, v3}, Landroid/taobao/windvane/cache/WVCacheManager;->getCacheDir(Z)Ljava/lang/String;

    move-result-object v2

    const-string v3, "CAMERA_OPEN_ERROR"
    ...
    iput-object v2, p0, Landroid/taobao/windvane/jsbridge/api/WVCamera;->mLocalPath:Ljava/lang/String;
    ...
    iget-object v5, p0, Landroid/taobao/windvane/jsbridge/api/WVCamera;->mLocalPath:Ljava/lang/String;

    invoke-direct {v4, v5}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    invoke-static {v2, v4}, Landroid/taobao/windvane/file/WVFileUtils;->getFileUri(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
...
.method private takePhotoSuccess(Ljava/lang/String;Landroid/taobao/windvane/jsbridge/api/WVCamera$UploadParams;)V
    ...
    const-string p2, "pic not upload and call success, retString: "
...
.method private zoomPicAndCallback(Ljava/lang/String;Ljava/lang/String;Landroid/taobao/windvane/jsbridge/api/WVCamera$UploadParams;)V
    ...
    const-string v3, "write pic to file, name: "
...
.method public execute(Ljava/lang/String;Ljava/lang/String;Landroid/taobao/windvane/jsbridge/WVCallBackContext;)Z
    ...
    invoke-static {p1, v2}, Landroid/taobao/windvane/runtimepermission/PermissionProposer;->buildPermissionTask(Landroid/content/Context;[Ljava/lang/String;)Landroid/taobao/windvane/runtimepermission/PermissionProposer$PermissionRequestTask;

    move-result-object p1

    new-instance v2, Landroid/taobao/windvane/jsbridge/api/WVCamera$1;

    invoke-direct {v2, p0, p3, p2}, Landroid/taobao/windvane/jsbridge/api/WVCamera$1;-><init>(Landroid/taobao/windvane/jsbridge/api/WVCamera;Landroid/taobao/windvane/jsbridge/WVCallBackContext;Ljava/lang/String;)V

    .line 4
    invoke-virtual {p1, v2}, Landroid/taobao/windvane/runtimepermission/PermissionProposer$PermissionRequestTask;->setTaskOnPermissionGranted(Ljava/lang/Runnable;)Landroid/taobao/windvane/runtimepermission/PermissionProposer$PermissionRequestTask;
    ...
    new-instance v2, Landroid/taobao/windvane/jsbridge/api/WVCamera$2;

    invoke-direct {v2, p0, p3, p2}, Landroid/taobao/windvane/jsbridge/api/WVCamera$2;-><init>(Landroid/taobao/windvane/jsbridge/api/WVCamera;Landroid/taobao/windvane/jsbridge/WVCallBackContext;Ljava/lang/String;)V
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    const-string v5, "takePhoto callback, requestCode: "
    ...
    invoke-static {v4, v3}, Landroid/taobao/windvane/util/TaoLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v6, "pick photo fail, picture not exist, picturePath: "
    ...
    const-string v8, "pick photo fail, Cursor is empty, imageUri: "
...
.method public takePhotoPlus(Landroid/taobao/windvane/jsbridge/WVCallBackContext;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string p2, "takePhotoPlus fail, params error"
...
.method public upload(Landroid/taobao/windvane/jsbridge/api/WVCamera$UploadParams;)V
    .locals 3
