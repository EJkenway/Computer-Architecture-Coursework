...
.method private getConfigsFromSomeWhere(Landroid/taobao/windvane/config/UCHASettings$ConfigRate;)Ljava/lang/String;
    ...
    const-string v3, "u4_collect_url_query"
    ...
    const-string v3, "u4_collect_url_ref"
    ...
    const-string v3, "u4_bkpg_sampling_rate"
    ...
    const-string v3, "u4_t1t3detail_sampling_rate"
    ...
    const-string v3, "u4_resloadfail_sampling_rate"
    ...
    const-string v3, "u4_xhr_sampling_rate"
    ...
    const-string v3, "u4_jserr_sampling_rate"
    ...
    const-string v3, "u4_har_sampling_rate"
    ...
    const-string v3, "u4_interaction_js_error_sampling_rate"
    ...
    const-string v3, "u4_webgl_error_state_api_sampling_rate"
    ...
    const-string v3, "u4_maps_groups_sampling_rate"
    ...
    const-string v3, "u4_maps_groups_tpupload_define"
    ...
    const-string v3, "u4_maps_groups_max_script_memory"
    ...
    const-string v3, "u4_maps_groups_max_gl_memory"
    ...
    const-string v3, "u4_uc_large_alloc_size"
...
.method public onReceiveValue(Landroid/util/Pair;)V
    ...
    const-string v11, "need not collect log, type:["
    ...
    const-string v4, "webgl error report with "
